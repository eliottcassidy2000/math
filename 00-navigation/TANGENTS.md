...
**T837** [codex-2026-06-17-S2] #lrc14 #dihedral-groups #uniform-fattening #OPEN-Q-108 #HYP-2569. Dihedral endpoint atlas for the LRC14 12-core crux: each `D_v` has local `v`-clock dihedral endpoints `(14k±1)/(14v)`, and a safe component from `aRk` to `bLl` has exact mouth length `(a*(14l-1)-b*(14k+1))/(14ab)`. The drop-6 core is a `D6` missing-clock shadow: its four safe components are two reflected mouth orbits inside the omitted speed-6 teeth at `1/6,5/6`, with `2*(1/728)+2*(5/1848)=7/858`. Two-delete/one-replacement scan through `w<=180`: all `2004` missing-6 rows have at least `7/858+1/980`; damaging old hexagon mouths forces larger new mouth mass. Next target: prove a scale-invariant dihedral mouth-exchange inequality. -> HYP-2568/2569, THM-523.

...
**T693** #lrc #unit-distance #channel-ledger #frontier-gain #jackknife #proof-obligations | certainty: reserved bridge packet | source: codex-2026-06-04-S624
Compare LRC and unit-distance by damaging retained channels one at a time.  LRC has survival bitmasks over `Z/(2n-1)` but needs owner/carry/pinch/CRT side channels; unit distance has frontier gains but needs direction support, compactness, orbit budget, deletion resilience, and obstruction labels.  S624 reserves HYP-2197 for an LRC witness-orbit jackknife paired with the S622/S623 unit-distance impairment ledger; Tournament Analysis vertices are channels/proof obligations, not runners or points.

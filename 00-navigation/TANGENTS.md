...
**T128** #symmetry-kernel #SC-SF-chain #isomorphism-classes #tiling-grouping | certainty: high (verified n=3,...,7) | source: opus-2026-03-06-S7
THE SC+SF KERNEL: Tournament isomorphism classes that are both self-converse AND self-flip form a persistent "symmetry kernel" across n values. Count: n=4:1, n=5:2, n=6:2, n=7:8. At even n (4,6), the H-maximizer IS in the kernel; at odd n (5,7), the H-maximizer (regular/Paley, high |Aut|) is SC but NOT SF. Grid-symmetric tilings per kernel class follow GS ~ 3^floor((n-2)/2) for most classes (exact at n=4,5,6; 6/8 at n=7). SF-only classes (not SC) come in transpose pairs {T,T^op} with equal H. All 456 classes at n=7 enumerated; 88 SC, 30 SF, 8 both. Kernel classes at n=7 all have |Aut|=1, nearly-regular scores, and H in [117,159] (62-84% of max H=189).

**T129** #GS-fraction #grid-symmetric #ratio-pattern | certainty: high (verified n=3,...,7) | source: opus-2026-03-06-S7
GS/SIZE RATIO PATTERN IN H-MAXIMIZERS. The fraction of grid-symmetric tilings in H-maximizer classes shows a striking pattern: GS/size = 3/5 = 0.600 at n=4 kernel, 1/5 = 0.200 at n=5 non-kernel, 9/15 = 3/5 = 0.600 at n=6 kernel, 3/9 = 1/3 at n=7 Paley. The 3/5 ratio recurs at even n for the kernel maximizer. GS tilings in kernel = 3^floor((n-2)/2): values 3,3,9 at n=4,5,6. This connects grid symmetry (anti-automorphism structure) to the tiling model's combinatorial geometry.

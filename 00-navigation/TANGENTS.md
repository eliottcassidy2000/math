...
**T097** #paley-deletion #maximizer-heredity | certainty: high (verified) | source: kind-pasteur-2026-03-06-S18e
Paley T_7 (H=189, global max at n=7) vertex deletion gives T_6 with H=45 = global max at n=6! H(T_7) - H(T_6) = 144 = 2*72. The 72 comes from mu-weighted odd cycle counts through the deleted vertex (mu is NOT always 1 at n=7 for 3-cycles: 4 available vertices can form odd cycles). Pattern: T_3 (H=3) -> T_2 (H=1) = max at n=2; T_7 (H=189) -> T_6 (H=45) = max at n=6. Conjecture: Paley T_p deletion always gives H-maximizer at p-1.

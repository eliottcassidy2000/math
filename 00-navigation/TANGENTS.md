...
**T725** #set-theory #continuum-hypothesis #cardinality #forcing #equinumerosity #side-channels | certainty: stub claimed + synthesis in progress | source: codex-2026-06-05-S656
Reserve the set-theoretic Continuum Hypothesis thread as the cardinal-shadow analogue of the repo's quotient failures.  CH asks whether `2^aleph_0` has no intermediate aleph layer; the repo lesson from HYP-2187, HYP-2185, HYP-2171, HYP-2230, and HYP-2231 is that scalar equality or scalar collapse is downstream of retained forcing/boundary/packet/owner data.  Full CH carrier atlas pending; keep this distinct from older repo `CH` entries for Caccetta-Haggkvist cycle-return work.  See HYP-2232.

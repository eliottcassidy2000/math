...
**T687** #cauldron-game #Schur #sum-free #online-coloring #removal-game #finite-sums | certainty: reserved scout | source: codex-2026-06-03-S618
The cauldron game is a Schur-coloring face when one boil ends play: `k=3`, distinct two-term `A+B=C` should force the first boil at `14` because `S(3)=13`.  The all-boiled version is not the same theorem; boiling/removing a cauldron creates a sacrifice dynamic over active sum-free resources.  S618 will compute exact small bounds and compare fixed-arity and finite-sums variants with Tournament Analysis over proof routes, active states, subset-sum obligations, and removal order types.  See HYP-2189.

...
**T763** #unit-distance #3n-floor #common-neighbour #K23-free #kovari-sos-turan #erdos #kissing-cap #eisenstein #realizability-gap #THM-420 #s709 | certainty: LOWER PROVED (N≥17) + UPPER VERIFIED (N=39) | source: monad-explorer-2026-06-06-S709
THE COMMON-NEIGHBOUR FLOOR FOR BEATING 3N (THM-420, HYP-2284). Answers the rigorous side of S702(b) "is triangular N=43 optimal?". Beating 3N unit distances (avg degree >6=κ) is IMPOSSIBLE for N≤16; min N* ∈ [17,39]. LOWER (proved, over ALL planar sets not just lattices): ≤2 common neighbours per pair (two unit circles meet in ≤2 pts = K_{2,3}-free) ⟹ ΣC(d,2)≤N(N−1) ⟹ avg deg ≤(1+√(8N−7))/2 ⟹ avg deg >D needs N≥**C(D,2)+2**; D=κ=6 ⟹ N≥17. KEY DUALITY: the SAME inequality is the Erdős/KST O(N^{3/2}) UPPER ceiling read upward and this FLOOR read downward — one geometric fact clamps both ends of the unit-distance count. UPPER (verified exact-int): √7 Eisenstein patch centred at edge-midpoint (½,0) gives N=39, U=118>117 — IMPROVES HYP-2267's lattice-centred N=43. κ sits in BOTH threshold (κ/2)N AND floor C(κ,2)+2; gap 17→39 = cost of Euclidean realizability over pure design. Open: exact N*; lift floor via K₄-freeness; LRC transfer (worry-set shell-partner = a ≤2-incidence ⟹ a smallest-modulus floor?). See THM-420, reflection the-common-neighbour-bound-governs-both-ends-of-the-unit-distance-count-s709.md.

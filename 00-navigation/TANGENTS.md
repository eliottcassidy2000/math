...
**T726** #open-problems #frontier-scout #kakeya #falconer #unit-distance #union-closed #reconstruction | certainty: stub claimed + atlas in progress | source: codex-2026-06-05-S657
Reserve the missed-problem frontier scout.  S657 searches repo and web for important math problems not yet central in the workspace but compatible with local carriers.  Early candidate clusters: Kakeya/Falconer incidence geometry, Hadwiger-Nelson coloring, union-closed families, graph reconstruction decks, Ryser-Brualdi-Stein/Rota rainbow bases, sunflower/extractor set systems, Caccetta-Haggkvist short cycles, and Erdős-Hajnal blow-up tournaments.  Rank by external importance, low repo coverage, and carrier match rather than fame alone.  See HYP-2233.

...
**T625** #lrc #n14 #permutohedron #braid-arrangement | certainty: stub / proof target | source: codex-2026-06-01-S526
The n=14 proof attempt should lift the observer-source movie from scalar gap races to the braid arrangement / permutohedral chamber fan: chamber walls are adjacent swaps, THM-384 source is the long-long facet around the observer, and the seven CRT blockers become owner labels on adjacent normal cones. A counterexample would be a closed one-parameter sweep avoiding that source facet while cycling blocker owners. See HYP-2001.

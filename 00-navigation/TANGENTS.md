...
H=63 is NOT universally forbidden: an n=8 tournament has Ω(T)=K31, so H=I(Ω,2)=1+2·31=63. This refutes HYP-1754 and sharpens the permanent-gap story: 7 and 21 remain special, while 63 unlocks through a complete conflict graph rather than a disconnected K3 factor. See `05-knowledge/results/h63_counterexample_audit_s8.out`.

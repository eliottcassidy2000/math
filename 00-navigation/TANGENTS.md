...
**T740** #paris-harrington #ultrafilter #colorings #bad-coloring-tree #recursion-theory #metagraph #lrc | certainty: stub claimed for finite PH miniature | source: codex-2026-06-05-S671
Reserve the coloring-recursion layer above HYP-2245.  Working thesis: a coloring is a side-choice over tuple atoms; bad colorings form an outer-extension tree; a homogeneous relatively-large set is a finite filter trace that cannot be pushed indefinitely into the tail; and the Paris-Harrington least-witness function measures when every coherent bad-coloring branch is killed.  Planned finite audit: exact `x=2` pair-coloring miniature plus a small `x=3` search-pressure scout, then translate to LRC owner/carry filters and quotient descent.  See HYP-2246.

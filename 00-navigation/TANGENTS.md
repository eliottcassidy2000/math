...
**T250** #spectral-zeta #forbidden-H #Bernoulli #power-sums | certainty: MEDIUM (observed, deeper proof needed) | source: opus-2026-03-16-S73
**Forbidden H values as spectral zeta evaluations.** ζ(-3)=7 (first forbidden), ζ(-5)=21=3×7 (second forbidden). These are alternating power sums = Bernoulli polynomial evaluations at negative odd integers. 21 is also the double factorial fixed point (n-2)!! mod 42 (HYP-1614) and 42/2 (odd half of base 42). The forbidden values encode power-sum arithmetic. HYP-1618.

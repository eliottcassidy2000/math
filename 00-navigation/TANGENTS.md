...
The prime denominator `n=17` has a clean first gate: no `17`-multiple leaves all unit walls `a/17` as closed witnesses. After the gate, the closest structured repair is not a one-gate swap but `{r} union {17q:1<=q<=16,q!=8}`, with exact positive `gap/th=0.003676...` at denominator `9248=17*544`. The skipped `8` is a half-gate debt packet candidate; next step is an exact formula for that corridor. See HYP-2064 (renumbered from 2063 by monad-reviewer-2026-06-02; MISTAKE-053).

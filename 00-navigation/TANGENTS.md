...
The unordered bucket formula is now proved in Lean for fixed-point-free involutive move systems. `BucketBalance.pairHalf` closes internal half-lines under involutive moves, fixed-point-free moves give no self-partners, the generic finite orbit-parity lemma gives `Even selfHalf.card`, and `unordered_balance_of_involutive_fixedPointFree` proves the row formula. The remaining THM-346 bridge is no longer bucket-specific: instantiate `x xor u` for nonzero Boolean masks. See THM-350 and HYP-1778.

...
**T727** #frontier-carriers #reconstruction #union-closed #kakeya #finite-field #tournament-analysis | certainty: stub claimed + computation in progress | source: codex-2026-06-05-S658
S658 follows the HYP-2233 frontier atlas by building small predicate-preserving carriers before chasing big statements.  The claimed lanes are tournament reconstruction decks, union-closed frequency tournaments, and finite-field Kakeya/Falconer incidence toys.  For each lane, record the preserved predicate, the destroyed side channel, and Tournament Analysis fingerprints.  See HYP-2234.
...
**T728** #tournament-decks #reconstruction #derivatives #marked-projections #side-channels | certainty: stub claimed + computation in progress | source: codex-2026-06-05-S659
S659 deepens the tournament deck angle from HYP-2234.  Treat a vertex-deleted deck as a projection that forgets the missing vertex's boundary/owner label; candidate repairs are deletion derivatives such as `H-H_card`, `c3-c3_card`, deleted score, SCC change, and local influence profiles.  The goal is to identify which repairs are deck-visible, which require marking, and how this mirrors LRC owner/carry, unit-distance point-deletion pressure, and union-closed set pressure.  See HYP-2235.

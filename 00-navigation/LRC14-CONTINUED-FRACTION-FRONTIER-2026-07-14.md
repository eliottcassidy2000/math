...
| THM-779/785, r=8 token-walk chain | THM-779 characterizes full blocking by piece surjectivity, wall rainbows, and absence of simultaneous walls; consecutive wall owners must follow a deterministic collision-hop rule. THM-785 proves recurrence, balance, dephasing, and a conditional extent bound. Joined to THM-778, this is a schedule-versus-algebra word problem. | The current `K0=6` is an adversarial-census ceiling, not an unconditional bound. The balanced co-landing cascade and hence a universal exit bound remain open. |

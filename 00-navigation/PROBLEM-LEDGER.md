...
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. THM-2633/2655 reduce live quartic monodromy to `A4/S4` plus a rank-two `V4` Kummer carrier on the full resolvent normalization. THM-2681 excludes the actual THM-1310 cubic as an exact quartic `S4` Keller resolvent. THM-2685/2686 give the divisor-parity and coprime-invariant Kummer gates; THM-2695 gives the secondary Picard-divisibility quotient. THM-2696 proves every proper finite complex reflection-group quotient non-Keller and closes the obvious constant-different `S3<S4` planar slice, not arbitrary `A4/S4`. At degree 22, THM-2671/2683/2692 empty supports three/four/five, hence every coefficient-support stratum in the inherited polynomial exact-square-prefix, genuine nonsplit branch. | For quartics, compute boundary units and `Cl[2]` on other full cyclic/S3 resolvent normalizations, or classify smooth transverse coefficient surfaces beyond THM-2696; do not rematch discriminants. For degree 22, retain the split anti-invariant first-flux constant or prove integral `2`-adic order raising; do not recompute coefficient supports. Separately retain outside reductions and THM-2240's DC axes. |

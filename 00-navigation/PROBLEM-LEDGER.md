...
|---|---|---|
| LRC(14) | Open. THM-2199 forces rank twelve but does not enumerate the finite locus. In scalar `5+3`, THM-2213--2229 reduce the ledger to `240`; THM-2233/2239 leave `194`, and THM-2244 closes `28/29` depth-three rows. Exactly `166` remain: `165` first-depth-one rows and `(3,4,5)`. | Join THM-2234's private two-owner expansion to separately centered signed owner/Fourier incidence on the `165` first-depth-one rows; build a composite or multidirectional score for `(3,4,5)`; separately prune THM-2208's rank-twelve locus. |

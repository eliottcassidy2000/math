...
| Jacobian / Dixmier / Poisson | **OPEN.** THM-4248/4226 close `M=11/13`; THM-4290/4297/4299 reduce `M=12` to `U=0`, `Z=0`, and the cubic corner. THM-4308/4312 isolate finite row-eight `k=1`; THM-4315 cuts it to ten `L_1!=0` row-nine points and THM-4316 proves none reaches row ten. THM-4317 resolves the conditional completed-local divisors. | Attack `U=0`, `Z=0`, and seam entry. `JC(2)` and `DC(2)` remain open. |

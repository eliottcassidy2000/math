...
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. THM-2247 closes nonsplit degree fourteen. At degree eighteen THM-2297 and THM-2314/2316/2320/2324/2328 close support at most two; THM-2335 closes square-class degree `0`; THM-2371/2376 close `H_2`; THM-2389 gives the final `H_4` pole system. **CANDIDATE + VERIFIED-EXACT THM-2406**, awaiting independent audit, forces that system onto THM-2345's closed common-root wall; promotion would close the entire degree-eighteen trajectory stratum. | Hostile-audit THM-2406's splitting field, pole localization, and wall normal forms. Then treat split/even short edges at other degrees, integral `2`-adic order raising, and THM-2240's DC continuation axes. Retain the Keller one-form and Faber sidecars; do not infer JC(2) or DC(2) from a degree-eighteen closure. |

...
|---|---|---|
| LRC(14) | Open. THM-2051--2100/2112 reduce rank seven to explicit finite boxes. THM-2098--2126 route guarded ranks `8..10` through three-sparsity, content blockers, clocks, and joint Toeplitz phase; THM-2124 reduces the guard-`13` no-terminal-blocker lane to pencils `(8)` or `(7,1)`. | Discharge the rank-seven boxes; resolve the pencil's moving affine offsets and residual nontransverse lanes; retain content, phase, torsion, and higher intersections through ranks nine to twelve. |
| NC2 / GMC | THM-2022 proves NC2/GMC(2); THM-2111 is effective and THM-2101 gives two product-free additive paper proofs. Lean root-imports their algebraic core and reciprocal-monic construction of each ramified small root; general complex `DvdK1` remains the endpoint. | Formalize either THM-2101 analytic bridge and its `DvdK1` wrapper; alternatively enumerate reciprocal branches and prove their product/Wiener--Hopf identity. |
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2)/DC(2) remain open. THM-2063/2071/2118 close linear through cubic source fibers; THM-2127 closes exact coprime two-face and affine-root proper-power subclasses. | Attack quartic source fibers and general proper-power descent; optimize DC(2) gauges for polynomial termination and coupled `D`; keep generic-cover claims separate. |

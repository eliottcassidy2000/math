...
|---|---|---|
| LRC(14) | Open. THM-2199 forces rank twelve but does not enumerate the finite locus. In scalar `5+3`, THM-2213--2229 reduce the ledger to `240`; THM-2233/2239 leave exactly `194`, split as `165` first-depth-one and `29` first-depth-three rows. | Join THM-2234's private two-owner expansion to separately centered signed owner/Fourier incidence on the `165` first-depth-one rows; optimize complementary scores on the `29` depth-three rows; separately prune THM-2208's rank-twelve locus. |

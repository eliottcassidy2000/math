...
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. THM-2230 computes the exact target-shear response fiber; THM-2241 proves the degree-sharp monic test `D_P^(d+1)(x)=0` and a resultant equation for nonproperness. | Join the response tail to the quartic `E_14/E_10` flux system; separately classify split/even short edges and optimize Weyl termination. |

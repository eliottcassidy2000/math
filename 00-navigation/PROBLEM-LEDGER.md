...
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. In the reduced `(2,3)` seam, THM-4248 closes exact `M=11` off three walls. On exact-`M=12`, `W=0`, THM-4253 leaves `176/104` classes and `1,512` incidences; THM-4260 excludes all `280` specialized gate classes and THM-4265 proves the wall roots simple. THM-4268/4272 give a non-effective incidence collar across `Lambda=0` via the `A_23` contact. THM-4279/4280 give formal-log observers, integral minimal triples `{1,2,4}` and `{2,4,7}`, ramification spectrum `{1,2,4}`, and sharp faithful `5Q`. THM-4285 proves the A2 direct-sum norm form universal and completes the shell noncollapse thresholds `2Q/3Q/5Q`. THM-4284 identifies the saturated branch graph as `A_(2ell-1)`, isolates the anti-diagonal cotangent class, and proves degree `34/42` gives `A_1`; common-tangent preservation would suffice, but is not proved for the Keller graph. THM-4288 proves strict intermediate contact normalizations have dual-number fibres and gives the exact last-blowdown defect `c_C'-c_R'-c_E'`; this obstructs a full Cartesian etale pullback but does not construct one. | Prove an ambient-neighbourhood extension or ambient-regular Keller differential on the terminal triple chart, or establish raw two-variable regularity so THM-4284's `W`-saturation criterion applies. Then make the collar effective, cross the three coefficient walls, and prove exact-`M=12` seam entry. JC(2) and DC(2) remain open. |

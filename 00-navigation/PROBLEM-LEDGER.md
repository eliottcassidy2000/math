...
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. THM-2247 closes nonsplit degree fourteen. THM-2262/2297 leave a weighted singular trigonal cone at degree eighteen, with all one-sparse strata and `B=D=0` empty. THM-2311 reduces exactly two-sparse survivors to `31` ratios; THM-2314 closes the two rational `B`--`D` points, leaving `29`. | Normalize the remaining finite ratio bank, then classify the three-/four-sparse singular trigonal strata while retaining the Keller one-form and Faber sidecar; separately treat split/even short edges and THM-2240's DC continuation axes. |
...
| Metric composition / flows | THM-2176 gives the Gordian continuation kernel; THM-2191 gives stable localization. THM-2292 realizes finite catalytic tables in one context and identifies the stable calibration nerve. THM-2308 proves the common-Alexander-fibre floor `u((#^P K)#(#^Q mirror(K)))>=P+Q`, raises the Brittenham--Hermiller stable diagonal to `[2,5]`, and reduces its two same-sign chambers to one concave profile between sharp abstract norm envelopes. THM-2177 refutes Goemans' exact planar cost conjecture. | Determine the mirror-double diagonal/profile with a new stable calibrator or obstruction; separately classify higher-rank calibration nerves and unsplittable-flow overload facets. |

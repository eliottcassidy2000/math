...
|---|---|---|
| LRC(14) | Open. THM-2193 gives the uniform rank-six floor `7^-21`, an explicit seventh relation, and safe septimal torsion points. THM-2196 gives a finite semilinear circuit/carry atlas and proves the primitive zero-Haar locus finite by a two-plane rank-lift ladder, but does not enumerate it. THM-2192 leaves scalar `5+3` at one deepest blocker and an anchored chord carrier. | Effectivize THM-2196's rank lifts or discharge its finite primitive atlas; in parallel propagate THM-2192's rooted ownership through the next 13-adic scale. |

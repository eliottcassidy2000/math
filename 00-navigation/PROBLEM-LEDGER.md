...
|---|---|---|
| LRC(14) | **OPEN.** THM-4326/4329 close the fixed-pool chart; THM-4330 leaves `2+12`, while THM-4333/4338 close residual ranks three/four. THM-4347 closes height `40`; THM-4349/4371 are clocks, not entry. THM-4348 leaves `7u|h` and triple overlaps. THM-4363--4367 give the cofinite 828 fibre and exit law; THM-4374/4379 sharply recover its parameter after 17 metric/16 labeled shifts. THM-4384 subsumes 4373/4382/4383 and sharply closes all ten parity-compatible small-defect relation sectors with `m+h<=13`; their overlaps cannot be summed, and the first `m+h=15` case has nonzero defect `+/-3`. | Attack `7u|h`, universal nonresonance, and seam entry with retained prefixes, owners, addresses, nonlinear current, and the new defect-state coordinate beyond `m+h=13`; Haar bounds and identification do not force safety. |

...
|---|---|---|
| LRC(14) | Open. THM-2199 forces rank twelve by explicit height `78*182^13` but does not enumerate the finite locus. THM-2192 leaves scalar `5+3` at one unique deepest blocker; THM-2198/2204 eliminate `(1,1,2)` and `(2,2,3)`. At deepest depth three only `(1,1,3)/(1,2,3)` remain. | Attack those two mixed shallow-depth profiles using THM-2204's labelled guard-hole correlation vector/THM-2201 jets; separately discharge the explicit finite rank-twelve box. |

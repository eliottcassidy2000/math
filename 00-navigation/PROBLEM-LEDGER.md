...
|---|---|---|
| LRC(14) | Open. THM-2250/2257 close `(3,4,5)`, leaving exactly the `165` first-depth-one scalar rows. THM-2255 forces a greater-than-one-comb expiration spill on the `150` strict rows, but THM-2261 proves raw guard-owner expiration maps onto the whole circle. THM-2199's explicit rank-twelve finite locus remains unenumerated. | Build a full-cover marked successor diagram coupling the spilled owner root to the five unit masks and two surviving blockers; one-core targets cannot work. Treat the `15` repeated-first rows separately, and prune THM-2208/rank twelve. |
...
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. THM-2230 computes the target-shear response fibre; THM-2240 gives its DC continuation warning; THM-2241 gives the monic tail test. THM-2247 closes nonsplit terminal reduced degree fourteen, so that branch next begins at degree eighteen. | Extend the spectral/one-form mechanism to degree eighteen; retain THM-2240's next-grade gauge axes while testing attached-rung termination; separately classify split/even short edges. |

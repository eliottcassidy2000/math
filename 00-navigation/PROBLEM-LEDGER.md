...
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. THM-2247 closes nonsplit degree fourteen. At degree eighteen THM-2297 and THM-2314/2316/2320/2324/2328 close support at most two; THM-2335 closes square-class degree `0`; THM-2371/2376 close `H_2`; THM-2389 gives the final `H_4` pole system. **PROVED + VERIFIED-EXACT + INDEPENDENTLY HOSTILE-AUDITED THM-2406** forces that system onto THM-2345's closed common-root wall, closing the inherited nonsplit exact-square-prefix reduced degree-eighteen branch. **CANDIDATE THM-2411** empties `A=0` in the inherited genuine nonsplit polynomial exact-square-prefix degree-22 branch; `A!=0` remains open. | Hostile-audit repaired THM-2411, then treat the complementary degree-22 first-flux chart `A!=0`. Next address branches outside THM-2262, split/even short edges, integral `2`-adic order raising, and THM-2240's DC axes. Do not infer JC(2) or DC(2) from bounded-degree closure. |

...
|---|---|---|
| LRC(14) | Open with `165` rows. THM-2436 empties deep-`c_3`; THM-2452/2459 retain mask, service, and drift. THM-2466 closes word retention conditionally. THM-2471/2474 give collision service and every squarefree primitive class; THM-2478 adds a future semantic owner edge and all-colour old-drift alignment. The new owner is target-neutral and rebasing loses the deep sheet. No row is excluded. | Transport charge across the temporal scale/sheet cocycle, prove owner-loop drift, or exclude uniform offset. |

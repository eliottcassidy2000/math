...
|---|---|---|
| LRC(14) | Open. THM-2051--2100 reduce rank seven to explicit finite boxes. THM-2098--2116 route higher rank through relation-labelled pair weights, clocks, finite-ring needles, all maximum bases, Toeplitz tests, and a 13-orbit ledger; THM-2120 rules out a uniform margin on scalar filters only. | Discharge the finite rank-seven boxes and the two extremal 13-toothpick patterns; retain clock/content, higher active intersections, and guard-proportional/torsion sidecars; decide the rank-eleven/rank-twelve cells. |
| NC2 / GMC | NC2/GMC(2) are paper-proved by THM-2022 using effective internal seed THM-2111; GMC is false from dimension three. THM-2101 is a RESERVED additive orbit-residue bypass. Lean root-imports irreducibility and its Check A/orbit/Lagrange core, but not the analytic small-root subset/splitting-field bridge. | Formalize the local small-root subset and generating-function residue identity—or the reciprocal-monic Hensel construction—then instantiate the equivariant Galois wrapper to remove the explicit `DvdK1` premise. |
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. THM-2063 closes one-fiber-linear maps, THM-2071 closes quadratic-fiber cells, THM-2084 pushes the cubic reduced complement to degree `>=13`, and THM-2102 proves every power-free top-face Keller component triangular. | Make later bracket equations kill or classify the proper-power approximate-root quotient `[P] mod H^(m-1)` and resonant shear classes; extend the cubic Faber boundary from degree 13; decide Weyl termination/coupled `D`. |

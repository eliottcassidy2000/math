...
|---|---|---|
| LRC(14) | Open with `165` rows. THM-2436 empties deep-`c_3`; THM-2471/2474 saturate collision colours. THM-2507--2531 give lossless Boolean paths and anchored Gram/selector data. THM-2532--2534 give exact cyclic orientation, three-gain owner phase, positive all-slope Crofton reconstruction, and transverse target charge. THM-2535/2536 add clock holonomy and lossless selector flow with target drift, but neither is a temporal transition. Common-ancestry source/deep/arrival alignment remains open; no row is excluded. | Construct a later Boolean arrival field on the same inherited ancestry and retain its cross-boundary product with the source; then transport one positive semantic incidence into the scalar row. |

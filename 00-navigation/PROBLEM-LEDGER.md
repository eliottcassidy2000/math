...
|---|---|---|
| LRC(14) | Open. THM-2257/2258 leave `165` first-depth-one rows. THM-2261--2278 give sharp expiration, owner, gap, and marked-root structure; THM-2274/2283 force scalar ranks two and three. On the `120` interior rows THM-2279/2282 anchor a `c_1` minor nonzero mod `13`, while THM-2276 lands the exact shallow ancestry atom for multipliers `1..3` and freezes a sharp `696`-multiplier local-cancellation bank. | Use the global cover, gap ancestry, or anchored rank to defeat THM-2276's hard multipliers `4..757`; then treat the `15` repeated-first, `15` next-first, and `15` adjacent-deep rows. Residue or Plucker rank alone is not exact Fourier landing. |

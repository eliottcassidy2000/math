...
|---|---|---|
| LRC(14) | Open. THM-2250/2257 close the final depth-three row `(3,4,5)`, leaving exactly the `165` first-depth-one scalar rows. THM-2255 gives them quantitative exclusive-owner mass and forces a greater-than-one-comb expiration spill on the `150` strict rows. THM-2199's explicit rank-twelve finite locus remains unenumerated. | Prove where THM-2255's marked spill goes: a labelled successor collision/handoff law could consume the strict class; treat the `15` repeated-first rows separately. Separately prune THM-2208 and the rank-twelve box. |

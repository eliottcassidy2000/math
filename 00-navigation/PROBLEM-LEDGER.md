...
| Jacobian / Dixmier / Poisson | **OPEN.** THM-4290--4356 close the staged `M=12` atlas. THM-4357--4361 close zeta/beta-zero; THM-4362/4364/4368/4369 give the diagonal hierarchy, rank/address clocks, and exact Pascal kernel/boundary basis; THM-4366 closes `U=0` through row eleven. | Test the next source pullbacks and seam entry. Retain strata, prior-depth functionals, addresses, and packet-boundary coordinates through the next consumer. |

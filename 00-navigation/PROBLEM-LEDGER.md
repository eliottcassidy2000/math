...
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. In the reduced `(2,3)` seam, THM-4248 closes exact `M=11` off three coefficient walls. On exact-`M=12`, `W=0`, THM-4241/4249 leave `176/132` symmetry classes in `55/34` torsion envelopes; THM-4251 independently checks a subsumed row, and THM-4253 removes the norm-three profile, leaving `176/104` classes and `864/648=1,512` incidences. | Evaluate the `1,512` residual incidences on one canonical node orbit, retaining the class/incidence overlap ledger; separately attack the `M=11` walls, other hidden-Hom locus, and seam entry. Retain the quartic, degree-22, and THM-2240 DC footholds. |

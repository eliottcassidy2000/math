...
|---|---|---|
| LRC(14) | Open. THM-2193 gives the uniform rank-six floor `7^-21`, an explicit seventh relation, and safe septimal torsion points. THM-2196 gives a finite semilinear circuit/carry atlas and proves the primitive zero-Haar locus finite by a two-plane rank-lift ladder, but does not enumerate it. THM-2192 leaves scalar `5+3` at one unique deepest blocker; THM-2198's exact root-image/Hall deficit eliminates `(1,1,2)`. | Effectivize THM-2196's rank lifts or discharge its finite primitive atlas; in parallel propagate THM-2198's labelled ownership/H-drift through depths at least three. |
...
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. THM-2181 closes monic depressed quartics. THM-2189/2194 force the remaining quartic pole congruence on every nonsplit deck and uniformly in reduced mate degrees two and six. Any finite-pole survivor is split with leading coefficient `W^4` and reduced degree at least ten. | Close the split degree-`>=10` Faber bank or find its invariant recursion, then prove the terminal nonmonic square-prefix descent; separately exclude terminal short edges and optimize Weyl termination. |

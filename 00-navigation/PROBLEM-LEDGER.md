...
|---|---|---|
| LRC(14) | Open. THM-2199 forces rank twelve by explicit height `78*182^13` but does not enumerate the finite locus. THM-2192 leaves scalar `5+3` at one unique deepest blocker; THM-2198/2204/2205/2207 eliminate every deepest-depth-three profile, and THM-2203 bounds the residual depth by `4..19`. | Propagate the labelled guard-hole carrier through depths `4..19`; separately prune the one-candidate rank-eleven states of THM-2208 and discharge the explicit finite rank-twelve box. |

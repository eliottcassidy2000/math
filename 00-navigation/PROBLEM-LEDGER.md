...
|---|---|---|
| LRC(14) | Open with exactly `165` first-depth-one rows. THM-2426 empties the final subtop-guard lane. Candidate THM-2436's exact punctured common-`91` atlas empties all three deep-`c_3`/top-guard types by repeated-step rounding banks, including fixed-spectrum refinement at `M=0`; `c_3<=M` has a separate noncirculant top graft. No scalar profile is excluded. | Prove owner-conditioned survival for the `c_3<=M` graft and land a signed terminal current. Independently hostile-audit THM-2436's proof-to-parent rounding transfer; retain blocker ownership, physical labels, and endpoint evolution in any transplant. |
...
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. THM-2247 closes nonsplit degree fourteen. At degree eighteen THM-2297 and THM-2314/2316/2320/2324/2328 close support at most two; THM-2335 closes square-class degree `0`; THM-2371/2376 close `H_2`; THM-2389 gives the final `H_4` pole system. **PROVED + VERIFIED-EXACT + INDEPENDENTLY HOSTILE-AUDITED THM-2406** forces that system onto THM-2345's closed common-root wall, closing the inherited nonsplit exact-square-prefix reduced degree-eighteen branch. **PROVED + VERIFIED-EXACT + INDEPENDENTLY HOSTILE-AUDITED THM-2411** empties `A=0` in the inherited genuine nonsplit polynomial exact-square-prefix degree-22 branch; hostile-audited THM-2423/2425/2428 empty all five one-sparse axes in `A!=0`. Candidate THM-2429 closes the first support-two plane `C,W`; other mixed strata remain open. | Triage the other nine degree-22 support-two planes by weighted ratio and geometric genus, retaining the third flux and full-mate sidecar on rational exceptional fibres. Next address branches outside THM-2262, split/even short edges, integral `2`-adic order raising, and THM-2240's DC axes. Do not infer JC(2) or DC(2) from bounded-degree closure. |

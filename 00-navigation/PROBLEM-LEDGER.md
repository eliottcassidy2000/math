...
|---|---|---|
| LRC(14) | **OPEN.** THM-4326 closes the fixed thirty-label pool after any two positive outsiders, and THM-4329 completes every eleven-face of the resulting thirty-two-label Pascal chart with `chi_q(P)=30`. THM-4330 identifies the minimum-valuation graph `K_(m,14-m)`, closes `1+13`, and leaves anchored `2+12` first; its positive-rational projective pool sieve closes at most two outsiders without re-referencing. THM-4331 gives component endpoint escapes and the `1/189 -> 27(C-1)` appender; THM-4332 proves unscaled pool subsets cannot literally imply an outsider. THM-4333 proves retained `L_3/D>2/27` only on THM-4231's `181,194`-pair remainder and supplies cofinal third-outsider/two-sheet families. | Work anchored `2+12` without changing runner, especially the degree-twelve anchors and bodies failing both THM-4330 tests. In parallel, test rank four against the forced `7/81` two-appender target on `(50,70)` and `(509,640)`, and compute endpoint addresses on the latter; the first control already improves `52,407` to `120`. Retain signed relatives, midpoint collisions, scale, endpoint owners, and residual-pair qualification. |

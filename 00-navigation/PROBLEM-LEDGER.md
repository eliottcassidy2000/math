...
| Jacobian / Dixmier / Poisson | **OPEN.** THM-4290--4327 close the `M=12` interior, corner, and generic endpoint lanes by good-differential order. THM-4334/4337 close the beta/zeta endpoint owners. THM-4339 closes the clean cubic gate `Z=beta_11=zeta_3=0,U*K*W*(U+W)!=0`, including every interior collision. THM-4340 closes all `U=0,WZ!=0`: its two repeated cusps reduce to one critical-value series, and every positive-genus tail has positive Keller-form order. THM-4328 makes Student visibility even-lossless/odd-zero. | On the `Z=0` residual, handle `K=0` Laurent root exit, `W=0` degree drop, and the separate `U+W=0` contact; on `U=0`, handle `WZ=0`; then address seam entry. Retain the three-tax tuple and the critical-series owner address. |

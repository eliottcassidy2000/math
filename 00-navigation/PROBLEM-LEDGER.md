...
|---|---|---|
| LRC(14) | Open. THM-2193 gives the uniform rank-six safe-torus floor `7^-21`, an explicit seventh relation, and many safe septimal torsion points, while its THM-2188 slope factorization proves why none controls the primitive runner line. THM-735/2184/2186 give far-cone, mixed-grid, and toric terminals; THM-2192 reduces scalar `5+3` to a unique deepest blocker and an anchored chord carrier. | Transport positive torus mass to the primitive slope/current, or propagate THM-2192's rooted sheet ownership through the next 13-adic scale; control critical equality rather than adding another blind finite phase bank. |
...
| Metric composition / flows | THM-2176 gives the Gordian continuation kernel; THM-2191 constructs its catalytic localization and closes reverse `4_1/9_10` as bypass. THM-2177 refutes Goemans' exact planar cost conjecture via a `K_3` stable-set facet. | Decide the conditional `10_6` catalytic boundary and classify higher-order overload facets; unrestricted LRC localization collapses at its null absorber. |

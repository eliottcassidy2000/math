...
| Jacobian / Dixmier / Poisson | **OPEN.** THM-4290--4356 close the staged `M=12` atlas. THM-4357--4360 stratify its response and close the zeta-zero plane; THM-4361 closes beta-zero by joint row-ten depth, while THM-4362 proves the shared sharp tetrahedral stencil. | Test the next source pullbacks and seam entry. Retain constructible strata, prior-depth functionals, and attachment addresses until after the next consumer. |

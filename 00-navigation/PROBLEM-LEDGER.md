...
| Jacobian / Dixmier / Poisson | **OPEN.** THM-4290--4356 close staged `M=12`; THM-4357--4361 close zeta/beta-zero. THM-4362/4364/4368/4369/4375 give hierarchy, clocks, Pascal kernel, and reciprocal path-band/fibres. THM-4366/4376 close `U=0` and prove its complete restricted depth bank is bracket-blind. | Test nonempty source pullbacks and seam entry. Retain strata, depth functionals, addresses, packet boundaries, scale, and the bracket sidecar through the next consumer. |

...
| LRC(14) | **OPEN.** THM-4326/4329 close the fixed-pool chart; THM-4330 retains `2+12`. [Current synthesis](../05-knowledge/results/continuing14_20260908_synthesis.md) classifies every zero-budget clock:6,889 necessary connected-complement clocks remain, maximum11,934; zero-budget356/max7,056. The [frontier](CURRENT-FRONTIER.md) retains the other body, sheet and transport routes. | Establish arbitrary/disconnected-complement entry. At surviving clocks alternate complete native endpoint profiles with forced graph topology; retain actual ratios, quotient clocks, valuations and component addresses. Relaxation feasibility and Haar bounds do not force physical safety. |
...
| Tournaments | [THM-4463--4466](../05-knowledge/results/tournament_continuation_20260908.md): homogeneous-pair forced-contact floors, checksum output sheets, weighted shear/contact laws. The [universal spectral bound](../05-knowledge/results/continuing15_20260909_universal_cubic_bound.md) now closes arbitrary weighted cyclic supports, with a complete equality criterion. Join and strong-core laws remain proved. THM-2290 makes the endpoint-colour matching kernel hafnian-complete, with universal Pfaffian gauges only at orders `2,4`; THM-2294 gives locally transitive Plucker signs. THM-2501 retains signed-`C4`/Gram energy; THM-3392 gives sharp `Q<=B<=2Q` with ternary-support sidecar. | Resolve residual `G-F_R` on homogeneous swaps; retain nonuniform contact kernels and physical evolution after the sharp universal amplitude bound. `H>=disc` remains OPEN and is distinct from G. Beyond scalar bipartite norms, retain ties, gains, endpoint colours, support partitions and edge amplitudes. |

...
|---|---|---|
| LRC(14) | Open. THM-2051--2100/2112 reduce rank seven to explicit finite boxes. THM-2098--2126 route guarded ranks `8..10` through relation-labelled weights, pure-transverse three-sparsity, content blockers, clocks, and joint Toeplitz phase; scalar filters alone have no uniform margin. | Discharge the rank-seven boxes; resolve the guard-`13` pencil and residual nontransverse lanes; retain content, phase, torsion, and higher intersections through ranks nine to twelve. |
| NC2 / GMC | THM-2022 proves NC2/GMC(2); THM-2111 gives an effective seed and THM-2101 two independent product-free additive paper proofs. GMC is false from dimension three. Lean root-imports the algebraic core; general complex `DvdK1` remains the sole explicit endpoint. | Formalize either THM-2101 analytic bridge—specialization/splitting/contour or monodromy—and its final `DvdK1` wrapper; sharpen THM-2111's degree bound separately. |
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2)/DC(2) remain open. THM-2063/2071 close linear/quadratic source fibers; THM-2118 plus THM-2102 close every cubic source fiber. THM-2049 exposes DC(2) syzygy and integration gauges. | Attack quartic source fibers and general proper-power resonant descent; optimize the DC(2) gauges for polynomial termination and coupled `D`; keep VC(4), Jelonek, and generic-cover claims separate. |

...
|---|---|---|
| LRC(14) | Open with `165` rows. THM-2436 empties deep-`c_3`; THM-2452/2459 retain mask, service, and drift. THM-2471/2474 saturate first-collision colours and THM-2478 adds a future owner edge. THM-2507--2528 make the toothpick/cut bank lossless, orient it on a physical guard sheet, and realize one positive owner-marked Boolean path. THM-2529--2531 retain the deep mask as an anchored Gram cone and actual occupied-to-excluded-target boundary. THM-2532/2533 identify the exact cyclic-tournament derivative and lift it to common-owner phase with three mixed gains. THM-2534 gives positive boundaries in all twelve slopes, exact Crofton/Gram reconstruction, and transverse algebraic target charge. Deep-anchor/semantic-arrival transport remains open; no row is excluded. | Preserve one transverse boundary charge on the same deep anchored terminal component and identify its target with semantic arrival; alternatively close the source-covariant `C_7` scheduler or prove owner-loop drift. |

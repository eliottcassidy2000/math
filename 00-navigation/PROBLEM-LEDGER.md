...
|---|---|---|
| LRC(14) | **OPEN.** THM-4305 proves exact endpoint-595 response minima `5/10/22` (arbitrary/mixed-8-9/rank-eight). THM-4308 gives a 3,925-mask carrier on the 391-row target, with optimality only in its fixed `D_350` family. THM-4309 extends that carrier across the full 25-row endpoint-594 layer and proves exactly `3,911/14` safe/unsafe one-mask deletions there. THM-4306's `H_265` deck remains separate. Typed union `2,036`; residual `20,611`; max `593` on 16 rows. No physical entry. | Replay the 16-row endpoint-593 layer, freeze any pair-tagged failures and exact response quotient, recurse on other failed singleton ideals, and seek an entry/owner bridge without merging decks. |

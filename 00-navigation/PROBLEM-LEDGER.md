...
|---|---|---|
| LRC(14) | Open. THM-2257/2258 close `(3,4,5)`, leaving `165` first-depth-one rows. THM-2263 gives sharp owner floors, but THM-2261 proves raw expiration blind. THM-2144/2164 force bounded rank two and THM-2145/2166 every-cut low-carry resonance. THM-2268 forces three global owner switches, while THM-2267 shows static service and raw carry omit their gluing. | Build an ancestry-weighted successor graph coupling private owner witnesses, five masks, two blockers, and a bounded crossing frequency; price one positive cut at Haar scale. Treat the `15` repeated-first rows separately, and prune THM-2208/rank twelve. |

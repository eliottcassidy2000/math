...
| Jacobian / Dixmier / Poisson | **OPEN.** THM-4290--4356 close staged `M=12`. THM-4357--4361 close zeta/beta-zero; THM-4362/4364/4368/4369/4375 give diagonal hierarchy, clocks, Pascal kernel/basis, and the reciprocal path-band/fibre law; THM-4366 closes `U=0` through row eleven. | Test the next source pullbacks and seam entry. Retain strata, prior-depth functionals, addresses, packet boundaries, and source scale through the next consumer. |

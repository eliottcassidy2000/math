...
|---|---|---|
| LRC(14) | **OPEN.** The fixed-pool outsider-pair lane now has exact residual `174,904`, maximum `671`, topped exactly by `(256,671),(384,671)`: THM-4266/4271 give four learned-carrier rounds, while THM-4267/4269/4270 close six primitive-ray families. This is not physical entry. Separately, the `165` relation rows remain open: THM-2701/2710 close two terminal languages, while THM-2698/2707 show local recurrence below the semantic gate and the `BABA` carrier still lacks target current. | For the fixed-pool lane, attack the two endpoint-671 carrier resistances without mistaking them for danger; test minimum active-repair augmentation before importing another full prefix. For the global lane, prove physical entry or re-root a recurrent packet at an actual exclusive owner while retaining coefficient-two guard debt, phase, and ancestry. |

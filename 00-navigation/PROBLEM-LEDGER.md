...
|---|---|---|
| LRC(14) | Open. THM-2199 forces rank twelve by explicit height `78*182^13` but does not enumerate the finite locus. In scalar `5+3`, THM-2250/2257 close the final depth-three row `(3,4,5)`, leaving exactly the `165` first-depth-one rows. | Quantify cross-time owner switching/carry on the `165` depth-one rows; separately prune THM-2208 and the explicit rank-twelve box. |

...
|---|---|---|
| LRC(14) | Open with `165` rows. THM-2436 empties deep-`c_3`; THM-2452/2459 retain mask, service, and drift. THM-2466 closes word retention conditionally. THM-2471/2474 give first-collision service and every squarefree primitive class. Source, arrival, and deep copies differ. No row is excluded. | Intertwine the collision stalk with the endpoint/deep current, prove owner-loop drift, or exclude uniform offset. |

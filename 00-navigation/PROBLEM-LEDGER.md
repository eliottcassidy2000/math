...
|---|---|---|
| LRC(14) | Open. THM-2190 forces rank six by height `450` and some finite seventh relation; THM-2188 proves rank/finite phase data still blind. THM-735/2184/2186 give far-cone, mixed-grid, and toric terminals; THM-2168 leaves scalar `5+3` with a sharp height invoice. | Lift THM-2174's fixed-core two-state flag through a changing-core pump; close scalar `5+3` beyond its quotient-remainder exit and control critical equality. |

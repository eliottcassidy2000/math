...
|---|---|---|
| LRC(14) | Open with `165` rows. THM-2436 empties deep-`c_3`; THM-2452/2459 retain mask, service, and drift. THM-2466 closes word retention conditionally. THM-2471/2474 give collision service and every squarefree primitive class; THM-2478 adds a future semantic owner edge and all-colour old-drift alignment. THM-2507 detects the saturated punctured defect through nonaffine seven-point folds (`>=7/12` slopes universally, `11/12` FINITE-EXACT on the atlas), but its ordered cut/carry is not a physical target/owner/deep current. No row is excluded. | Make the cut/carry fold covariant on a Boolean ancestry cospan, transport charge across the temporal scale/sheet cocycle, prove owner-loop drift, or exclude uniform offset. |

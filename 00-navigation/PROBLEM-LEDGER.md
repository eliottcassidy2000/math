...
|---|---|---|
| LRC(14) | Open. THM-2257/2258 close `(3,4,5)`, leaving `165` first-depth-one rows. THM-2261 makes raw expiration blind; THM-2263 gives sharp owner floors. THM-2144--2166 give bounded rank and crossing; THM-2270 makes crossing simultaneous, while THM-2271 gives a quotient-faithful scalar crossing divisible by `13`. THM-2267/2268 force switch structure; THM-2269 gives marked energy in every nonzero mod-13 residue and separates ancestry from current service. | Descend a THM-2271 crossing frequency through the selected-owner address, land that exact integer frequency—not only its residue—in THM-2269's marked support, then price the THM-2267 cut. Treat the `15` repeated rows separately and prune THM-2208/rank twelve. |

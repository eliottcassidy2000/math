...
|---|---|---|
| LRC(14) | Open. THM-2199 forces rank twelve by explicit height `78*182^13` but does not enumerate the finite locus. In scalar `5+3`, THM-2213/2215/2219 close depth four, THM-2222/2224 force `lambda_1<=5`, and THM-2226 removes `217` more; exactly `458` profiles remain, only eight at first depth four or five. | Close THM-2226's eight geometric residues and build a uniform bound for the `450` first-depth-at-most-three profiles; separately prune THM-2208 and the explicit rank-twelve box. |
...
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. THM-2202 removes quartic finite poles; THM-2214 closes nonsplit terminal degrees through ten, while THM-2217 forces odd-leading survivors to degree `>=14` and `R deg(q)>=deg(V)`. | Classify higher spectral-curve singular strata and the split/even terminal square-prefix branch; separately exclude short edges and optimize Weyl termination. |
...
| Metric composition / flows | THM-2176 gives the Gordian continuation kernel; THM-2191 constructs its catalytic Grothendieck group length, proves localization/homogenization commutation and exact abstract stable duality, and closes reverse `4_1/9_10` as bypass. THM-2177 refutes Goemans' exact planar cost conjecture via a `K_3` stable-set facet. | Decide the conditional `10_6` catalytic boundary and find explicit stable calibrators; classify higher-order overload facets. Unrestricted LRC localization collapses at its null absorber. |

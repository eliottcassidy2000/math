...
|---|---|---|
| LRC(14) | Open. THM-2257/2258 close `(3,4,5)`, leaving `165` first-depth-one rows. THM-2261 makes raw expiration blind; THM-2263 gives sharp owner floors. THM-2270 gives one simultaneous balanced-cut relation; THM-2274/2283 give quotient-faithful scalar rank at least two by height `2116` and at least three by height `3540`. On the `120` interior rows THM-2279/2282 give a `c_1`-anchored relation minor nonzero modulo `13`. THM-2267/2268 force switch structure; THM-2269 gives marked energy in every nonzero mod-13 residue and separates ancestry from current service. | Retain the integer lift inside a selected mod-13 residue and its owner ancestry, or control the signed whole residue class, then price the THM-2267 cut. Modular Plucker rank is address control, not exact Fourier landing. Treat the `15` repeated rows separately and prune THM-2208/rank twelve. |
...
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. THM-2247 closes nonsplit degree fourteen. THM-2262 makes the degree-eighteen generic spectral cover genus four, kills the exceptional center by an exact Faber-sidecar pole, and leaves an explicit singular degree-twelve branch-discriminant locus with Keller one-form. | Normalize the singular trigonal locus while retaining its one-form and polynomial sidecar; separately classify split/even short edges and THM-2240's DC continuation axes. |
...
| Metric composition / flows | THM-2176 gives the Gordian continuation kernel; THM-2191 gives stable localization. THM-2242 makes the kernel embedding isometric and proves singleton Green classes, unknot-only idempotence/regularity, and prime-knot atoms. THM-2177 refutes Goemans' exact planar cost conjecture. | Decide the conditional `10_6` catalytic boundary along principal-ideal rays and find explicit stable calibrators; classify higher-order overload facets. |

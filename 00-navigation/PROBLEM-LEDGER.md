...
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. THM-2247 closes nonsplit degree fourteen. At degree eighteen THM-2297 and THM-2314/2316/2320/2324/2328 close support at most two; THM-2335 closes square-class degree `0`; THM-2371/2376 close `H_2`; hostile-audited THM-2406 closes the inherited reduced `H_4` branch. At degree 22, hostile-audited THM-2411 closes `A=0`; THM-2423/2425/2428 close all five axes; THM-2429/2437/2463/2468/2469/2470/2472/2475/2476/2480 close all ten planes; audited THM-2671 closes all ten support-three strata by fixed root/pair Hensel ranks and the retained spectral square. THM-2446 opens the `z`-quadratic six-bracket architecture; THM-2451 plus independent extensions refute its cone shortcut. | Attack the five degree-22 support-four strata and the full-support stratum. Lift the common fixed-section root/pair calculation from linear terminal rank to the toric ideal of its three-parameter tail monomials; stack successive beyond-degree Hensel orders when one five-row matrix is insufficient. Separately address split/even short edges, integral `2`-adic raising, branches outside THM-2262, the 2-jet swallowtail/field-degree layer, and THM-2240's DC axes. |

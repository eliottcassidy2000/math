...
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. THM-4248 closes exact `M=11` off three walls, THM-4226 closes dense `M=13`, and THM-4290 closes exact-`M=12` on `U*Z*D*Lambda!=0`. At `Lambda=0`, THM-4289 proves the exact `conductor/J_f` Kahler/dualizing loss. THM-4291's abstract degree-42 genus-five tail has Keller order eight; THM-4292 proves every exceptional `A_23` tail constant. THM-4293 corrects the inherited packet: a double top-edge root of contact `r` gives degrees `42-2r/34-2r` and genus `18-r`. Degree conservation plus the deck Eisenstein eigenline excludes `r=1,2,4,5,6`; only noncritical `r=3` and the repeated discriminant survive. MISTAKE-531 records the repaired degree transport. | Attack `r=3` through its norm-`9/7` visible maps and attachment data; stratify the repeated discriminant's normalized pole divisor. In parallel, cross `U=0`, `Z=0`, and `D=0`, and prove exact-`M=12` seam entry. JC(2) and DC(2) remain open. |

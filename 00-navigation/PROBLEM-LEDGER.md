...
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. THM-2247 closes nonsplit degree fourteen. At degree eighteen THM-2297 closes one-sparse strata and `B=D=0`; THM-2314/2316/2320/2324/2328 close all `31` exactly two-sparse ratios. THM-2332 leaves squarefree degrees `0,2,4`; THM-2335 eliminates `0`; THM-2345/2347 close the common-root and double-zero divisors. THM-2359 is a verified-exact candidate closing the perfect-quartic divisor, pending audit. | Classify the residual off-wall `H_2/H_4` loci, beginning with a proved moving-root localization rather than the reserved THM-2357 namespace; retain the Keller one-form and Faber sidecar. Separately treat split/even short edges and THM-2240's DC continuation axes. |

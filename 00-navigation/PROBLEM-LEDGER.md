...
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. THM-2181 closes monic depressed quartics. THM-2189/2194/2202 force the remaining quartic pole congruence on every deck and every twice-odd reduced degree, so no quartic finite-pole survivor remains. | Prove the terminal nonmonic square-prefix/quadratic-member descent; separately exclude terminal short edges and optimize Weyl termination. |

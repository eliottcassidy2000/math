...
|---|---|---|
| LRC(14) | **OPEN.** THM-4326/4329 close the fixed-pool chart; THM-4330 leaves `2+12`, while THM-4333/4338 close residual ranks three/four. THM-4347 closes height `40`; THM-4349/4371 are clocks, not entry. THM-4363--4367 give the cofinite 828 fibre and exit law; THM-4374/4379 recover its parameter after 17 metric/16 labeled shifts. THM-4386 gives the exact rank-two raw-carrier sum, empties independent zero-defect overlaps, and completes all thirteen ternary-unit `||c||_1<=14` patterns. THM-4387/4391 sharply close all seven norm-`16` patterns with affine defect `0,+/-3`; THM-4392 proves the exact box-spline/Poisson duality and shows complete shortest-orbit data do not determine mass. | Attack `7u|h`, universal nonresonance, and seam entry using raw carriers, residue-deleted successive minima, retained prefixes/owners, nonlinear current, and the affine defect state; Haar bounds, shortest-orbit data, and identification do not force safety. |

...
|---|---|---|
| LRC(14) | Open. THM-2051--2100/2112 reduce rank seven to finite boxes. THM-2098--2131 route guarded ranks through three-sparsity, content, Toeplitz phase, two-prime `143` invoices, and 13-adic pencils; THM-2131 empties the guard-blocker/no-terminal-blocker lane. | Attack simultaneous guard/terminal blockers and the fivefold guard pencil; discharge finite rank-seven boxes and ranks nine to twelve without dropping labelled `11/13` offsets, phase, or torsion. |
...
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. THM-2063/2071/2118 close affine, quadratic, and cubic source-fiber members. THM-2102 closes power-free top faces; THM-2127 handles arbitrary later faces whenever the first lower face is not divisible by `rad(h)`, and closes affine roots. | Classify factor-initial cancellation on `rad(h)|A`; attack the quartic source-fiber boundary and Weyl termination/coupled `D`. |

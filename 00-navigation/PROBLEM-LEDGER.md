...
|---|---|---|
| LRC(14) | Open. THM-2199 forces rank twelve by explicit height `78*182^13` but does not enumerate the finite locus. In scalar `5+3`, THM-2233/2239 leave exactly `166`: the `165` first-depth-one rows and `(3,4,5)`. THM-2250 forces every survivor of the latter to have equal normalized blocker cores. | Quantify cross-time owner switching/carry on the `165` depth-one rows; solve the exact common-core `(3,4,5)` Markov branch; separately prune THM-2208 and the explicit rank-twelve box. |

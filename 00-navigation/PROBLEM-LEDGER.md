...
|---|---|---|
| LRC(14) | Open. THM-2051--2100/2112 reduce rank seven to finite boxes. THM-2098--2135 route guarded ranks through content, Toeplitz phase, `143` invoices, and 13-adic pencils; THM-2135 forces the `6+1` scalar tail to depth five and excludes `5+2` depths `(1,1),(1,2)`. | Prove the all-depth unit-annulus extremal law, attack the remaining `5+2` floods and fivefold guard pencil, and discharge finite rank-seven/rank `9..12` boxes without losing labelled offsets, phase, or torsion. |
| NC2 / GMC | THM-2022 proves NC2/GMC(2); THM-2111 is effective and THM-2101 gives three product-free additive paper proofs, including a purely t-adic packet argument. Lean root-imports their algebraic core; general complex `DvdK1` remains the endpoint. | Formalize the t-adic packet coefficient and `DvdK1` wrapper; sharpen THM-2111's first-return bound toward `M+N`. |
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. THM-2127/2132 close exact two-face branches and force a Newton chord; THM-2134 makes each nonradial edge a coarsened local power or terminally short, and THM-2136 scalarizes the power with an exact Hermite compatibility budget. | Prove a nonzero cross-factor Hermite/subresultant obstruction or exclude terminal short edges; classify central prefixes, descend the quartic square remainder, and optimize Weyl termination. |

...
| Jacobian / Dixmier / Poisson | **OPEN.** THM-4290--4327 close the `M=12` interior, corner, and generic endpoint lanes by good-differential order. THM-4328 makes Student visibility even-lossless/odd-zero. | Audit `U=0` with `WZ=0` or either repeated cusp, and `Z=0,U!=0` with `beta_11 zeta_3=0`; all 51 primary complexes have positive order, but contacts and seam entry remain. |

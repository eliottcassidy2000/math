...
|---|---|---|
| LRC(14) | Open. THM-2051--2100 reduce rank seven to explicit finite boxes. THM-2098--2125 route higher rank through relation-labelled pair weights, clocks, finite-ring needles, Toeplitz tests, and the 13-content invoice; THM-2126 rules out a uniform margin on scalar filters only. | Discharge the finite rank-seven boxes; resolve the guard-13 pencil and residual nontransverse branches; retain clock/content, higher active intersections, and torsion sidecars through ranks nine to twelve. |

...
|---|---|---|
| Euler / signed-budget bridge | [THM-4457](../01-canon/theorems/THM-4457-euler-sharp-transverse-shear-distance-budget.md) proves a sharp vorticity shear-distance budget; its NS continuation specialization follows from Miller. [THM-4458](../01-canon/theorems/THM-4458-lrc-one-sided-adverse-leak-budget.md) sharpens the real-profile leak tariff. The [external audit](../05-knowledge/reference/OPENAI-EULER-AUDIT-2026-09-08.md) leaves full PDE verification incomplete. | Bound adverse leakage on the same canonical LRC observer; compute integrated shear distance along one fixed solution, retaining its background. No major-problem closure follows yet. |
| LRC(14) | **OPEN.** THM-4326/4329 close the fixed-pool chart; THM-4330 leaves `2+12`, while THM-4333/4338 close residual ranks three/four. THM-4347 closes height `40`; THM-4349/4371 are clocks, not entry. THM-4363--4367 give the cofinite 828 fibre and exit law; THM-4374/4379 recover its parameter after 17 metric/16 labeled shifts. THM-4386 gives the exact rank-two raw-carrier sum and completes every ternary-unit `||c||_1<=14` pattern; THM-4387/4391/4393/4394 close the minimal norm `16/18/20` sectors with affine defect `0,+/-3`. THM-4398 closes all one-zero-mod-three presentation sectors through norm `14`, with one live affine class and no new extremizer beyond `{1,5,11}`. THM-4392 gives box-spline/Poisson duality; THM-4396 closes `(11,13,17)` by an eleven-site/exact-pair hybrid and proves that quotient cannot certify equality without third-sheet data. | Attack `7u|h`, universal nonresonance, and seam entry using raw carriers, residue-deleted successive minima, retained prefixes/owners, nonlinear current, and the affine defect state; extend the one-zero tail and restore a minimal third-sheet sidecar without double-counting presentation overlaps. Haar bounds, shortest-orbit data, and identification do not force safety. |
| Newton circuit / no-return | [Fixed-moment circuits](../05-knowledge/results/continuing9_20260907_fixed_moment_circuits.md) realize every ternary word at every strictly feasible first-two-moment pair and give the exact cubic amplitude image. [Anchored interlacers](../05-knowledge/results/continuing9_20260907_interlacer_circuits.md) retain all27 C-only words; D excludes an open neighborhood. [Prior synthesis](../05-knowledge/results/continuing8_20260906_synthesis.md) retains fixed-edge jets, cancellation tax, the proved narrow-cluster law and THM-3010 bronze/Fuss repair. The two-end classifier and general norm/alternation dichotomy are REFUTED. | Determine the full C/D image with actual factorial rows and phases. Four full-model words have exact controls; absence of two negative circuits and the untouched wall core remain OPEN. |

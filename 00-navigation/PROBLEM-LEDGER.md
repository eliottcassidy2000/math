...
|---|---|---|
| LRC(14) | Open with `165` rows. THM-2436 empties deep-`c_3`; THM-2452/2459 retain a matched mask, supplied service, and drift. THM-2461 separates word and roots; THM-2466 closes delayed-word retention conditionally. THM-2471 gives first-collision service `169I_r` and all twelve colours, but source, arrival, and deep copies remain distinct. No row is excluded. | Intertwine the collision stalk with the endpoint/deep current, prove owner-loop drift, or exclude uniform offset globally. |

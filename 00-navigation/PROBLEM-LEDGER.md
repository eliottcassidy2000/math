...
|---|---|---|
| LRC(14) | **OPEN.** THM-4326/4329 close the fixed-pool chart; THM-4330 leaves anchored `2+12` with `420|h`; THM-4333/4338 close residual ranks three/four; THM-4335 gives exact renewal owners. THM-4347 closes every dyadic eleven-body through height `40`. A max-`72` body escapes fixed clocks `15..43`, while THM-4349 proves that one explicit adaptive clock is nevertheless a complete certificate for each fixed body. THM-4348 reduces one/two-residual third-tooth walls off `7u|h`. THM-4345/4346 identify the residual-wall transducer/current. THM-4363 proves that even 828 statuses plus all completed chains need missing prefixes and Euclidean tooth addresses to determine first exit. | Attack `7u|h` and triple wall-shadow intersections using the retained missing prefixes, address/remainder cells, and nonlinear current; compress THM-4349's adaptive clock or force its emptiness. |

...
|---|---|---|
| LRC(14) | **OPEN.** THM-4326/4329 close the fixed-pool chart; THM-4330 leaves anchored `2+12` with `420|h`; THM-4333/4338 close residual ranks three/four. THM-4347 closes dyadic eleven-body height `40`; THM-4349/4371 give clocks, not entry. THM-4348 leaves `7u|h` and triple overlaps. THM-4363/4365/4367 give a common cofinite 828 fibre, exit law, and ray-scale collisions; THM-4374 sharply recovers its parameter after 17 metric shifts, proving equality is the only compatible shift congruence. | Attack `7u|h`, triple wall shadows, and seam entry using retained prefixes, address/remainders, and nonlinear current; clocks and delayed metric identification do not force safety. |

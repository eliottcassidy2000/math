...
|---|---|---|
| LRC(14) | Open. THM-2257/2258 independently close `(3,4,5)`, leaving exactly `165` first-depth-one rows. THM-2263 gives sharp owner floors, but THM-2261 proves raw expiration is globally blind. THM-2264 forces a height-29 relation; THM-2265 forces a crossing relation through every `6+7` cut. | Build a full-cover marked successor diagram coupling owner handoff, five masks, two blockers, and a bounded crossing frequency; one-core targets cannot work. Treat the `15` repeated-first rows separately, and prune THM-2208/rank twelve. |

...
|---|---|---|
| LRC(14) | Open with `165` rows. THM-2436 empties deep-`c_3`; THM-2452/2459 retain mask, service, and drift. THM-2466 closes word retention conditionally. THM-2471/2474 give collision service and every squarefree primitive class; THM-2478 adds a future semantic owner edge and all-colour old-drift alignment. THM-2507--2509 make the nonaffine toothpick/cut bank lossless and affine-covariant; THM-2511 contracts it to nonnegative all-colour root vectors on at least `64/72` atlas pairs. The contraction is signed pair-space data, not a Boolean owner/deep current. No row is excluded. | Realize the cut/pair bundle on one Boolean ancestry cospan, transport absolute phase and charge across the temporal scale/sheet cocycle, prove owner-loop drift, or exclude uniform offset. |

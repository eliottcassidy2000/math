...
|---|---|---|
| LRC(14) | **OPEN.** THM-4326/4329 close the fixed-pool chart; THM-4330 leaves anchored `2+12` with `420|h`; THM-4333/4338 close residual ranks three/four; THM-4335 gives exact renewal owners. THM-4347 closes every dyadic eleven-body through height `40`. THM-4349 gives a complete adaptive clock per body; THM-4348 leaves `7u|h` and triple overlaps. THM-4345/4346 identify the residual-wall current. THM-4363/4365/4367 give a common cofinite 828 fibre, exit law, and sharp ray-scale collisions; the metric quotient is not a shift state. | Attack `7u|h` and triple wall-shadow intersections using retained missing prefixes, address/remainder cells, and nonlinear current; compress THM-4349's adaptive clock or force emptiness. |

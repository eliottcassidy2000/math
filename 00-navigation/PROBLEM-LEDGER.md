...
|---|---|---|
| LRC(14) | **OPEN.** The fixed-pool lane has residual `174,741`, max `670`, top `(256,670),(384,670)`: THM-4266/4271/4276 give five carrier rounds (the last an exact minimum-six augmentation); THM-4267/4269/4270 close six rays. This is not physical entry. The `165` relation rows also remain open: THM-2701/2710 close two terminal languages, while the `BABA` carrier lacks target current. | Attack the two endpoint-670 carrier resistances by response quotient and hostile packing; search non-ray common decks below them. Globally, prove physical entry or re-root at an exclusive owner while retaining coefficient-two guard debt, phase, and ancestry. |

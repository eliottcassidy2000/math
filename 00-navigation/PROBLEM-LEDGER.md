...
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. THM-4248 closes exact `M=11` off three walls, THM-4226 closes dense `M=13`, and THM-4290 closes exact-`M=12` on `U*Z*D*Lambda!=0`. On `W=Lambda=0`, THM-4291/4292 prove every exceptional `A_23` tail Keller-constant. THM-4293 corrects that slice's packet to degrees `42-2r/34-2r` and genus `18-r`; its sieve leaves `r=3` and the repeated discriminant. THM-4294 proves exact central order nine, so the genus-seven component is constant too; proper-flat degree conservation closes the complete `W=Lambda=0`, `U!=0` slice. Its repeated sidecar has discriminant orders `13,14,15,16,18`, with missing `17` and common norm-seven degree `28` as non-load-bearing signal. | Extend the central/tail inventory to the general `Lambda=0` wall with `W!=0`, then cross `U=0`, `Z=0`, and `D=0`. In parallel, prove exact-`M=12` seam entry. JC(2) and DC(2) remain open. |

...
|---|---|---|
| LRC(14) | **OPEN.** Fixed-pool residual `21,323`, max `626`, top `(100,626),(256,626)`. THM-4295 proves rank-eight append minimum `14`, a distinct Pareto carrier, and ideal minima `2,4,4`. THM-4296 proves the deletion upset/depth-nine lemma, a 14-for-14 exchange, a 9,019-mask mixed carrier closing 70 rows, and 110 singleton decks. Exact overlap accounting with the larger ideals adds three rows to its 1,321-row subunion: aggregate `1,324`. Decks, carriers, and row-set unions remain separate; none gives physical entry. | Quotient the 1,005 endpoint-626 carrier failures with deletion depth retained. Recurse on 81 failed singleton groups/larger ideals, then prove entry or re-root at an exclusive owner. |

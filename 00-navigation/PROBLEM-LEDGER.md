...
|---|---|---|
| LRC(14) | Open. THM-2051--2100/2112 reduce rank seven to finite boxes. THM-2098--2130 route guarded ranks through three-sparsity, content, Toeplitz phase, finite-plane pencils, and a two-prime `143` determinant invoice; scalar filters alone have no margin. | Discharge rank-seven boxes and the all-eight mod-13 pencil; combine labelled `11/13` offsets, phase, torsion, and higher intersections through ranks nine to twelve. |
| NC2 / GMC | THM-2022 proves NC2/GMC(2); THM-2111 is effective and THM-2101 gives two product-free additive paper proofs. Lean root-imports their algebraic core and reciprocal-monic construction of each ramified small root; general complex `DvdK1` remains the endpoint. | Formalize either analytic bridge and its `DvdK1` wrapper; alternatively enumerate reciprocal branches and prove their product/Wiener--Hopf identity. |
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2)/DC(2) remain open. Linear, quadratic, and cubic source fibers close; THM-2127 closes two proper-power subclasses and THM-2129 leaves one balanced quartic square. THM-2049 exposes DC(2) gauges. | Descend the quartic square-completion remainder `(q,r-p^2/4)` and its quadratic deck; optimize DC(2) termination/coupled `D`; keep generic-cover claims separate. |

...
|---|---|---|
| LRC(14) | Open. THM-2167/2171/2169 make rank-two relation carriers algebraically finite and give deletion height `1247`; THM-2174 isolates phase windows/current. THM-2168 eliminates the transverse and scalar-`4+3` parts of `(3,5,0)`, leaving only scalar `5+3`. THM-2184 closes every fixed arbitrary-residue `7+6` affine ray at large scale. | Close scalar `5+3`; find a uniform affine-ray decomposition or full joint continuation carrier for the unrestricted residual; discharge the finite rank-seven/rank `9..12` boxes without losing higher-order phase incidence. |
...
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. THM-2158 gives one translation-invariant quartic pole divisor; THM-2180 kills its first cubic-pole stratum, and THM-2181 closes every already monic depressed polynomial quartic. | Prove `V|(4gamma-(beta/V)^2)` (or descend its pole divisor), then supply the nonmonic terminal monicization/quadratic-member step; continue Weyl termination. |

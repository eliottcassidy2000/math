...
|---|---|---|
| Cross-concept bridges | [THM-4459--4462](../05-knowledge/results/cross_concepts_20260908.md): sharp shear moments/minors, LRC continuation states, transcendental coin carries and cyclic capacity. Builds on THM-4457/4458; external Euler verification remains incomplete. | Supply canonical owner transport, physical flux bounds, improved causal coin decoders and pressure-compatible cells. Major-problem closure is not claimed. |
| LRC(14) | **OPEN.** THM-4326/4329 close the fixed-pool chart; THM-4330 retains `2+12`. [Mandatory actual wedges](../05-knowledge/results/continuing15_20260909_lrc_mandatory_wedges.md) close clocks5,880,6,804,7,056:6,886 necessary connected-complement clocks remain, maximum11,934; zero-budget353/max6,552. The [frontier](CURRENT-FRONTIER.md) retains the other routes. | Establish arbitrary/disconnected-complement entry. At survivors retain non-atlas pair overlaps and the full seven-tail union: synchronized native edges alone need not cover. |
| Newton circuit / no-return | [Current synthesis](../05-knowledge/results/continuing10_20260908_synthesis.md): every ternary circuit word survives fixed first two moments; all27 anchored C-only words survive, but joint D moments exclude the entire closed nonpositive octant. The two-end classifier and general norm/alternation dichotomy are REFUTED. | Resolve the two-negative cells with degree-eight D moments and actual factorial rows. Original-response transport and the wall core remain OPEN. |
...
| Jacobian / Dixmier / Poisson | **OPEN.** THM-4290--4361 close the named staged `M=12` cells; THM-4362--4378 give the depth/clock/Pascal/reciprocal machinery. THM-4380 closes the fixed source-normal weight-at-most-twelve family; THM-4385 identifies its row-ten elliptic quotient. THM-4389 proves the next `p^5*y` face deforms that curve into a non-isotrivial pencil while `p^2*y^3` stays tangent through row ten. | Compute the weight-thirteen row-eleven/twelve divisor, then test nonempty source pullbacks and seam entry. Retain strata, depth functionals, addresses, packet boundaries, scale, and the bracket sidecar through each consumer. |
| Tournaments | [THM-4463--4466](../05-knowledge/results/tournament_continuation_20260908.md): homogeneous-pair forced-contact floors, checksum output sheets, weighted shear/contact laws. [Universal bound](../05-knowledge/results/continuing15_20260909_universal_cubic_bound.md): all supports, exact equality. Join and strong-core laws remain proved. THM-2290 makes the endpoint-colour matching kernel hafnian-complete, with universal Pfaffian gauges only at orders `2,4`; THM-2294 gives locally transitive Plucker signs. THM-2501 retains signed-`C4`/Gram energy; THM-3392 gives sharp `Q<=B<=2Q` with ternary-support sidecar. | Resolve `G-F_R` on homogeneous swaps; restore nonuniform contacts and physical evolution. `H>=disc` remains OPEN and is distinct from G. Beyond scalar bipartite norms, retain ties, gains, endpoint colours, support partitions and edge amplitudes. |

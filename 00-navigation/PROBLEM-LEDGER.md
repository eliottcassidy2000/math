...
|---|---|---|
| LRC(14) | Open. THM-2051--2074 give the atlas and density-one complement. THM-2073/2075/2077 preserve the terminal carrier; THM-2078/2080 force maximum `>=25`, depth `<=4`, size `7..10`; THM-2081/2083 reduce rank seven to bounded relations supported on guard/two-speed triples. THM-2082 proves scalar code-wheel blindness. | Make THM-2083 effective or discharge its templates with projective residue/endpoint data; handle ranks 8--10, other rank-eleven cells, and the rank-twelve box. |
| NC2 / GMC | NC2/GMC(2) are paper-proved by THM-2022 using internal seed THM-2067; GMC is false from dimension three. Lean root-imports `heightWitnessSupplier_holds`, leaving general `DvdK1` as the sole explicit premise; special positive/two-charge/unique-channel leaves are checked. HYP-8931 is vacuous (MISTAKE-240). | Formalize THM-2067; repair the unique-face predicate only with a nonempty/straddling witness and an actual NC2 consumer; isolate complex cancellation. |

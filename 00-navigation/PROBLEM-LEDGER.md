...
| LRC(14) | **OPEN.** THM-4326/4329 close the fixed-pool chart; THM-4330 retains `2+12`. [Current synthesis](../05-knowledge/results/continuing13_20260908_synthesis.md) adds complete zero-cut closures at9240 and11088:7,618 necessary connected-complement clocks remain, maximum11,935. The [frontier](CURRENT-FRONTIER.md) retains the other body, sheet and transport routes. | Establish arbitrary/disconnected-complement entry. At surviving clocks alternate complete native endpoint profiles with forced graph topology; retain actual ratios, quotient clocks, valuations and component addresses. Relaxation feasibility and Haar bounds do not force physical safety. |

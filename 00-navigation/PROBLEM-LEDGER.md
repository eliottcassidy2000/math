...
|---|---|---|
| LRC(14) | Open. THM-2051--2100/2112 reduce rank seven to finite boxes. THM-2098--2133 route guarded ranks through three-sparsity, content, Toeplitz phase, two-prime `143` invoices, and 13-adic pencils; THM-2131 empties the no-terminal-blocker lane and THM-2133 leaves only two scalar simultaneous-blocker tails. | Attack the scalar `6+1`/`5+2` flood tails and the fivefold guard pencil; discharge finite rank-seven boxes and ranks nine to twelve without dropping labelled `11/13` offsets, phase, or torsion. |
...
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. THM-2063/2071/2118 close affine, quadratic, and cubic source fibers. THM-2127/2132 close every exact two-face proper-power branch; with arbitrary tails they force either tameness away from `rad(h)|A` or a later factorwise Newton chord. | Classify central prefixes, the small-degree chord branch, and chord initial polynomials; descend the quartic square remainder and optimize Weyl termination/coupled `D`. |

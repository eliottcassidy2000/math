...
|---|---|---|
| LRC(14) | **OPEN.** THM-4326/4329 close the fixed-pool chart; THM-4330 leaves `2+12`, while THM-4333/4338 close residual ranks three/four. THM-4347 closes height `40`; THM-4349/4371 are clocks, not entry. THM-4348 leaves `7u|h` and triple overlaps. THM-4363--4367 give the cofinite 828 fibre and exit law; THM-4374/4379 sharply recover its parameter after 17 metric/16 labeled shifts. THM-4384 closes ten coefficient-one sectors; THM-4386 upgrades them to an exact rank-two raw-carrier lattice sum, proves independent zero-defect overlaps empty, and sharply completes all thirteen primitive full-support ternary-unit patterns with `||c||_1<=14`. Norm `16` already has defect `0,+/-3`. | Attack `7u|h`, universal nonresonance, and seam entry using raw carriers, residue-deleted successive minima, retained prefixes/owners, nonlinear current, and the affine defect state beyond norm `14`; Haar bounds and identification do not force safety. |

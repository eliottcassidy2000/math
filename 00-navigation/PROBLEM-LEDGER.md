...
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. THM-2247 closes nonsplit degree fourteen. At degree eighteen THM-2297 and THM-2314/2316/2320/2324/2328 close support at most two; THM-2335 closes square-class degree `0`; THM-2371/2376 close `H_2`; THM-2389 gives the final `H_4` pole system. **CANDIDATE + VERIFIED-EXACT THM-2406**, awaiting independent audit, forces that system onto THM-2345's closed common-root wall; promotion would close the entire degree-eighteen trajectory stratum. **CANDIDATE THM-2411** reduces degree-22 `A=0` to open `H_0S_3^2/H_2S_2^2` classes. | Hostile-audit THM-2406/2411. On degree 22, combine the third flux, Keller one-form, and whole-polynomial sidecar on both square classes; separately treat the complementary first-flux chart. Then address split/even short edges, integral `2`-adic order raising, and THM-2240's DC axes. Do not infer JC(2) or DC(2) from bounded-degree closure. |

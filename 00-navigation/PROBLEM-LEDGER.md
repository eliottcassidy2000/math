...
| Jacobian / Dixmier / Poisson | **OPEN.** THM-4290--4356 close the staged `M=12` atlas. THM-4357--4361 stratify its response and close zeta/beta-zero; THM-4362/4364/4368 give the diagonal hierarchy, rank clock, and boundary address; THM-4366 closes the full `U=0` source pullback through row eleven. | Test the next source pullbacks and seam entry. Retain constructible strata, prior-depth functionals, and attachment addresses until after the next consumer. |

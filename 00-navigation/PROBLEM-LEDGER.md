...
| Jacobian / Dixmier / Poisson | **OPEN.** THM-4290--4356 close the staged `M=12` atlas; THM-4357/4358 isolate and kill finite `S_4339` at row ten. THM-4359 identifies the row-eight constructible response as an affine modification and proves specialization adds real zero-wall incompatibilities. | Test THM-4357's next smallest pullbacks and seam entry. Retain constructible strata, prior-depth functionals, and attachment addresses until after the next consumer. |

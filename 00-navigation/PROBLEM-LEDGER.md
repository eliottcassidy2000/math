...
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. THM-2247 closes nonsplit degree fourteen. At degree eighteen THM-2297 and THM-2314/2316/2320/2324/2328 close support at most two; THM-2335 closes square-class degree `0`; THM-2371/2376 close `H_2`; hostile-audited THM-2406 closes the inherited reduced `H_4` branch. At degree 22, hostile-audited THM-2411 closes `A=0`; THM-2423/2425/2428 close all five one-sparse axes in `A!=0`; THM-2429 and THM-2437 close the `C,W` and `D,W` support-two planes. THM-2446 opens the `z`-quadratic six-bracket architecture, while THM-2451 refutes its proposed plane-map cone shortcut on the separated-ruling line stratum. | Triage the remaining eight degree-22 support-two planes, beginning with the low-complexity `B,D` plane, retaining the third flux/full-mate sidecar on exceptional fibres. For the 2-jet route, test the conic-direction repair rather than the refuted unrestricted P2. Next address branches outside THM-2262, split/even short edges, integral `2`-adic order raising, and THM-2240's DC axes. |

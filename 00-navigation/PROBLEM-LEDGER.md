...
|---|---|---|
| LRC(14) | **OPEN.** THM-4302 retains a 9,019-mask carrier through endpoint 596. THM-4303 replays that carrier on all 28 endpoint-595 rows and closes 25; only `(96,595)`, `(100,595)`, `(210,595)` fail, on `116/13/16` bodies. Typed union `1,658`; residual `20,989`. No physical entry. | Build pair-tagged response quotients on the three failure sets, audit shared additions and family-wide inactive slack, recurse on failed ideals, and seek an entry/owner bridge. |

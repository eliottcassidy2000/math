...
| Jacobian / Dixmier / Poisson | THM-1300 refutes JC from dimension three; JC(2) and DC(2) remain open. In the reduced `(2,3)` seam, THM-4248 closes exact `M=11` whenever `A*B*(A+B)!=0`, leaving exactly three coefficient walls. On the exact-`M=12`, `W=0` gate, THM-4241 proves the full integral Hom lattice and THM-4249 confines degree-`34/42` attachment collapse to `176/132` symmetry classes and `55/34` marked-ratio torsion envelopes. The older quartic and degree-22 footholds remain valid. | Evaluate the exact `1,512` residual `W=0` map-ratio incidences on one canonical node orbit, preferably through good-prime function-field pole ideals; separately attack the `M=11` walls `A=0,B=0,A+B=0`, the other hidden-Hom locus, and seam entry. Retain the quartic boundary gate, degree-22 exceptional locus, and THM-2240's DC axes. |

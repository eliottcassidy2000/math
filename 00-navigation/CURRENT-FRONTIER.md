...
- **Entry:** [Synthesis](../05-knowledge/results/continuing12_20260908_synthesis.md):
  7,620 connected-complement clocks remain, `t<=11935,g<=90`.
...
- **Jacobian/Dixmier:** `JC(2),DC(2)` **OPEN**. THM-4130--4378 close named
  ...
  [Unit modules](../05-knowledge/results/continuing12_20260908_synthesis.md):
  identical unit futures hide unbounded ambient torsion on W2; entry **OPEN**.

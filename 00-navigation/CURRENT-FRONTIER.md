...
THM-2928/2941 empty aligned `k>=4`, cap `k=2,3` at `1732/294`, and close the
common-level reflected `k=1` diagonal.  Other censuses, arbitrary `k<=1`, the rung,
and LRC are open.  Septimal floor/exception plus
located phase cut the raw five-drift ledger
...
not physical-cover counts.  For `k=3`, torsion closes `312`; exact status/Farkas replay closes `306,302,298`; at `297`, one-high reduction plus the order-at-most-seven torsion-density pigeonhole closes all `73` terminal cases, leaving `294`.

...
[THM-2340](../01-canon/theorems/THM-2340-owner-word-anova-target-landing.md) identifies pure-word landing with ordered main effects and fork landing with interaction. Prove the selected component nonzero, then retain all-`91`-unit visibility and THM-2303 phase; otherwise attack the `15` repeated/resonance rows. The ledger remains `165`.

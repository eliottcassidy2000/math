...
- **PROVED rank descent and explicit residual atlas:** THM-2052 combines
  ...
  template; all boxes still need discharge. THM-2098 splits ranks 8--11 between seven transverse bands (budget `5(n-7)/49`) and seven guard-proportional bands; THM-2099/2103 prove pair-tree data and affine rank still miss exact dyadic rows whose denominator-six clock escapes. The six persistent height-114 cut

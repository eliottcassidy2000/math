...
THM-3356 sends primitive carriers to determinant shells. THM-3366 leaves refined `(rows,count)` `k=2:4,056/200,069,517,203`, `k=3:1,897/2,548,893,834`. THM-3385/3387--3389 classify `15,393` body rows and `q=2,3,4` sheet clutters; seven refine, so no decrement.

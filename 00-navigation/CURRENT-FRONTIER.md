...
Direct frontier: `<=6`. THM-2928 empties aligned `k>=4`; THM-2995/3111 cap projected `k=2,3` at `1579/229`; corrected THM-2941 leaves `561` reflected bodies, `D>=6,1<=m<2D/3`.

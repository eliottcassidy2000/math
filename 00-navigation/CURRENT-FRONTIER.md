...
THM-3349--3352 close all connected-low rays.  Disconnected-low: `q>=8p`, non-`3:5` small-ruler `g>=4`, and all `g>=19` close.  The `3:5` lane, other `g<=3`, arbitrary `k<=1`, rung, entry and LRC remain open.

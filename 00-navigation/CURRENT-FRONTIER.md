...
- **Jacobian/Dixmier:** `JC(2),DC(2)` are **OPEN**. THM-4130--4248 close
  ...
  `Z=beta_11=zeta_3=W=xi_10=0` endpoint. THM-4357/4358
  isolate `S_4339` and kill its row-9 curve at row ten. THM-4359 identifies
  the constructible response and its specialization defect. Other source
  strata and seam entry stay open.

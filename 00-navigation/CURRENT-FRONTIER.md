...
Cell-0 rank1 (MISTAKE-417); audited square/root/point/source-sheet:
`4/36`,`(3,12,12)/432`,`(5,12,12)`,rank6/432. Current x root
`(3,4,12,12)/5184` via pointed-six; two-current: mod169 chain,
rank `3/4`, pure `5184`. Audit/cross/address/U_clock/LRC open.

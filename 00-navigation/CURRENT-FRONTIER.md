...
THM-3405/3415/3416: ZMC rank 4 iff `8|q or 9|q`; rank 5 iff `(10|q or 12|q)` with `8,9 not|q`; rank 6 iff `(11|q or 15|q or 23|q or 25|q)` with `8,9,10,12 not|q`. THM-3414: fixed-zero rank <=6 iff one of `15,16,18,20,24` divides q. M389 splits HG; 3409 q15 tariff `(50,6)/(10,3)`; 3410 wedge/MST.
...
- **Planar source fibres:** THM-2063/THM-2084--2247 close the affine-through-
  ...
  THM-3418 separately closes sparse `P=f(x)+g(x)z^d`, `d>=2`, by a residue-one recurrence; intermediate coefficients remain open.

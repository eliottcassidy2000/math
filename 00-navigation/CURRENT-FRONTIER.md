...
proves regular shortlex density; [THM-3510](../01-canon/theorems/THM-3510-binary-shortlex-equal-level-count-log-density-boundary.md)
is sharp: equal counts allow two densities or none.
...
- THM-3200/3211/3224 split LRC rays into bulk, coboundary, gcd carry, owner exact part, periodic constant, and head.
  ...
  THM-3305/3307 give exact edge updates/circuits; THM-3315/3322/3324 give the walk OGF, second moment, and closed response Gram.
...
- **Jacobian/Dixmier:** `JC(2)`/`DC(2)` and general lanes OPEN. THM-3438 gives
  ...
  THM-3544/3550 internally force pencil degrees composite `>=6` and height
  `>=8`; cited Nagata/GGHV gates sharpen this to `Omega(deg R)>=3` for every
  pencil member and reduced height `>=108`, with only `(72,108)` below `125`.
  THM-3543/3545/3554 form a ramified/algebraic/punctured collision pincer;
  THM-3549 starts quotient repair at transverse `(4,5)`, THM-3553 closes all
  displayed polynomial graphs, and THM-3546/3548 leave nonlinear
  coordinate-hypersurface descent plus phase-aware conductance gates.
  ...
  remain open. [THM-3504](../01-canon/theorems/THM-3504-level-four-sporadic-keller-image-prime-and-four-component-nonproperness.md)
  is the level-four router. THM-2681/2685--2708 block the `A4/S4` cubic and
  retain its holonomy; 3448/3517 leave quartic `C3` open (MISTAKE-416).
  THM-3440/3443/3450 and 3064/66/68 show the LRC/Keller modes have no lawful
  amplitude/current transport and still allow a punctured `C3`; polynomial
  `A2` regularity and constant units are missing.
  ...
  `C[A,d]^2` is equivalent to `JC(2)`, while `B`-targets and nongraph surfaces
  stay open. Degree eighteen closes sparse/`H_2`, sending `H_4` to common-root.

...
THM-3356 sends primitive carriers to determinant shells. THM-3366 leaves refined rows/counts `4,056/200,069,517,203` (`k=2`) and `1,897/2,548,893,834` (`k=3`). THM-3385 explains its seven hits by an exact degree-`q` fibre theorem; no new refined decrement follows.

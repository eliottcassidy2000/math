...
**Rolling state — 2026-08-12.** Linked theorems are proof sources; this file records composition and residuals. Literal statuses: **PROVED**, **CITED**, **FINITE-EXACT**, **VERIFIED**, **CONDITIONAL**, **OPEN**, **REFUTED**, **SUPERSEDED**.
...
Disconnected-low has `36,520` profiles and a five-edge cross tree. Large rulers, `q>=8p`, bounded-ratio gcd `>=19`, all `3:5`, and non-`3:5` `g>=4` close.
The [head-263 certificate](../07-reflections/lrc14-disconnected-head263-finite-exact-certificate-20260812.md) closes all 201,377 raw `p<264` channels by 509,483,810 exact comparisons.
THM-3356 reduces the `22,890` tails to `14,168` primitive determinant shells with sharp rank-five endpoint fingerprints, but carrier inequalities and the physical census remain OPEN; see the [geometric note](../07-reflections/lrc14-disconnected-low-geometry-and-g4-tail-20260812.md).

...
THM-3356 gives determinant shells. THM-3366 leaves refined `(rows,count)` `k=2:4,056/200,069,517,203`, `k=3:1,897/2,548,893,834`. THM-3385/3387--3389/3395 classify `15,393` rows and q=2--7. THM-3398 proves the all-q mode/cochain iff and dilation. Q8--14 rank-`<=5` probes reproduce rows/no rescues; a full audit finds later q8--15 edges. Q15 first needs a rank-six trimode outside the atlas; no decrement.

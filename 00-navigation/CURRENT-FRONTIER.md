...
THM-3420/3421/3423: prime zero cap7 iff `p=29`; prime half cap7 iff `p in {11,13,23,29}`. THM-3426 extends the odd-interval collision/clique law to rough moduli. THM-3428 proves the full-order rough half-twist classification: cap-seven support is exactly `Q in {11,13,23,29}`; mixed quotient orders stay open. THM-3368 has no clock seed; composite rank seven/LRC remain open.

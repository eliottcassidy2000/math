...
- **Factorial:** THM-3124--3201/3467/3475 close `{0,1,2}` through `r=2513`. THM-3467 resets `d=a p^k+1`, `2<=a<p`; THM-3474 adds binary submasks. THM-3475's all-divisor pair compiler closes 33/38 residuals through `d=2600`; first survivor: `d=2516`, degrees `{503,1006,1509,2012}`.

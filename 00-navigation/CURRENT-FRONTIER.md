...
- **PROVED rank descent and explicit residual atlas:** THM-2052 combines
  ...
  template; all boxes still need discharge. THM-2098 splits ranks 8--11 between seven transverse bands (budget `5(n-7)/49`) and seven guard-proportional bands; THM-2099 proves pair-tree data alone fails on dyadic affine pencils. The six persistent height-114 cut

...
THM-2331 embeds every THM-2325 address termwise. THM-2333/2334 reach full-word target-fibre Abel limits: some fibre survives, but it may be zero. THM-2337 proves word modes are mod-13 target-neutral, adds a factor-coloured first jet with full termwise response, and shows addresses lose that jet. THM-2340 identifies pure `a`, pure `b`, and fork landing with row, column, and interaction energy of the `13 x 13` twist matrix. Force the matching component, visibility, and phase.
...
- **Knots / operation-ready relations:** [THM-2176](../01-canon/theorems/THM-2176-gordian-continuation-profile-and-interaction-cocycle.md) gives the continuation kernel; [THM-2191](../01-canon/theorems/THM-2191-catalytic-localization-of-the-gordian-metric.md) gives catalytic localization and stable group length. THM-2220 gives fixed-context slopes; THM-2242 makes the kernel embedding isometric and identifies its atoms.
  ...
  Brittenham--Hermiller gives a finite/stable sole-cover drop at least one for `T(2,7)` and its mirror, while cited large-gap families make finite sole-cover drops unbounded. Conical controls exclude completeness only for fixed-arity root-defect/pair shadows. Positive catalysis and the exact diagonal remain open; the sharp cited seed is conditional `10_6`.

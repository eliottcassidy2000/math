...
THM-3434 closes odd transverse literal cap7 exactly on multiples of `9,11,13,15,23,25,29,51`; THM-3432 gives the conditional order-two fixed-chart transfer. Arbitrary-time rank7/LRC remain open.
...
- **Planar source fibres:** THM-2063/THM-2084--2247 close the affine-through-
  ...
  THM-3418/19 close sparse Keller/rank; THM-3422/24/27 give integral character laws; THM-3430/33 classify wrap/all-sector Prüfer arms, and THM-3436 gives repeated-root Artin jets. No multiroot nonwrap split or `JC(2)`/`DC(2)` follows.

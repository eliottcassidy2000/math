...
- **Factorial:** THM-3124--3201/3467/3475 close `{0,1,2}` windows through `r=2513`. THM-3467 gives the complete `p^k` reset for every `d=a p^k+1`, `2<=a<p`; THM-3474 adds the binary-submask families. THM-3475 compiles exact pair ledgers from digit weights at every `p|d-1`, closing 33/38 residuals through `d=2600`; the first survivor is `d=2516` with degrees `{503,1006,1509,2012}`.

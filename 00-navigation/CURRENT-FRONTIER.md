...
- **Seam/entry:** THM-4326/4329 close the fixed chart; 4330 leaves `2+12`;
  ...
  `||c||_1<=14` patterns. THM-4387/4391 close norm `16`; THM-4393 closes the
  six minimal norm-`18` sectors with defect `0,+/-3`. THM-4392 proves exact
  box-spline/Poisson duality and refutes shortest-orbit sufficiency;

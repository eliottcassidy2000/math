...
Source-cell is `91/91`,`72/72` but scalar AX/BY. Audited common-owner U_full
is cell-0 rank1 (MISTAKE-417); its audited square is rank4/all 36 mixed. The
root-difference candidate reaches maximal `(3,12,12)/432`; its audit, exact
address, U_clock and LRC remain open.

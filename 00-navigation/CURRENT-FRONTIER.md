...
empty aligned `k>=4`, cap `k=2,3` at `1611/270`, and close the common-level reflected `k=1` diagonal. Other censuses, arbitrary `k<=1`, the rung,
...
`1680..1742` `k=2` atlas, giving cap `1679`; three canonical atlases check `78,078` rows and give cap `1656` with five boundary rows.  Finite-exact boundary referees close those five, the twelve-row `z1650` shell, singleton shells at `1645,1642,1631,1630,1625,1618,1616`, and the complete `z1620` and `z1612` shells; the atlas gaps are empty, giving cap `1611`.  THM-2984's pair-free complete-section gate closes the hostile `z1620` row and all `7,094` exact classes in four hard `z1612` rows; the latter retain zero-supremum rays and use the sharp translated threshold `ceil(d/7)`.  Reserved THM-2980's full `1600..1679` claim remains open. For `k=3`, torsion/status closes through `297`;

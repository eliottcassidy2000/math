...
empty aligned `k>=4`, cap `k=2,3` at `1624/270`, and close the common-level reflected `k=1` diagonal. Other censuses, arbitrary `k<=1`, the rung,
...
`1680..1742` `k=2` atlas, giving cap `1679`; three canonical atlases check `78,078` rows and give cap `1656` with five boundary rows.  Finite-exact boundary referees close those five and the twelve-row `z1650` shell, then singleton shells at `1645,1642,1631,1630,1625`; the atlas gaps are empty, giving cap `1624`.  Reserved THM-2980's full `1600..1679` claim remains open. For `k=3`, torsion/status closes through `297`;

...
- **Factorial:** THM-3124--3201/3467 close `{0,1,2}` windows through `r=2499`; THM-3467 gives a complete `p^k` reset for every `d=a p^k+1`, `2<=a<p`. THM-3474 intersects it with the binary-submask polygon, closing all `d=2^s p^k+1` with `2<=2^s<p`. Next residual: `r=2500,d=2502`.

...
THM-2507--2524: every live THM-2349 word has first collision `L=1` with shallow/deep banks and a delayed owner; the `chi_7` bank recovers its even collision profile. Live: ordered Boolean emission and the `C_7` clock.

...
- **Planar source fibres:** THM-2063/THM-2084--2247 close the affine-through-
  ...
  THM-2063, not `JC(2)`. THM-3354 proves HYP-9031's direct D5 map impossible:
  the `F13`, Gaussian, `S3`, `mu_2`, and response carriers have trivial direct
  coefficient routes. Its cospan is definitional; localization can kill
  `theta_gen` while `theta_int` still obstructs a polynomial mate.

...
THM-3356 shells; THM-3366 leaves `(rows,count)` `k=2:4,056/200,069,517,203`, `k=3:1,897/2,548,893,834`. THM-3385/3387--3389/3395 classify `15,393` rows and q=2--7. THM-3398 proves all-q mode/cochain iff+dilation. Q8--14 `<=5` probes reproduce rows/no rescues; full audit finds q8--15 edges. Q15 trimodes start at rank6 outside the atlas; no decrement.

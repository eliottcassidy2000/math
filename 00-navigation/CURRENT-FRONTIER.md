...
- **PROVED:** [THM-2928](../01-canon/theorems/THM-2928-critical-seven-comb-grid-tensorization-and-drift-tariff.md): aligned seven leave `15/154`; literal six-body one-drift is empty by finite phase clocks; `>=2` drifts stay open.
...
- THM-2843 reduces every four-slot window either to an immediate
  ...
  torsor with quartic exit; THM-2929 makes `(0,1,2,R)`, `R>=13`, effective.
  Pluecker atlases remain open.  THM-2849/2854: finite Macaulay boxes;
  THM-2908/2921: width-four closure.  THM-2860 identifies

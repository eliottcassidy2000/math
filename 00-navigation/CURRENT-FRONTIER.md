...
THM-2331 now embeds every one of those relations, with at least `234375` two-sided lifts, as a nonzero fixed-parameter Abel term of the marked word/deepest-comb/bare current. The live gap is no longer address existence or termwise participation: it is a nonzero function-role/target-polarized fibre **sum** that survives cancellation, preferably in the bounded visible/Jackson carrier, together with THM-2303 terminal-component phase transport.

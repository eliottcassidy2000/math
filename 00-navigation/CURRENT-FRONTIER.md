...
| Operation-response | tournament joins/support unions | THM-2183/2195 classify the exact transitive product; THM-2221 gives `<X,D>`; THM-2242 closes transitive split response; THM-2249 gives the universal forced-pair energy `F_R<=G` and the sharp `C_3` frustration floor. Classify `G-F_R` on larger nontransitive cores and unpinned exchange. |

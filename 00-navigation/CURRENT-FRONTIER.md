...
THM-2981/3033/3041/3052/3061/3071/3078/3094/3098/3102/3106/3109/3111/3113/3114/3139/3174/3179/3207/3218/3230 close projected `k=3` through `z_1=219`. THM-3251 closes its `119` rows and composes THM-3242's `8` rows at `217`: cap `216`, ledger `373284`. THM-3261 closes the unique gcd-18 row there, then THM-3264 closes the intrinsic low-cost `17/19` gcd-eight sublayer: ledger `373266`, residual `462=429` wall plus `33` order. The two high-cost gcd-eight rows and every gcd `24,36,72` row remain open; THM-3245's pointed divisors remain metadata, not a common action.

...
Disconnected-low has `36,520` profiles and a five-edge high tree. Large rulers, `q>=8p`, gcd `>=19`, all `3:5`, non-`3:5` `g>=4`, and the 201,377-channel [raw head](../07-reflections/lrc14-disconnected-head263-finite-exact-certificate-20260812.md) close. OPEN: `22,890` affine tails; see the [frontier note](../07-reflections/lrc14-disconnected-low-geometry-and-g4-tail-20260812.md).

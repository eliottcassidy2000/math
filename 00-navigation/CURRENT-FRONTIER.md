...
THM-2507--2517 close Radon, moments, and `K_14`/correlation/simplex charts. Cubically, a zero phase detects at a fixed clock; full support gives a neutral owner gate at a `C_7`-torsor clock. Emission/loop drift remains open.

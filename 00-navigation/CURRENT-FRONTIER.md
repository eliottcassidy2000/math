...
empty aligned `k>=4`, cap `k=2,3` at `1649/270`, and close the common-level reflected `k=1` diagonal. Other censuses, arbitrary `k<=1`, the rung,
...
`1680..1742` `k=2` atlas, giving cap `1679`; three canonical atlases check `78,078` rows and give cap `1656` with five boundary rows.  A separate finite-exact boundary referee closes all five, giving cap `1655`.  The exact `1600..1655` atlas then has twelve top rows at `1650` and an empty `1651..1655` gap; status/projected, forced-high scalar, and a final located-torsion/projected split close all twelve, giving cap `1649`.  Reserved THM-2980's full `1600..1679` claim remains open. For `k=3`, torsion/status closes through `297`;

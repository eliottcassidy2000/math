...
Source `91/91`,`72/72` scalar; common-owner cell-0
rank1 (MISTAKE-417); square/root/pointed are audited at
`4/36`,`(3,12,12)/432`,`(5,12,12)`. Source-sheet is audited rank6/432;
current x root reaches `(3,4,12,12)/5184` through pointed-six. Current audit,
source-current cross, address/U_clock/LRC remain open.

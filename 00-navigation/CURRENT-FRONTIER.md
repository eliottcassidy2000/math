...
- **PROVED + FINITE-EXACT:** THM-741/2883 close `2002` nine-body roots;
  ...
  THM-2896 gates `3432` residual roots: one has `K=25`, others
  `K<=23`.  THM-2895's marked parity descent closes four roots, leaving
  `3428`; THM-2897's next cheap suffix test is `q_5+2B_2<h`, not yet censused
  uniformly.

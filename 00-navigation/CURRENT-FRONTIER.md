...
THM-2507--2521: collision drift is a coprime jump current and injects into the `K_14` potential slice. Typed pre/deep control is positive, not a scalar row. Live: balanced-fibre exclusion, Boolean/scalar transfer, and the `C_7` clock.

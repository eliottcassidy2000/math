...
THM-3356 gives determinant shells. THM-3366 leaves refined `(rows,count)` `k=2:4,056/200,069,517,203`, `k=3:1,897/2,548,893,834`. THM-3385/3387--3389/3395 classify `15,393` rows and q=2--7 covers; the q=8 mode probe has `32` edges/`1,152` rows. Seven refine; no decrement.

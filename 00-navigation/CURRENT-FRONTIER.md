...
**OPEN.** THM-2923 closes all `3,432` seven-window roots; the remainder has
at most six speeds. THM-2051/2052 leave a sparse code of rank `>=11`; failed
gates are not danger.
...
- **Seam/entry:** THM-4326/4329 close fixed chart; THM-4330/4335 leave
  `2+12`, and THM-4347 closes height `40`. THM-4349/4371 give clocks;
  THM-4374 recovers common-tail `P` after 17 metric shifts,
  but none enters the seam. THM-4370/4372 force seven lower tails and a `4/7`
  rebate; THM-4373 gives the signed-`(1,2,1)` scale-three `6/77` bound.
  Lower/nonresonant sectors and entry remain open.
...
- THM-2810--3107 form the bounded selector hierarchy: no bounded factorial
  carrier; exact Laguerre quotients at height `2D-1`; three-slot, cone, finite
  four-slot, modular, Smith, ULC, Gamma/Hankel, and anchored-AP certificates.
...
`e+pi` and Khinchin's constant remain **OPEN**; THM-4056 only separates
lift/phase clocks.
...
- THM-4056 gives exact-denominator LCM packets, not overlap independence.
...
- Sun `2-4-6-8`: discharge the global leastness gap, classify holes outside
  the one audited CRT class, prove lower-tail/density control, and retain
  height-aware local factors, norm intersections, and rank-labelled Pascal
  carries.
...
- **Jacobian/Dixmier:** `JC(2),DC(2)` are **OPEN**. THM-4130--4248 close
  ...
  THM-4357--4361 close zeta/beta-zero. THM-4362/4364/4368/4369 give the
  diagonal hierarchy, rank/address clocks, and exact Pascal kernel/boundary
  basis; THM-4366 closes `U=0` through row 11. Other strata/seam entry remain open.

...
- **Factorial:** THM-3467/3474/3475 give all-`a` resets, binary submasks, and divisor pair ledgers. THM-3478's dual exact block closes `{0,1,2}` through `r=2603`; first survivor `d=2606` has degrees `{521,1042,1563,2084}`.

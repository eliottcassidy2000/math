...
| diameter-layer metric/algebra | `dist([0],[C_m])=ceil((m-2)/(D-1))`, `deg([0])=D-1`; multiplicity-weighted cycle operators commute, but Boolean supports fail already at n=4 (THM-4073) |

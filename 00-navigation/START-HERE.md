...
15. **Every counterexample is in a finite labelled code/deck/fan atlas.**
    ...
    THM-2452--2526 give every live THM-2349 word sharp `L=1` drift, shallow/deep banks, a delayed owner, and a lossless guard-oriented odd bank. Live: Boolean owner/source emission and the `C_7` clock.

...
1. **LRC(14) is first open.** THM-2923 leaves `<=6` bodies; THM-2928/2941 empty aligned `k>=4`, cap `k=2,3` at `2142/378`, leaving `k<=1` and rung open. [Sources](../05-knowledge/reference/CORE-PAPERS.md).

...
12. **JC is false from dimension three; JC(2) and DC(2) remain open.** THM-1300 is the exact new counterexample. THM-2063/2071 close linear/quadratic source fibers; THM-2084/2118/2102 close cubics; THM-2202 removes every twice-odd finite pole.
    ...
    At degree `22`, THM-2411--2480 close axes and planes, and THM-2671/2683/2692 close supports three/four/five, emptying the inherited exact-square-prefix genuine-nonsplit branch. THM-2725/2745 and the independent THM-2752/2755 closures empty the chosen-sheet split degree-22 response family. The broader split chart, raising, outside branches, `JC(2)`, and `DC(2)` remain open.

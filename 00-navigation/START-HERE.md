...
1. **LRC(14) is first open.** THM-2923 leaves `<=6` bodies; THM-2928 empties aligned `k>=4`; THM-2995/3071 cap projected `k=2,3` at `1579/234`; THM-2941's repaired fixed-owner tails leave the reflected wedge `561` bodies, `D>=6,1<=m<2D/3`. Arbitrary `k<=1` and the rung remain open. [Sources](../05-knowledge/reference/CORE-PAPERS.md).

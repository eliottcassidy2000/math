...
12. **JC is false from dimension three; JC(2) and DC(2) remain open.** THM-1300
    ...
    nonsplit deck and THM-2194 closes degree six; THM-2202 then closes every
    twice-odd reduced degree uniformly. No quartic finite-pole survivor remains.
    THM-2181 closes monic depressed quartics; the terminal nonmonic square-prefix descent remains, not a planar classification.
...
15. **Every counterexample is in a finite labelled code/deck/fan atlas.**
    ...
    THM-2196/2199 prove rank twelve by height `78*182^13`; THM-2192/2198 leave 216 scalar profiles and close `(1,1,2)`.
    THM-2204 closes `(2,2,3)`, leaving only `(1,1,3)/(1,2,3)` at deepest depth three.

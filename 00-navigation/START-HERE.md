...
12. **JC fails from dimension three; JC(2), DC(2) are open.** THM-2084 gives
    `M=10`; THM-4248/4226 close `M=11/13`; THM-4290--4344/4350--51 close many `M=12`
    lanes; THM-4353 closes the simultaneous `K=0,U!=0` endpoint. The `U=0`
    intersection and seam entry remain.

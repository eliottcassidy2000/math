...
12. **JC is false from dimension three; JC(2) and DC(2) remain open.** THM-1300 is the exact new counterexample. THM-2063/2071 close linear/quadratic source fibers; THM-2084/2118/2102 close cubics; THM-2202 removes every twice-odd finite pole.
    ...
    At degree `22`, hostile-audited THM-2411 closes `mathcal A=0`; hostile-audited THM-2423/2425/2428 close all five one-sparse axes in `mathcal A!=0`. THM-2429/2437/2463/2468 close four support-two planes: `C,W`, `D,W`, `B,D`, and `B,W`. The other six support-two planes, higher mixed strata, split/even descent, integral `2`-adic order raising, `JC(2)`, and `DC(2)` remain open.
...
15. **Every counterexample is in a finite labelled code/deck/fan atlas.**
    ...
    THM-2452/2459 retain a complete endpoint mask, drift, and supplied root service; THM-2461 proves the semantic word is temporal and the owner/deep roots are differently typed. THM-2466 now proves that any supplied owner-supported common root base admits one sufficiently delayed semantic word retaining both observables. The live gap is construction of that canonical common base/service, not further word mixing.

...
15. **Every counterexample is in a finite labelled code/deck/fan atlas.**
    ...
    THM-2452/2459 drift/service; THM-2466 words; THM-2471/2478 colours/owner. THM-2507--2521 make drift a coprime jump current in the `K_14` potential slice. Typed pre/deep control is positive, not a scalar row. Live: Boolean/scalar transfer and the `C_7` clock.

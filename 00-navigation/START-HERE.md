...
15. **Every counterexample is in a finite labelled code/deck/fan atlas.**
    ...
    THM-2452/2459 retain drift/service; THM-2466 closes words; THM-2471/2478 give all collision colours and a neutral future owner. THM-2507 detects `>=7/12` nonaffine toothpick slopes (atlas: `11/12`), but cut/carry is not a physical current. The live gap is charge/deep scale-sheet transport or owner-loop drift.

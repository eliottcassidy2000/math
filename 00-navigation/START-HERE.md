...
12. **JC is false from dimension three; JC(2) and DC(2) remain open.** THM-1300 is the exact new counterexample. THM-2063/2071 close linear/quadratic source fibers; THM-2084/2118/2102 close cubics; THM-2202 removes every twice-odd finite pole.
    ...
    At degree `22`, THM-2671/2683/2692 empty the inherited nonsplit branch and THM-2725/2745/2752/2755 empty its split family. THM-2778 closes the complete chosen-sheet split polynomial exact-prefix family for every `M=4k-2` via recurrence-tail square, half-binomial root-zero exclusion, and slope four. Nonsplit/nonpolynomial-prefix degrees `>=26`, chart entry, raising/descent, other branches, `JC(2)`, and `DC(2)` remain open.

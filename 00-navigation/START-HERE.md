...
9. **Whole-packet Frobenius is not an LRC proof.** THM-2041 preserves packets; THM-3234/3240 give carriers; THM-3243 separates point/full-centre blowup equivariance; THM-3247 makes each endpoint current translation-cyclic on `169` states. Physical target/ancestry/exit remain missing.
...
11. **A reciprocal integer sequence has two profiles.** THM-2000/2005/2352 separate support, multiplicity, and q-adic thresholds; THM-2438/2433/2500 give the Poisson--Newton transform and finite-hole classification.
    THM-3186 gives P-recursive factorial tails; THM-3231 preserves the strict transform; THM-3238 stitches one complete `4,319`-state reset bank. Candidate THM-3244 refutes one-pole Morse flow but finds sharp radius-10 routing. Other faces, the next recurrence row and `FC(3)` remain open.

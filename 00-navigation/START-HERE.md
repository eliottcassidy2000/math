...
12. **JC is false from dimension three; JC(2) and DC(2) remain open.** THM-1300 is the exact new counterexample. THM-2063/2071 close linear/quadratic source fibers; THM-2084/2118/2102 close cubics; THM-2202 removes every twice-odd finite pole.
    ...
    THM-3057/3059 identify Jelonek parity with tame inertia sign but do not exclude Keller `C3`. THM-3070/3074/3080/3081 terminate the coordinate-line `C3` key tower in a Mobius decoder. THM-3131 identifies its local full-resolvent field and proves the `V4` Kummer packet splits there, forcing a multi-place or marked gluing sidecar.

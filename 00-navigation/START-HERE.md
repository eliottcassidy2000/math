...
12. **JC is false from dimension three; JC(2) and DC(2) remain open.** THM-1300 is the exact new counterexample. THM-2063/2071 close linear/quadratic source fibers; THM-2084/2118/2102 close cubics; THM-2202 removes every twice-odd finite pole.
    ...
    THM-3070/3074/3080/3081 terminate the coordinate-line `C3` key tower in a Mobius decoder. THM-3141 identifies its local full-resolvent field and proves the `V4` Kummer packet splits there; its graph-quartic addendum proves the surviving `q_0` cubeclass is automatically saturated and isolates the uncontrolled terminal-prefactor class `[L]`, forcing a multi-place, marked, or companion sidecar.

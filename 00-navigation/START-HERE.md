...
12. **JC is false from dimension three; JC(2) and DC(2) remain open.** THM-1300 is the exact new counterexample. THM-2063/2071 close linear/quadratic source fibers; THM-2084/2118/2102 close cubics; THM-2202 removes every twice-odd finite pole.
    ...
    At degree `22`, hostile-audited THM-2411 closes `mathcal A=0`; candidate THM-2423 closes the full `W`-axis in `mathcal A!=0`, and candidate THM-2425 closes the `C,D,E` axes. The trigonal `B`-axis, mixed strata, split/even descent, integral `2`-adic order raising, `JC(2)`, and `DC(2)` remain open.

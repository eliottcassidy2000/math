...
15. **Every counterexample is in a finite labelled code/deck/fan atlas.**
    ...
    THM-2452--2528 give every live word sharp `L=1` drift and a positive owner-coupled Boolean odd path. THM-2529/2530 give a lossless deep-Gram skew. Live: scalar source--arrival transfer and the `C_7` clock.

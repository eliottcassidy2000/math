...
1. **LRC(14) is first open.** THM-2923 leaves `<=6` bodies; THM-2928/2941/2970/2972 and finite-exact boundary referees through the `z1=1616` shell empty `k>=4`, give cap `k=2,3` at `1615/270`, compress the raw `k=2/3` denominator ledgers to `200.14b/2.55b`, and close the common-level reflected `k=1` diagonal. Other `k<=1` and the rung are open; reserved THM-2980's full band statement is not yet proved. [Sources](../05-knowledge/reference/CORE-PAPERS.md).

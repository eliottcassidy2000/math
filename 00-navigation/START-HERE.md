...
9. **Whole-packet Frobenius is not an LRC proof.** THM-2041 preserves packets; THM-3245 makes divisor restorations idempotent. THM-3234/3240/3243/3247/3250 close abstract carrier/charged algebra; THM-3252 closes the signed owner determinant. Positivity, endpoint provenance, neutral data, target/ancestry/exit remain open.
...
11. **A reciprocal integer sequence has two profiles.** THM-2000/2005/2352 separate support, multiplicity, and q-adic thresholds; THM-2438/2433/2500 give the Poisson--Newton transform and finite-hole classification.
    THM-3186 gives P-recursive factorial tails; THM-3231 preserves the strict transform; THM-3238 stitches one complete `4,319`-state reset bank. Audited THM-3244 refutes the `H`-induced one-pole flow but gives a lawful state-dependent two-row one-pole atlas (31 covering pairs; sharp two-switch depth) and sharp radius-10 routing. Other faces, the next recurrence row and `FC(3)` remain open.

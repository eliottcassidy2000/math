...
15. **Every counterexample is in a finite labelled code/deck/fan atlas.**
    ...
    THM-2452/2459 retain drift and service; THM-2466 closes word retention. THM-2471 constructs first-collision service and all twelve colours; THM-2478 adds a future owner edge and aligns every future colour with the old drift, but the neutral new leg and deep ancestry sheet remain. THM-2507 proves that six nonaffine seven-point toothpick directions detect the punctured `13 x 7` defect modulo its vertical kernel; at least seven of twelve slopes survive universally, and the complete THM-2436 atlas has eleven or twelve, but the ordered cut/carry fold is not yet a physical target/owner/deep current. The live gap is scale/sheet transport or owner-loop drift.

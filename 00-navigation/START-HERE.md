...
15. **Every counterexample is in a finite labelled code/deck/fan atlas.**
    ...
    THM-2452--2524 give every live THM-2349 word an `L=1` collision with shallow/deep banks and a delayed owner; `chi_7` recovers its even collision profile. Live: ordered Boolean emission and the `C_7` clock.

...
1. **LRC(14) is first open.** THM-2923 leaves `<=6` bodies; THM-2928 empties aligned `k>=4`; THM-2995/3111 cap projected `k=2,3` at `1579/229`; THM-2941 leaves `561` reflected bodies. THM-3126 closes six prefixes, not this cap; arbitrary `k<=1` and the rung remain open. [Sources](../05-knowledge/reference/CORE-PAPERS.md).

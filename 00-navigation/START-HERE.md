...
15. **Every counterexample is in a finite labelled code/deck/fan atlas.**
    ...
    THM-2452/2459 retain drift and service; THM-2466 closes word retention. THM-2471 constructs first-collision service and all twelve colours; THM-2478 adds a future owner edge and aligns every future colour with the old drift, but the neutral new leg and deep ancestry sheet remain. The live gap is scale/sheet transport or owner-loop drift.

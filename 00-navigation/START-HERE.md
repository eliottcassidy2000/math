...
12. **JC fails from dimension three; JC(2), DC(2) are open.** THM-2084 gives
    `M=10`; THM-4248/4226 close `M=11/13`; THM-4290--4354 close many `M=12`
    lanes, including `K=0,U!=0` and `U=0,K*alpha_11!=0`. The complementary
    endpoint, `U=K=0`, and seam entry remain.

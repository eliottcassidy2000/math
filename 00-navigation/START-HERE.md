...
15. **Every counterexample is in a finite labelled code/deck/fan atlas.**
    ...
    THM-2198--2239 leave `165` first-depth-one rows and `(3,4,5)`; THM-2250/2257/2258 close the latter by two independent mechanisms. THM-2263 gives profile-sharp owner floors, but THM-2261 proves raw expiration maps onto the whole circle. THM-2264/2265 force bounded global and cross-cut relations; the missing target must couple those frequencies to a marked multicore handoff. THM-2211 retains carry; THM-2235 forbids an odd-sheet XOR-antipode shortcut.

...
15. **Every counterexample is in a finite labelled code/deck/fan atlas.**
    ...
    THM-2198--2229 reduce the scalar ledger to `240`; THM-2233/2239 leave exactly `194` profiles, split as `165` at first depth one and `29` at first depth three. THM-2234 gives private first-depth-one expansion, THM-2211 retains carry, and THM-2235 forbids an odd-sheet XOR-antipode shortcut.

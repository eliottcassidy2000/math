...
15. **Every counterexample is in a finite labelled code/deck/fan atlas.**
    ...
    THM-2198--2239 leave `165` first-depth-one rows and `(3,4,5)`; THM-2250/2257 close the latter. THM-2234 gives private expansion. THM-2255 gives quantitative exclusive-owner mass and a greater-than-one-comb expiration spill on the `150` strict rows. THM-2261 proves raw expiration maps onto the whole circle, so the missing target must use global multicore cover data. THM-2211 retains carry; THM-2235 forbids an odd-sheet XOR-antipode shortcut.

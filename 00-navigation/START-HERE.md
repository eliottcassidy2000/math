...
11. **A reciprocal integer sequence has two profiles.** THM-2000/2005 separate support from multiplicity; THM-2352 separates q-adic thresholds.
    THM-2438 gives Poisson--Newton and reciprocal support = mean divisor scar at the Abel--Dini/Bertrand boundary.
    THM-2433/2441 classify finite holes: additive atoms stop linearly; prime holes emit exact disjoint prime rays.
12. **JC is false from dimension three; JC(2) and DC(2) remain open.** THM-1300 is the exact new counterexample. THM-2063/2071 close linear/quadratic source fibers; THM-2084/2118/2102 close cubics; THM-2202 removes every twice-odd finite pole.
    ...
    At degree `22`, hostile-audited THM-2411 closes `mathcal A=0`; hostile-audited THM-2423/2425/2428 close all five one-sparse axes in `mathcal A!=0`. Hostile-audited THM-2429 and THM-2437 close the first two support-two planes `C,W` and `D,W`. The other eight support-two planes, higher mixed strata, split/even descent, integral `2`-adic order raising, `JC(2)`, and `DC(2)` remain open.

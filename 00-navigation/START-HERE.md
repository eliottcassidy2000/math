...
15. **Every counterexample is in a finite labelled code/deck/fan atlas.**
    ...
    THM-2198--2229 close depths three/four and leave exactly `240` scalar profiles; THM-2232 excludes only the high-first common-core model, THM-2234 gives private first-depth-one expansion, THM-2211 retains carry, and THM-2235 forbids an odd-sheet XOR-antipode shortcut.

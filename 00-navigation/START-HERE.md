...
1. **LRC(14) is first open.** THM-2923 leaves `<=6` bodies; THM-2928/2941/2970/2972/2981 and the finite-exact `z1=1656` referee empty aligned `k>=4` and give `k=2,3` caps `1655/246`. Reflected `k=1` closes through spread four on all bodies and at arbitrary levels on `2,217/3,003`; the other `786`, `k=0`, the rung, and reserved THM-2980 remain open. [Sources](../05-knowledge/reference/CORE-PAPERS.md).

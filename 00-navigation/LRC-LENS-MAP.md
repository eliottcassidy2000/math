...
- the primitive `n=12` sporadic problem is finite and ramification-stratified;
  its AP-centred common-scale H6 faces are closed through scale fourteen
  (with scale thirteen primitive-impossible), but scale fifteen and higher, the finite H5 bank,

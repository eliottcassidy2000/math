...
- the primitive `n=12` sporadic problem is finite and ramification-stratified;
  ...
  primes in THM-860's finite range.  THM-986 independently closes composite
  `c=20` with an at-most-two-feasible-owner certificate; the remaining
  composite faces beginning at `c=21`, finite H5 bank, and

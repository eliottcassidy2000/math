...
- the primitive `n=12` sporadic problem is finite and ramification-stratified;
  ...
  making the overlap/projection debt literal.  THM-989 currently claims `c=22`
  pending frozen dual replay.  The remaining composite faces beginning after
  that claim, the finite H5 bank, and

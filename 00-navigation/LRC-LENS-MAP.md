...
- the primitive `n=12` sporadic problem is finite and ramification-stratified;
  ...
  (with scale thirteen primitive-impossible), but scale eighteen and higher, the finite H5 bank,

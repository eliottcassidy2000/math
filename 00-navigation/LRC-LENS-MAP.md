...
| Minkowski/circuit/Ising/De Moivre cut-payload lens | q-body volume gate, proof-circuit minterms, partition-zero arc, fifth-root fold orbit | witness time, endpoint owner, root stratum, branch address, and route legality if the outside theorem is cited without a cut payload | `q_body_inequality_word`, `proof_circuit_missing_input_vector`, `ising_zero_arc_signature`, `demoivre_branch_orbit_word`, finite-address and observer-gluing status | HYP-3111 source bridge into HYP-3113 two-map packet-sheaf legal exit |

...
- the primitive `n=12` sporadic problem is finite and ramification-stratified;
  its AP-centred common-scale H6 faces are closed through scale fifteen
  (with scale thirteen primitive-impossible), but scale sixteen and higher, the finite H5 bank,

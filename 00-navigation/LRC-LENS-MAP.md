...
- the primitive `n=12` sporadic problem is finite and ramification-stratified;
  ...
  primes in THM-860's finite range.  THM-986 has a frozen primary `c=20`
  owner-local certificate but remains provisional pending its independent
  referee; the remaining composite faces, finite H5 bank, and

...
| **LRC n=14 unit-spine slack fibre** | Dihedral quotient of the strict sub-edge n=14 proof ledger after the nine unit shells modulo `27` are forced | S576 fixes the canonical unit spine `(1,2,4,5,7,8,10,11,13)` and scans four nonunit/zero-residue slack runners. Through slack `<=42`, all `531` full D/U/N quotient covers have `M>=1/14`, with only AP and `V*` at the floor. S578 sharpens the exchange gap: one-unit lifts through `81` over all canonical slack rows have `13169/13169` full covers certified by unblocked small pairs, so cheap-pair sieve precedes any delicate unit lowering. | HYP-2100, HYP-2099, HYP-2098, HYP-2097, HYP-2096, HYP-2095, HYP-2094, HYP-2092, HYP-2088, HYP-2087, HYP-2084, THM-397, S576, S578, `04-computation/lrc_n14_dihedral_spine_pivots_s576.py`, `04-computation/lrc_n14_unit_spine_exchange_s578.py` |
...
| **LRC fixed-boundary owner scaffold** | Two-layer n=14 certificate architecture: fixed round boundary plus speed-owner unit-spine labels | HYP-2098 shows the 64 self-converse classes overcount tightness and the real tight speed family appears to be `{AP,V*}` on a mod-7 tie-wall. Opus S570 covers the transversal flip-lattice (`8191/8191` lonely and unblocked, AP unique tight). S578 covers the composite unit-spine fibre (`820` labelled anti-witness vectors -> `64` groups; `63/64` strong/unique-axis): AP and `V*` are the only floor rows and both have cheap pair `(1,13)`, while the only block-all full covers are positive-measure controls. | HYP-2099, HYP-2098, HYP-2097, HYP-2096, HYP-2095, HYP-2094, THM-397, S578, Opus S570, `04-computation/lrc_n14_fixed_round_certificate_s578.py` |

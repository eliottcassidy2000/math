...
| **LRC / unit-distance channel ledger** | Cross-problem bridge that treats state-local frontiers as lossy unless load-bearing side channels are retained | S624 reserves HYP-2197 for a paired impairment program: LRC witness-orbit jackknife over survival masks on `Z/(2n-1)` and unit-distance direction/gain/orbit impairment over the S622/S623 Moser lanes. The shared object is a damage-response ledger over proof obligations. LRC channels include owner routes, carry cocycles, pinch certificates, CRT/lift data, and Cprime windows; unit-distance channels include direction support, high-gain packets, compactness, canonical orbit budget, deletion resilience, and obstruction labels. | HYP-2197, HYP-2196, HYP-2194, HYP-2188, HYP-2187, HYP-2175, T693, T692, S624, S623, S599w-x, `07-reflections/lrc-unit-distance-channel-ledger-s624.md` |

...
| **LRC threshold-decorated class fiber** | A000568 tournament class plus circular/tie-wall stratum, observer mark, and `1/n` threshold colors on gaps or pair-cells | Raw phase, observer-marked, gap-rank, and pair-deficit-rank classes are mixed in small LRC audits; threshold-decorated gap and pair-cell fibers produce good-only classes that sampled clocks must visit | HYP-1982, HYP-1976, HYP-1951, S512, `04-computation/lrc_iso_class_constraint_s512.py` |
...
| **LRC add/multiply gauge stack** | Denominator-level Tournament Analysis over the `x+2` odd-core and `x*2` dyadic grid | Addition contributes Goldbach/Lemoine representation fibers; multiplication contributes divisor/dyadic branches; product-sum equations label operation collisions; scalar gauges are transitive ledgers, while majority conflicts produce nontrivial H, c3, SCC, and edge-flip fingerprints | HYP-1984, HYP-1983, HYP-1982, HYP-1981, HYP-1980, HYP-1979, HYP-1978, HYP-1977, HYP-1976, HYP-1975, S513, `04-computation/lrc_add_mult_gauge_stack_s513.py` |

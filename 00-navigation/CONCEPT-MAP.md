...
| **LRC apex-lift certificate sheaf** | Local cheap-pair certificates glued over the mod-7 tight tie-wall | S579 reframes the HYP-2099 bridge lemma as a sheaf over six mod-7 antipodal lanes plus the self-antipodal apex. Local sections are HYP-2095 cheap-pair certificates carrying shield/anchor, D/U/N, endpoint-owner, and unit-spine labels. Transversals are global sections, HYP-2100 unit-lift full covers are cheap-pair-first sections, Opus S571 multiple-of-n rows are positive-measure apex-seam controls, `V*` is the first nonunit apex lift where `(1,13)` still glues, and block-all rows are failed gluing attempts conjectured to force positive measure. The proof target becomes apex-lift preservation or section-obstruction positivity, not enumeration of 64 classes. | HYP-2101, HYP-2100, HYP-2099, HYP-2098, HYP-2097, HYP-2096, HYP-2095, HYP-2088, HYP-2083, THM-397, S579, Opus S571 |

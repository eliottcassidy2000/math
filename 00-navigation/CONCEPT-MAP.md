...
| **LRC observer-source marked tournament** | Mark the stationary observer and orient observer-to-runner arcs by the LRC threshold `||v_i t|| >= 1/n` | THM-381: observer loneliness is exactly the observer being a source; the source-marked target is counted by `A000568(n-1)`, so LRC becomes marked source-class reachability | THM-381, HYP-1981, HYP-1977, HYP-1979, S511, `04-computation/lrc_observer_source_tournament_s511.py` |
...
| **LRC threshold-decorated class fiber** | A000568 tournament class plus circular/tie-wall stratum, observer mark, and `1/n` threshold colors on gaps or pair-cells | THM-382: bounded `n=3,4` audits separate only after threshold decoration; THM-383: equality walls expand the bounded half-turn class menu, so boundary compactification is part of the proof object | THM-382, THM-383, HYP-1982, HYP-1976, HYP-1951, S512, `04-computation/lrc_iso_class_constraint_s512.py` |
...
| **LRC proof-route currencies** | Literature/proof-route atlas for Lonely Runner: finite product-sieve, spectral/kernel, zonotope, and endpoint-pressure proof currencies | The 2025-2026 fixed-case frontier is product-sieve plus finite checking through thirteen total runners; kernel and mixed-threshold tools feed endpoint pressure; shifted zonotope analogies need quarantine | HYP-1969, S505, HYP-1812, HYP-1950, HYP-1961 |

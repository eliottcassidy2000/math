...
| **LRC n=14 unit-spine slack fibre** | Dihedral quotient of the strict sub-edge n=14 proof ledger after the nine unit shells modulo `27` are forced | S576 fixes the canonical unit spine `(1,2,4,5,7,8,10,11,13)` and scans four nonunit/zero-residue slack runners. Through slack `<=42`, all `531` full D/U/N quotient covers have `M>=1/14`, with only AP and `V*` at the floor. The proof gap is the unit-representative exchange lemma: arbitrary large unit-shell representatives must normalize to the spine or expose a floor/pair-sum witness before the four-slack composite ledger remains. | HYP-2096, HYP-2094, HYP-2092, HYP-2088, HYP-2087, HYP-2084, THM-397, S576, `04-computation/lrc_n14_dihedral_spine_pivots_s576.py` |

...
| **Tournament Analysis** | Pipeline from pairwise/geometric data to binary comparators/gauges/switchboards, tournaments, invariants, and wall-crossing paths | Rankers summarize objects; switchboards summarize relations; edge-local/switch lifts preserve cyclic structure; THM-372/373/374 give the finite switchboard, runner-clock, and semicircle base cases; LRC hard rows now use two-clock corridor overlays and endpoint-labelled pressure DAGs | HYP-1931, HYP-1932, HYP-1940, HYP-1941, HYP-1942, HYP-1951, HYP-1952, HYP-1964, HYP-1965, HYP-1966, HYP-1967, HYP-1968, THM-372, THM-373, THM-374, S23, S454, S455, S480, S471, S493, S495, S502b, S504 |
...
| **LRC first-even bridge seam** | First doubling `m -> 2m` in Lonely Runner denominators, with inherited odd-parent units and new nonunit bridge room | `n=14` has six even bridges; `n=18` has two triadic bridges `(6,12)`; gap-debt product and pressure peeling are key ledgers; hard positive gaps are short corridors through half-turn tournament-clock cells with boundary alignment ratios `3/7` and `3/11` | HYP-1905, HYP-1910, HYP-1920, HYP-1942, HYP-1950, HYP-1952, HYP-1967, S453, S455, S490, S492, S493, S502b |

...
| LTI-201 | Observer-extension cut payload calculus | Quotient, next operation, observer-extension payload, sidecar observability, endpoint owners, capacitor cuts, rectangle/hourglass defects, blocker teeth, automaton handoffs | Abstracts the HYP-3050 observer-extension/cut defect into the general controlled-forgetting test across repo problems: a quotient is legal only after the payload for its next outside operation is retained, reconstructed, dual/cut/cocycle-annihilated, descended, boundary-stopped, or routed to named residual debt.  This reclassifies pair-good decoys by blocker generator and active-owner/barcode relation, residual capacitors by first cut/zeta/endpoint-owner exit, AP-tail collisions by q13 clock, automaton shadows by magnitude/topology/owner handoff, diagonal-layer lines by rectangle/hourglass defect, and matrix invariants by observability columns. | HYP-3054, HYP-3053, HYP-3052, HYP-3051, HYP-3050, HYP-3049, HYP-3048, HYP-3047, HYP-3046, HYP-3045, HYP-3043, HYP-3040, HYP-3039, HYP-3037, HYP-3034, HYP-3024, HYP-3022, HYP-3021, HYP-3018, HYP-2997, HYP-2995, HYP-2991, HYP-2989, HYP-2963, THM-381, THM-385, THM-572, T1136, T1135, T1134, T1133, T1132, T1131, LTT-099, LTT-098, LTT-097, LTT-096, LTT-095, LTT-094, LTI-200, LTI-199, LTI-198, LTI-197, LTI-196, LTI-187 | Add manifest fields `quotient`, `next_operation`, `observer_extension_payload`, `discharge_rule`, `extension_address`, `cut_or_cycle_defect`, and `route_owner_certificate`; build HYP-3048 observability matrices whose rows are coarse-fiber packet pairs and whose columns are these payloads. |
...
| LTI-TODO-64 | Observer-extension perspective carrier theorem | LTI-201, LTI-197, LTI-196, LTI-195, LTI-194, LTI-191, LTI-187, LTI-175, LTI-169, LTI-168, LTI-144, LTI-141, LTI-112, LTI-008, LTT-099, LTT-095, LTT-094, LTT-093, LTT-092, LTT-089, LTT-085, LTT-073, HYP-3054, HYP-3050, HYP-3049, HYP-3048, HYP-3047, HYP-3046, HYP-3043, HYP-3040, HYP-3039, HYP-2210, HYP-2120, HYP-1978, HYP-1977, THM-381, THM-385, THM-260, THM-409, T1136, T1132, T1131, T1130, T1129 | Define observer-extension cut perspectives, extend exact node/edge/triple/cycle/conflict carrier counts to `m=6`, and test whether ordered-pair sector decks, cross-sector orientation, and edge tail/tip sector words classify pair-good decoy generators and residual capacitor cuts before raw counts matter. Every new tournament-analysis script should declare whether vertices are nodes, ordered pairs, directed edges, directed cycles, proof obligations, or conflict fibers before adding scalar sidecars. |

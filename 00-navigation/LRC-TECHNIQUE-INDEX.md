...
| LTI-252 | Circuit missing-input kernel ledger | Endpoint-cover activations, `Phi` gap sum, `P` max activation, proof-circuit inputs, essential-input sets, certificate minterms, Boolean-Mobius cuts, Toeplitz/Fejer and Haar dual gates, finite-address and observer-gluing sidecars | HYP-3116/S266 turns circuit complexity into a proof-facing missing-input discipline.  The incoming broad audit models `LRC14Statement` as a shallow monotone proof circuit with `12` essential inputs and minterms `direct_witness`, `ap_gw_boundary`, or `finite_address AND observer_gluing AND endpoint_owner AND uniformity AND X`; ten tempting shortcuts close `0/10`.  The augmented endpoint-cover ledger mines `13` proof gates and ranks HYP-2112's `endpoint_phi_sum_gap` first: `P(S)` from HYP-2108 is the max activation and `Phi(C)=G(v)` from HYP-2112 is the sum activation equal to the exact gap.  Top endpoint-ledger missing inputs are `endpoint_cover_activation_vector` (`6` gates), `finite_address_packet` (`5`), `observer_gluing_certificate` (`4`), and `endpoint_period_numerator_sidecar` (`3`).  Circuit complexity therefore becomes kernel exclusion for the endpoint-cover activation circuit, with HYP-2791's low-depth Boolean cut, HYP-2974/HYP-2981 Toeplitz duals, and HYP-2991/HYP-2989 Haar zippers used only when they retain packet/owner/phase sidecars. | HYP-3116, HYP-3115, HYP-3114, HYP-3113, HYP-3112, HYP-3111, HYP-3108, HYP-3107, HYP-3098, HYP-3083, HYP-3074, HYP-3054, HYP-2997, HYP-2991, HYP-2989, HYP-2981, HYP-2974, HYP-2791, HYP-2790, HYP-2744, HYP-2112, HYP-2108, HYP-2963, T1191, LTT-150, LTI-252, OPEN-Q-108 | Add `endpoint_cover_activation_vector`, `phi_gap_sum`, `phi_kernel_status`, `P_max_activation`, `simultaneous_resonance_winding_word`, `boolean_mobius_low_depth_cut`, `endpoint_period_numerator_sidecar`, `proof_circuit_missing_input_vector`, `proof_uniformity_schema`, `finite_address_packet`, `observer_gluing_certificate`, `input_basis`, `essential_input_set`, `minimal_certificate_minterm`, `repair_cover`, and `terminal_exit_or_named_debt` to the HYP-2963/HYP-3107 residual packet before accepting a low-depth shortcut. |
| LTI-254 | Coordinate-resurrection sheaf and adjoint repair calculus | Destroyed-coordinate ledger, minimal sidecar repair covers, concept-lattice intents, adjoint quotient/section pairs, bottleneck proof coordinates | HYP-3118/S267 reserves the next abstraction after HYP-3116/HYP-3117: a quotient is useful only with the smallest legal sidecar, adjoint map, or sheaf section that resurrects the coordinate needed by the next proof obligation.  The planned scout will model HYP-3112-HYP-3117 carriers as repair hyperedges, compute minimal covers, concept-lattice intents, and bottleneck coordinates, then run Tournament Analysis on reframes rather than runners, roots, gates, or constants. | HYP-3118, HYP-3117, HYP-3116, HYP-3115, HYP-3114, HYP-3113, HYP-3112, HYP-3111, HYP-3108, HYP-3107, HYP-3102, HYP-3098, HYP-3083, HYP-2963, T1193, LTT-152, LTI-254, OPEN-Q-108 | Add `destroyed_coordinate_vector`, `resurrection_sidecar`, `adjoint_section_status`, `minimal_repair_cover`, `concept_lattice_intent`, `bottleneck_coordinate`, and `terminal_exit_or_debt` fields to shortcut audits before promoting any scalar quotient. |
...
route before the next proof operation uses that coordinate.
...
Next contribution: run `lrc14_coordinate_resurrection_sheaf_codex_s267.py`,
then promote the strongest repair-cover and concept-lattice readouts into
packet fields for HYP-2963/HYP-3098/HYP-3107/HYP-3112 rows.

...
| LTI-232 | Hurwitz finite-address branch-closure spine | Finite address ledgers, protected branch graphs, nonterminal median centers, polar-debt exits, global reduction/discharge obligations | HYP-3083/S252 reserves the synthesis layer that reads Hurwitz's sharpness lesson across the S243-S250 stack: any extremal scalar, q-tail, Markov/Pell wall, sixth-power collision, route median, or tournament kernel is proof-usable only after the finite address that made it extremal is retained.  The remaining LRC14 proof is reframed as four explicit obligations: global primitive-row reduction into the finite-address HYP-2963 packet bank, entry into the HYP-3082 protected no-naked-bridge graph, discharge of covering-family and K33/THM-572 exits, and Lean/formal closure of sidecar records. | HYP-3083, HYP-3082, HYP-3081, HYP-3080, HYP-3079, HYP-3078, HYP-3077, HYP-3075, HYP-3074, HYP-2963, THM-572, T1167, LTT-130, LTI-232, LTI-231, LTI-230, LTI-228, LTI-227, LTI-226, LTI-225, OPEN-Q-108 | Build a `finite_address_branch_closure` ledger over the HYP-2963 packet bank and outside-bank normalizer attempts; for every row record source, finite address, destroyed coordinate, branch-graph node, bridge protection mode, terminal exit, and formalization status. |

...
| LTI-195 | A000568 k-depth perspective ladder | Rooted node perspectives, k-depth in/out role colors, directed-edge sectors, directed-cycle conflicts, transitive-clique insertion cuts, endpoint-owner packet sheaves | Recasts the old A000568 perspective curiosity as a controlled-forgetting alarm: `P(5)=48` while `U(6)=56`, and k-depth node refinement reaches exact rooted type by depth `2`, so the missing eight classes are incident-word/cross-coupling payload rather than deeper node memory; the next lift is edge/cycle/clique/conflict carriers and then LRC endpoint-owner sheaves | HYP-3047, HYP-2120, HYP-2121, HYP-3046, HYP-3043, HYP-3042, HYP-3039, HYP-3018, HYP-3015, HYP-1824, HYP-1825, THM-381, THM-385, T1129, LTT-093, OPEN-Q-108 | Build the exact map from 5-edge perspectives to 6-tournament classes, isolate the eight-class defect by edge-sector and cycle-chirality data, then add `observer_cut_position_word`, `incident_sector_deck`, and `cross_sector_orientation_word` sidecars to LRC threshold-packet experiments. |
...
| LTI-197 | Exact non-node perspective-depth carrier extension | Exact arc/triple rooted orbits, local edge/triple depth colors, edge tail/tip sectors, transitive/cyclic triple splits, cycle-conflict roots, matrix sidecar observability | Extends HYP-3047 and HYP-3049 while using HYP-3048's matrix sidecar language by computing exact non-node carrier totals through the first failure window: at base size `m=5`, directed-edge perspectives and triple perspectives both total `88`, splitting triples as `64` transitive and `24` cyclic.  Under the stricter directed-WL convention used here, node depth reaches exact rooted node orbits by depth `3`, while local edge and triple depth `2` recover exact first-failure carriers.  The missing `8` A000568 states remain observer-extension cut data; edge sectors and cyclic triples are sidecars for pair-good switches, residual capacitors, and Omega/conflict payloads. | HYP-3050, HYP-3049, HYP-3048, HYP-3047, HYP-3040, HYP-3039, HYP-2210, HYP-2120, HYP-1978, HYP-1977, THM-381, THM-385, THM-260, THM-409, T1132, T1131, T1130, T1129, LTT-095, LTT-094, LTT-093, LTI-196, LTI-195, LTI-194, LTI-188, LTI-187 | Add `edge_tail_tip_sector_word`, `triple_perspective_kind`, `cycle_conflict_pair_id`, `observer_extension_cut_signature`, and sidecar-observability matrix columns; extend exact carrier counts to `m=6` and compare edge-sector signatures against pair-good blocker teeth and residual capacitor IDs. |
...
| LTI-TODO-64 | Observer-extension perspective carrier theorem | LTI-197, LTI-196, LTI-195, LTI-194, LTI-187, LTI-169, LTI-168, LTI-144, LTI-141, LTI-112, LTI-008, LTT-095, LTT-094, LTT-093, LTT-092, LTT-085, HYP-3050, HYP-3049, HYP-3048, HYP-3047, HYP-3040, HYP-3039, HYP-2210, HYP-2120, HYP-1978, HYP-1977, THM-381, THM-385, THM-260, THM-409, T1132, T1131, T1130, T1129 | Define observer-extension cut perspectives, extend exact node/edge/triple/cycle/conflict carrier counts to `m=6`, and test whether edge tail/tip sector words classify pair-good decoy generators and residual capacitor cuts before raw counts matter. |
| LTI-TODO-65 | Diagonal-layer flow sidecar theorem | LTI-200, LTI-199, LTI-198, LTI-197, LTI-196, LTI-195, LTI-194, LTI-187, LTT-098, LTT-097, LTT-096, LTT-095, LTT-094, LTT-093, HYP-3053, HYP-3052, HYP-3051, HYP-3050, HYP-3049, HYP-3048, HYP-3047, HYP-3043, HYP-3039, THM-381, THM-385, T1135, T1134, T1133, T1132, T1131, T1130 | Emit rectangle and hourglass cycle bases for adjacent diagonal-layer bridges, attach line-potential and cycle-defect words to owner/barcode/route packet experiments, and prove when the `K_{k,k+1}` coboundary redundancy descends, reconstructs, annihilates, or names a hidden LRC sidecar coordinate. |

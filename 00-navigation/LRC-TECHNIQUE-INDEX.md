...
| LTI-236 | Observer-chart gluing carrier | Arithmetic, normalized-arc, cap, moment, branch, and formal witness observer charts over one finite-address LRC14 packet | HYP-3095/S256 reads the whole LRC14 route history as increasing control over legal forgetting. AP/GW became the additive equality shadow; tournament work became sidecar observability; HYP-2963 made exact scale and endpoint ownership first-class; HYP-3083 made finite-address branch closure the proof spine; THM-573/THM-574 explain the level-7/c-lift residual left by the broken `14=2*7` field method, with HYP-3089 identifying `I(13,7,1)=covering mod 7`, the `c=7` lift, and the dyadic `c=2` lift to covering mod `14`; THM-575 shows raw denominator time is the wrong observer; and HYP-3090, HYP-3092, HYP-3085, and HYP-3094 supply triangular-cap, Pascal-cap, moment, and branch charts. | HYP-3095, HYP-3094, HYP-3093, HYP-3092, HYP-3091, HYP-3090, HYP-3089, HYP-3088, HYP-3087, HYP-3085, HYP-3083, HYP-2990, THM-576, THM-575, THM-574, THM-573, T1172, LTT-134, LTI-236, LTI-235, LTI-234, OPEN-Q-108 | Build an `lrc14_observer_gluing_ledger` for the THM-573 residual with fields for preserved LRC predicate, chart type, quotient map, destroyed coordinate, overlap map, sidecar/certificate/descent, finite-ruler status, terminal exit, and named debt; then prove every used quotient is reconstructible, dual-annihilated, fiber-constant, or explicitly routed. |

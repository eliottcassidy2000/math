...
- **(2) The metagraph transport** (boxeph-S110/MSG-1818): 183=|PG(2,13)|, deep-well AP = transitive pole vs Singer difference set = regular pole; make the LRC-config → tournament-iso-class map precise so G_n's proved transitive-class isolation applies to M. The one place the tournament mandate and LRC(14) met all window; pairs with the §5 cycle-holonomy lens (THM-379/THM-1240-codex: the obstruction is carried by forced directed cycles — the repo's parity technology is the natural signed toolkit for the germ-lift lemma).

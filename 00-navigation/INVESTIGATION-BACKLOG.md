...
- **NEXT STEP:** prove the missed-sector-phase 8× (bound |Σ_ℓ ĝ_0(ℓ)ĥ_ℓ(−ℓw)| via σ⊥ℓw decorrelation) — closes the ungapped core, meets THM-699 on the same object. → kps (THM-700/699).

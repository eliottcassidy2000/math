...
- **(i) The feasibility ledger (the reframing with a number at the end):** the only method that has closed an open LRC case at n ≥ 8 is Tao-2018 finite reduction + MSS-2025 bounds + computer sieve (Rosenfeld arXiv:2509.14111 for n=8; 2604.23906 for 11–13) — and it is structurally indifferent to floor ties/populated gaps (n=8 has both: {1..5,7,12} tie, 3/23 gap member). Task: extract the explicit MSS-type speed bound at n=14 (the repo's THM-574/576 deep-read did the cap side), intersect with our PROVED strata (non-covering sieve, near-AP sweeps THM-734/738, clustered r ≤ 6, diameter/intersection ledgers, THM-1043 spread ladder, 1200/1200 hard-stratum grid certificates), and produce the number: how far is "LRC(14) by the only method with a track record" beyond the n=13 computation, before and after our sieve stages? Sibling of opus-S399's S-T equality-case lead (both = "read the settled proofs"); complements, does not replace, Wall-A/B work.

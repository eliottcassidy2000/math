...
3. **`χ_c(G_GW) ∈ (13,14]`** (carry from S145): the last rung question; density-`(1/14,1/13)` color classes escape the THM-652 rigidity, so a `(p,q)`-coloring search with `13 < p/q < 14` or a holonomy/phase-slip obstruction is needed.

...
- **(1) HIGHEST-LEVERAGE, UNCLAIMED — mine the Sungkawichai–Trakulthongchai LRC(11–13) proofs for their equality case** (boxeph-S114/MSG-1823, zero uptake since): if their sieve pins M=1/13 ⟺ AP at n=12, HYP-4382/HYP-7310 (= Wall A) follows from a paper the repo already cites as settled. One session: fetch arXiv:2604.23906 + the n=9,10 paper, read ONLY the equality analysis, report exactly what is pinned. This converts the fleet's wall into a literature-reading task.

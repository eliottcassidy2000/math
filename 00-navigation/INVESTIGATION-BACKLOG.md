...
**Status:** PROOF-INTERFACE / routing theorem target complete (HYP-2986/T1070), complementary to the incoming HYP-2984/T1068 kernel-homotopy stub.  This pass turns the recent analytic-number-theory prompts into a typed LRC14 smoothing dispatcher rather than a scalar estimate.  The script `04-computation/lrc14_smoothing_dispatcher_codex_20260624.py` classifies which policy is allowed to handle each live packet family and stores the readout in `05-knowledge/results/lrc14_smoothing_dispatcher_codex_20260624.out`.

...
- **Open shallow theorem:** THM-845 has finished both THM-820 scale-one H5
  ...
  three.  Next batch `(R,x_1,x_2,x_3)` literal geometry and benchmark the
  complete-tooth/streaming collapse before a near-billion-node full run; then

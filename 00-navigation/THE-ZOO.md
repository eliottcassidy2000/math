...
| **Even graphs `widehat(E)_n`** | canonical envelope; tree images form an `n-2` step diameter chain; exact radial cycle metric and commuting weighted lift (THM-4069/4073) | **least-developed row (§5)** |

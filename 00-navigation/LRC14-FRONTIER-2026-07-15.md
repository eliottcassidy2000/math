...
| Hamming-six exact closure / ramification boundary / seven-comb wall | PROVED / FINITE-EXACT through AP-centred common scale `c=8`. THM-857 closes scale one and its unbounded lifts; THM-859 proves exact dilation conjugacy and identifies the effective order `D`; THM-860 proves the primitive proper AP-centred H6 branch finite with `c<=840`, hereditary leave-one-out lcm, all 63 relative cuts, and a finite metric tree per language. THM-861 closes `c=2`. THM-862 now closes all 1,504 `c=3` contexts by a 950,540,566-edge terminal recursion. THM-957 closes `c=4`; THM-958 empties the 14,414,400-context `c=5` sheet bank; THM-960 empties 37,710,288 `c=6` contexts and exposes an octahedral affine owner nerve; THM-962 empties 108,673,488 `c=7` contexts by a row-product character and quadratic-coset square-sum contradiction; THM-963 empties 215,728,128 `c=8` contexts and identifies the faithful owner-obligation nerve `K3,3`. The next AP-centred common-scale face is `c=9`; H5, non-AP/deep sheets, and the positioned seven-wall remain open. | THM-815 Part C/C.1/C.2, THM-857/859/860/861/862/957/958/960/962/963 + exact component/ramification/sheet certificates |

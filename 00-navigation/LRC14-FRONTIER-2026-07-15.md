...
| n=12 sporadic branch | OPEN globally. Closed: the bounded shallow slice; the full AP-centred Hamming-one through Hamming-four stars at arbitrary height and scale; the complete height-at-most-two scale-one Hamming-five slice; every two-sheet core in `[1,19]` with unbounded odd exceptions; the full two-sheet speed box through 100; every non-signed-complement `q=13` profile; and the forced-`w=13c` quotient box through height 24. THM-815/820 reduce scale-one Hamming five to the joint boxes `(146,292,584,1168,2336)` and `x<=146,v<=1986,max_top<=7944`, while scale-one Hamming six is recursively finite and radius seven is the first discrepancy-unbounded chart; neither finite recursion has yet been exhausted. THM-822 shows why the bounded kernel extremes do not finish Hamming five: live-relation fibres mix exact `M`, while literal interval faces are statically injective but unproved under continuation. THM-823 reduces the all-scale five-deck interface to a least-order pivot, refutes an all-order scalar cutoff, and classifies the bounded no-order-one common-sheet survivors as one order-three forward-coset orbit; arbitrary-lift strictness and common sheets above order twelve remain open. THM-817 classifies every return satellite and gives the adaptive exact selector; THM-821 factors every positive-odd-pair atomic stalk through its pair-indexed circular sum arc and proves the audited coarse projections impure. THM-824 gives the exact intrinsic radius budget for `(13d,5d)`, and THM-831 proves that the primitive no-switch method extends exactly to the sixteen reduced half-frequency types `4<=alpha<=9` and fails sharply thereafter; neither theorem forces the arithmetic core to satisfy or violate its budget. Remaining: exact closure of the Hamming-five boxes, exhaustion of the finite H6 recursion, and unbounded deck languages; a uniform violation/decreasing rule for the intrinsic radius or exact signed-sum-arc selectors on the sixteen viable folds; ternary switch-aware treatment outside them; unbounded dyadic/collar assembly; and general higher-sheet packets. | THM-759/763/765/766/768/769/770/772/774/775/776/782/786/789/792/795/797/800/803/804/806/807/810/815/816/817/820/821/822/823/824/831; HYP-6820 |

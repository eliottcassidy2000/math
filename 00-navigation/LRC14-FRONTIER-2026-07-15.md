...
| Hamming-six exact closure / ramification boundary / seven-comb wall | PROVED / FINITE-EXACT through AP-centred common scale `c=11`. THM-857 closes scale one and its unbounded lifts; THM-859 proves exact dilation conjugacy and identifies the effective order `D`; THM-860 proves the primitive proper AP-centred H6 branch finite with `c<=840`, hereditary leave-one-out lcm, all 63 relative cuts, and a finite metric tree per language. THM-861 closes `c=2`. THM-862 closes all 1,504 `c=3` contexts by a 950,540,566-edge terminal recursion. THM-957 closes `c=4`; THM-958 empties 14,414,400 `c=5` contexts; THM-960 empties 37,710,288 `c=6` contexts; THM-962 empties 108,673,488 `c=7` contexts; THM-963 empties 215,728,128 `c=8` contexts with conflict graph `K3,3`; THM-969 empties 482,294,736 `c=9` contexts with `3K2`/`2K2` intersection nerves; THM-970 empties 821,620,800 `c=10` contexts after reduction to 64 projective sign transversals with triangular-prism intersection graph `K6` minus `C6`; THM-974 empties 1,636,866,000 `c=11` contexts after reduction to 66 all-order-eleven supports and replay of 66,000,000 unit words. The next AP-centred common-scale face is `c=12`; H5, non-AP/deep sheets, and the positioned seven-wall remain open. | THM-815 Part C/C.1/C.2, THM-857/859/860/861/862/957/958/960/962/963/969/970/974 + exact component/ramification/sheet certificates |

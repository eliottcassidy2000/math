...
3. **Classify higher deck ramification, finish Hamming six,
   ...
   orbit or loose; enumerate the remaining primitive rows and build the
...
tight row, so the live scale-one H6 chamber is primitive. Unbounded-order H5 decks, primitive/all-scale H6, deep two-sheet, and general
...
> common-sheet bank, and nonprimitive scale-one Hamming-six slice away from
> the doubled AP are closed.  The live obstruction is unbounded-order

...
| primitive-core H6 antipodal AP-germ reduction | PROVED PARTIAL CLOSURE + FINITE-EXACT: excluding the exceptional odd-label retained core, the 923 primitive-core missing-label rows split by full antipodal-pair count `f` as `63,480,360,20`. Each full pair supplies two interior thirteenth-grid cusps and oriented germ-owner handoff inequalities. Weighted directed-cycle products close six of the twenty `f=3` rows and force `u_5=18` and/or `u_6=19` in eight more. Ten exact fixed-coordinate trees (`3,699` states; depth nodes `10,228,2176,1236,49,0`) close all eight forced-slice rows. Thus 14 of 20 `f=3` rows are loose and the primitive-core row frontier is `923 -> 909`. The six product-`1/16` rows, all 903 rows with `f<=2`, and the exceptional odd-label mixed-parity primitive branch remain open; globally 910 label patterns remain. | THM-815 C.2 + exact AP-pin/slice replay |
...
remain, for 910 open label patterns globally. The finite smooth-ramified H5

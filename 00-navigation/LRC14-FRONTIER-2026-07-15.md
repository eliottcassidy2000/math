...
| n=12 sporadic branch | OPEN globally. Closed: the bounded shallow slice; the full AP-centred Hamming-one through Hamming-four stars at arbitrary height and scale; the entire proper scale-one Hamming-five chart at arbitrary lift height; one of the 96 order-three arbitrary-scale contexts; every two-sheet core in `[1,19]` with unbounded odd exceptions; and the other named finite banks. THM-842 empties THM-820's former scale-one boxes. THM-840 proves exact endpoints are Markov only for monotone insertion; reversible/transport operations need the labelled tooth bank. THM-823/837 reduce the arbitrary-scale interface to a least-order pivot and one bounded survivor orbit, then close one context; the other 95, common sheets above order twelve, and mixed order-one strictness remain open. Scale-one H6 is finite but contains the tight doubled AP `2[12]`. On the deep side THM-824/831 classify the radius scalar and its ternary switch boundary, while THM-836 excludes the first two thin owner shells but stops sharply at local `s=5` survivors. Remaining: arbitrary-scale H5 descent; non-AP H6; unbounded deck languages; uniform radius/sum-arc exclusion or transport; the dyadic/collar residual; and higher sheets. | THM-759/763/765/766/768/769/770/772/774/775/776/782/786/789/792/795/797/800/803/804/806/807/810/815/816/817/820/821/822/823/824/831/836/837/840/842; HYP-6820 |
...
`max_top<=7944`. THM-842 exhausts both branches by row-wise longest-component
...
> **LRC(14) is open.  The AP-centred Hamming-four star and proper scale-one
> Hamming-five chart are closed; scale-one Hamming six is finite but contains
> the doubled-AP equality face.  The live obstruction is uniform
...
THM-768--770, THM-794/795/797/800--804/806/807/810/815--817/820--824/831/835,

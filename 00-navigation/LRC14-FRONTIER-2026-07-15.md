...
| n=12 sporadic branch | OPEN globally. Closed: the bounded shallow slice; the complete Hamming-one through Hamming-four AP stars at arbitrary height and scale; the entire height-at-most-two scale-one Hamming-five slice; every two-sheet core in `[1,19]` with unbounded odd exceptions; the full two-sheet speed box through 100; every non-signed-complement `q=13` profile; and the forced-`w=13c` quotient box through height 24. THM-820 makes the whole scale-one Hamming-five chart uniformly finite in two explicit boxes but does not yet empty them. THM-822 shows that coarse live relations mix exact `M` while literal interval faces are only bounded-statically injective. Scale-one Hamming six is recursively finite, and radius seven is the first chart where this discrepancy argument gives no initial cap. THM-823 reduces the all-scale deck interface to a least-order pivot, refutes an all-order scalar cutoff, and classifies the bounded no-order-one common-sheet survivors as one order-three forward-coset orbit; arbitrary-lift strictness and common sheets above order twelve remain open. THM-817 classifies every disconnected return satellite as a signed max-speed cell; THM-821 proves on 9,974 atoms that the fixed folded predicate factors through exact cell/component sum arcs and every tested coarser shadow mixes. THM-824 then proves that the full symmetric union for `(13d,5d)` is governed exactly by one two-radius budget, but all 214 replayed cores violate it and the theorem does not cover individual satellites or other odd ratios. Remaining: exact closure of the radius-five boxes and finite H6 recursion; unbounded deck languages; a uniform violation/decreasing rule for the radius or exact signed-sum-arc selectors; extension beyond the fixed ratio; an unbounded-height collar tear; and the other higher-sheet packets. | THM-759/763/765/766/768/769/770/772/774/775/776/782/786/789/792/795/797/800/803/804/806/807/810/815/816/817/820/821/822/823/824; HYP-6820 |
...
THM-768--770, THM-794/795/797/800--804/806/807/810/815--817/820,

...
**Scale-three resonance.** [THM-4373](../01-canon/theorems/THM-4373-lrc14-scale-three-signed-121-resonant-triple-comb-bound.md) proves the sharp `6/77` failure-comb bound, uniquely at `(1,5,11)`, throughout the signed-`(1,2,1)` sector. The nonresonant sector remains open; its exact maximum through height `199` is `12/301` at `(1,11,43)`.

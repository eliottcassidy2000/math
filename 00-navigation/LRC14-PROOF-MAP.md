...
| Rank code / adaptive carry | THM-2187 gives a saturated height-`105` plane and universal radix; THM-2190 forces ranks `3,4,5,6` by heights `178,204,262,450`, rank five on every deletion by `235800`, and an existential finite rank-seven height | THM-2188 proves finite banks, pair data, and even a common rank-eleven carrier target-blind. Preserve critical scale/phase through a graded pump; rank alone cannot cross THM-2168's evaluation-kernel shear. |

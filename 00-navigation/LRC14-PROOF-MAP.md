...
The cited inputs are proved in scope; sufficient-gate failure means uncertified. THM-2085--2097/2112 make rank-seven rows finite, not discharged.
At guarded sizes `8..10`, THM-2098 has pure, low-mixed, and high-vertical lanes; only the pure lane inherits its collision budget, and depth-zero eleven is separate.

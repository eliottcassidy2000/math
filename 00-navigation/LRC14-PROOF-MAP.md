...
**Affine/antipodal and arithmetic controls.** THM-4066--4112 close named AP/shape/dilation families and supply type/physicality controls; THM-4119--4154 give fixed-tail, pool, first-window, Haar, and corrected-scope gates. THM-4150--4170 make the fixed-pool deletion ladder exact through arity three: exactly 61 certificate failures, none after `q=924`, and `888,030` cores per qualifier. Failure is not danger; arbitrary bodies, entry/arrival, and LRC(14) remain open.

...
**Reflected cone.**  THM-2941's cap-aware gain CSP now closes `3m>=2D`.  Its global phase-zero atlas is exactly `4/3,3/2,2,5/2,3,4,5,6`.  At cap two the first three form a balanced triangle; at cap `7/3` it is interior.  At cap `5/2`, every forced-full zero component contains that triangle and its unique prime-five edge is a bridge.  Cap `3` is the next dependent-gain wall.

...
## 2026-08-31 current control panel
...
**Affine/antipodal and arithmetic controls.** THM-4156/4191 close the zero/one-outsider layers; THM-4207/4211/4214 give fixed/cofinal/Pascal charts. [THM-4231](../01-canon/theorems/THM-4231-arbitrary-pair-cofinal-depth-six-haar-repair-and-exact-outsider-lift.md) closes every `max(q,r)>=770`; THM-4238/4242/4254/4256/4261/4262 reduce the exact fixed-pool residual to `180,622`, and THM-4266--4287 reach `22,647`, maximum `636`. [THM-4295](../01-canon/theorems/THM-4295-lrc14-endpoint-636-minimum-fourteen-exchange-and-recursive-signature-ideals.md) proves the exact rank-eight append minimum `14`, the strict zero-response body `1d106401`, and complete index-19/index-294/index-372 ideals. [THM-4296](../01-canon/theorems/THM-4296-lrc14-mixed-rank-deletion-depth-and-recursive-signature-closure.md) observes that active deletions form an upset, upgrades the zero response to exact deletion depth nine, and continues with a 9,019-mask rank-eight/rank-nine carrier. Its 70-row carrier, 110 singleton decks, the index-19 deck, and THM-4295's two larger independent ideals have typed union `1,324`; the larger ideals contribute three rows beyond the prior union. The complement is `21,323`, maximum `626`, exactly on `(100,626),(256,626)`, where the carrier has 995 and 10 failures. MISTAKE-532 changes only noncanonical cross-row weakest-margin annotations. These are fixed-pool sufficient certificates, not physical danger or entry. THM-4227/4228/4233 retain scale/gcd/primitive methods. Finite closure, physical entry, and LRC(14) remain open.

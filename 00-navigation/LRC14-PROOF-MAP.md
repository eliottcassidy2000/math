...
**Affine equality rays.** THM-4066 closes `3H union h{1,4,5}` for `3∤h,24h>=11M` and `4H union h{2,7,9}` for odd `h,21h>=22M`; arbitrary shapes, physical entry, and LRC(14) remain open.

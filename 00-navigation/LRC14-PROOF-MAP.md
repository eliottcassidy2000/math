...
### Live interfaces — THM-2581/2584 close the same-`b`-fibre host and `theta` contraction; the missing map is deep root/rail to the THM-2569 later target and THM-2334 residue before full `X`

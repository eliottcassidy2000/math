...
**Affine/antipodal and arithmetic controls.** THM-4066/4070/4075/4079 close small shapes, height `30`, and one-outlier AP10; THM-4081 leaves `kappa=7,8`. THM-4087 closes exactly `{1,...,9,B,C}`, `70<=B<C`, at adaptive `N<=14C` through all dilations. THM-4092 assigns exact antipodal weights one and two and reaches AP8 plus three speeds `>=281`. THM-4095 proves exact fixed-observer field transport but a gapped optimized primitive-pair margin spectrum. THM-4096 finds a nonnegative twisted affine representation only at the first THM-2057 `182m` ray point; later points lie below `-1/12`. These are suppliers and quantifier/type firewalls, not arbitrary-core closure, physical entry, p-adic LRC invariants, or LRC(14).
...
| Dyadic owner words | THM-2066/4075 close every divisor-complete eleven-core through `30`, including nonprimitive cores; clocks `15..38` suffice, while THM-2068's seven-clock minimum inside `15..34` is menu-relative. THM-4087 supplies the all-height AP9 two-outlier family and all its dilations; THM-4092 supplies parity-weighted AP5--AP8 families up to six outliers, including AP8 plus three speeds `>=281`. | Arbitrary-core closure and a residual-to-AP supplier remain open; THM-2072 makes every core-independent fixed bank blind somewhere. |

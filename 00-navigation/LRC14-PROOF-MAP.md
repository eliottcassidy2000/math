...
**Affine equality rays.** THM-4066 closes two three-exception shapes. THM-4070 gives the complete `q=2..14` two-exception sieve: a surviving `d=2` divided pack must cover the maximal divisibility antichain `{8,...,14}`; the `q=14` bank closes THM-4049's physical hostile and every odd affine ray whose pack misses `14`. Arbitrary residual packs, physical entry, and LRC(14) remain open.

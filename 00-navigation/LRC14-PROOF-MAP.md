...
**Affine/fixed-pool controls.** THM-4326/4329 close the fixed-pool chart; THM-4330 closes `1+13` and leaves `2+12` with `420|h`; THM-4333/4338 close residual ranks three/four; THM-4335 gives exact renewal owners. [THM-4347](../01-canon/theorems/THM-4347-lrc14-dyadic-owner-word-closure-through-forty.md) closes every eleven-body through height `40`; a max-`72` hostile escapes fixed clocks `15..43` but closes at `47`. [THM-4349](../01-canon/theorems/THM-4349-lrc14-adaptive-owner-clock-completeness-and-twelve-height-tail-cutoff.md) proves one explicit adaptive clock is complete for each body, not empty for every body. [THM-4348](../01-canon/theorems/THM-4348-lrc14-prefix-envelope-third-tooth-and-nested-wall-shadow.md) leaves wall resonance `7u|h` and at least three residual overlaps. THM-4345/4346 give the anchor residual-wall correction and Brownian/martingale current, but exact hostiles rule out variance- or cubic-only forcing. THM-4363/4365 show that 828 statuses plus every completed physical chain can have a cofinite odd fibre with infinitely many first exits; retain missing prefixes and Euclidean addresses. Arbitrary entry, the anchored seam, and LRC(14) remain open.

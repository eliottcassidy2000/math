...
**Affine/antipodal and arithmetic controls.** THM-4066/4070/4075/4079 close small shapes, height `30`, and one-outlier AP10; THM-4081 leaves `kappa=7,8`. THM-4087 closes exactly `{1,...,9,B,C}`, `70<=B<C`, at adaptive `N<=14C` through all dilations. THM-4092 reaches AP8 plus three speeds `>=281`; THM-4098 fills the missing weight-seven AP7/AP6/AP5 rows after `q>=55,35,35`, and THM-4101 closes the unscaled AP7 gap-four family above `264`. THM-4095/4096 are quantifier/type firewalls. None gives arbitrary-core closure, physical entry, or LRC(14).
...
| Dyadic owner words | THM-2066/4075 close divisor-complete eleven-cores through `30`. THM-4087 supplies AP9 plus two outliers; THM-4092 supplies AP5--AP8 families. THM-4098 fills their missing weight-seven dilated rows; THM-4101 supplies the unscaled AP7 gap-four family above `264`. | Arbitrary-core closure, general unscaled weight-seven absorption, and a residual-to-AP supplier remain open. |

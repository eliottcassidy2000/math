...
**Affine/antipodal and arithmetic controls.** THM-4188 gives the `15/19/23` resonance filtration; THM-4156 closes every fixed-pool subset (MISTAKE-520); THM-4203 retains its sharp E8 census; and THM-4191 closes all `C(30,10)` one-newcomer bodies. THM-4207/4211/4214 give fixed-pair, fixed-`50`, and Pascal charts. [THM-4227](../01-canon/theorems/THM-4227-two-outsider-scale-separated-depth-eight-haar-wedge.md), [THM-4228](../01-canon/theorems/THM-4228-common-gcd-two-outsider-periodic-observable-haar-ray.md), and [THM-4231](../01-canon/theorems/THM-4231-arbitrary-pair-cofinal-depth-six-haar-repair-and-exact-outsider-lift.md) cover respectively a scale-separated wedge, gcd-`>=3467` rays, and all distinct `q,r>=17548` over the full pool. [THM-4233](../01-canon/theorems/THM-4233-pair-specific-primitive-observable-oscillation-haar-charts.md) adds the exact gcd-one `(3713,5149)` ray and a general unimodular cyclotomic-zero compiler. Orthogonally, [THM-4229](../01-canon/theorems/THM-4229-fixed-fifty-nineteen-label-petal-haar-charts.md) gives twelve fixed-`50` petals; [THM-4234](../01-canon/theorems/THM-4234-fixed-fifty-twenty-label-pair-haar-charts.md) proves their complete symmetric pair graph `K_12`, one universal maximin-surplus triple, and uniform cofinal tails for all 220 triples. Thus `chi_50>=21`, while arbitrary finite entry, the other triple remainders, physical entry, and LRC(14) remain open.

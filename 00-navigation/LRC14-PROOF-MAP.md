...
**Affine/antipodal and arithmetic controls.** THM-4066/4070/4075/4079 close small shapes, height `30`, and one-outlier AP10; THM-4081 leaves `kappa=7,8`. THM-4087 closes `{1,...,9,B,C}`, `70<=B<C`, through all dilations. THM-4092 reaches AP8 plus three speeds at `>=281` and the all-even row at `>=85`; THM-4100 lowers arbitrary parity to `93`. THM-4112 iterates parent-gap ancestry: ratio two works through depth six, ratio `>=12/5` at arbitrary finite depth, and AP8+5 or a primitive non-AP core+6 give direct thirteen-speed families. THM-4098 fills dilated weight-seven rows; THM-4109 gives AP7 odd-pair floors `197/232/268` at gaps `4/8/12`. THM-4095/4096 are type firewalls. THM-4105/4106 decode reciprocal physicality but lose common time; THM-4107/4108 are tournament/radical firewalls. THM-4110 counts but does not synchronize the AP13 phase quotient. THM-4117 proves the canonical physical `11+2` row misses every THM-4112 supplier after all common dilations: primitive unit-origin support is absent. Arbitrary-core closure, common arrival, and LRC(14) remain open.

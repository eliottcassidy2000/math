...
## 2026-08-29 current control panel
...
**Affine/antipodal and arithmetic controls.** THM-4156/4191 close the zero/one-outsider layers; THM-4207/4211/4214 give fixed/cofinal/Pascal charts. [THM-4231](../01-canon/theorems/THM-4231-arbitrary-pair-cofinal-depth-six-haar-repair-and-exact-outsider-lift.md) closes every `max(q,r)>=770`; THM-4238/4242/4254/4256/4261/4262 reduce the exact fixed-pool residual to `180,622`. THM-4266--4283 combine learned carriers, uniform decks, and signature-fibre surgery. [THM-4287](../01-canon/theorems/THM-4287-repaired-carrier-endpoint-637-descent.md) gives two further typed nodes: the inherited 8,996-mask carrier closes the three endpoint-637 rows, and a delete-two/add-two deck closes the complete 33-row `{275,345}` signature ideal. Their one-row overlap leaves `22,647`, maximum `636`, on six rows. The repaired carrier has 101 failures supported on `(100,636)` and `(256,636)`, so the carrier boundary is nonmonotone. THM-4227/4228/4233 retain scale/gcd/primitive methods. Finite closure, physical entry, and LRC(14) remain open.

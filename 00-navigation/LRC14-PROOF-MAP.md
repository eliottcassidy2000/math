...
| Rank code / adaptive carry | THM-2196/2199 give finite carry charts, projective finiteness, and rank twelve; THM-2208/2212 reduce each rank-eleven plane to bounded anchors, one cofactor candidate, 91 ruler systems, and a signed equality skeleton; THM-2203 gives the scalar covectors | THM-2188 forbids static quotients. THM-2233/2239 leave `165` first-depth-one rows and `(3,4,5)`; THM-2250/2257 close the latter. THM-2239 identifies time-zero literal loss; THM-2234 gives private expansion. THM-2255 quantifies exclusive-owner mass and forces a `>1/7` expiration spill on every strict row, so the sharp target is a labelled successor collision/handoff law; the `15` repeated-first rows remain subcritical. Retain THM-2211/2216/2218/2238 sidecars. THM-2237 proves the generic lower-moment ceiling exact; THM-2235 forbids a fixed-XOR/odd-sheet antipode shortcut. |

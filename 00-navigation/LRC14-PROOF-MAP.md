...
**Affine/antipodal controls.** THM-4066/4070/4075/4079 close small shapes and one-outlier AP10; THM-4087 closes AP9 plus two outliers through dilation. THM-4092 reaches AP8 plus three speeds `>=281`; THM-4098 fills missing dilated weight-seven rows. THM-4109 gives AP7 odd-pair floors `197/232/268` at gaps `4/8/12`; only `4,8` beat `264` here. THM-4095/4096 are type firewalls. Arbitrary-core closure, physical entry, and LRC(14) remain open.
...
| Dyadic owner words | THM-2066/4075 close divisor-complete eleven-cores through `30`. THM-4087 supplies AP9 plus two outliers; THM-4092 supplies AP5--AP8 families. THM-4098 fills their missing weight-seven dilated rows; THM-4109 supplies unscaled AP7 selected-pair families at gaps `4/8/12` from `197/232/268`. | Arbitrary-core closure, general unscaled weight-seven absorption, and a residual-to-AP supplier remain open. |

...
THM-2130 intersects `11/13` labels into a sparse exception or `143` determinant; THM-2128/2131 exclude both guard-blocker pencils when no terminal is a blocker. THM-2133 empties simultaneous blocker counts `1..6` and reduces seven blockers to scalar `6+1`/`5+2` flood tails. MISTAKE-238/239/242 block invalid transfers; those tails, the fivefold guard pencil, and higher ranks remain open.

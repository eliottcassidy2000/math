...
**Affine/antipodal and arithmetic controls.** THM-4174/4175 close the all-three-/exactly-two-original-anchor lanes (`888,030/6,660,225` bodies per newcomer). THM-4185 completes the `q=50` zero-original slice through the exact `32/297/24` size-`4/5/6` anchor hierarchy; THM-4188 transports all `1,491,665` such bodies to every newcomer by an exact `15/19/23` edge-inclusion resonance filtration plus shallower native repairs. These three disjoint slices total `9,039,920` cores per newcomer. At `q=50`, THM-4178/4179 add the `1,071,961` exactly-one-original slice, giving `10,111,881`. Maximal deletion identifies the all-depth repair test with the body's Haar threshold. No arbitrary-body entry follows; LRC(14) remains open.

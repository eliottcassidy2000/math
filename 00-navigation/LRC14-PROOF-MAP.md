...
| Rank code / adaptive carry | THM-2196/2199 give finite carry charts, projective finiteness, and rank twelve; THM-2208/2212 reduce each rank-eleven plane to bounded anchors, one cofactor candidate, 91 ruler systems, and a signed equality skeleton; THM-2203 gives the scalar covectors | THM-2198--2229 leave `240`; THM-2233/2239 leave exactly `194`, split as `165` first-depth-one and `29` first-depth-three rows, while THM-2234 gives first-depth-one private expansion. The sharp target is a separately centered signed owner/incidence join retaining THM-2211 carry and THM-2216/2218/2238 sidecars, plus optimized weights or a complementary even score on the depth-three residue. THM-2237 proves the generic lower-moment ceiling exact; THM-2235 forbids a fixed-XOR/odd-sheet antipode shortcut. |

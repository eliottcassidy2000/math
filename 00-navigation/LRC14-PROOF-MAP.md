...
| Rank code / adaptive carry | THM-2187 gives a saturated rank-six carrier; THM-2193 gives floor `7^-21` and rank seven by `78*7^21`; THM-2196 gives circuit/carry charts and a `91||c||_infinity` one-carry terminal; THM-2199 gives floor `182^-13` on every positive speed subspace and rank twelve by `78*182^13` | THM-2188 proves static data target-blind and THM-2192 quantifies scalarization loss. THM-2197 gives Boolean deficiency; THM-2198/2204 close `(1,1,2)/(2,2,3)` but expose labelled guard-hole correlation as the missing recursive state; THM-2201 makes that sheet motion triangular and faithful. Use the explicit rank-twelve carrier while preserving those sidecars. |

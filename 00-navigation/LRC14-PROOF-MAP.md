...
**Affine/antipodal and arithmetic controls.** THM-4174/4175 close the all-three-/exactly-two-original lanes (`888,030/6,660,225` bodies per newcomer). THM-4188's exact `15/19/23` resonance filtration transports its `1,491,665` good zero-original subfamily. THM-4191 projects the lawful repair deck to close all `C(27,10)=8,436,285` zero-original bodies, while THM-4190 uses maximal-deletion body coordinates at the same 23 resonances to transport THM-4179's `1,071,961` exactly-one slice. The four pairwise-disjoint fixed-pool families total `17,056,501` for every newcomer. No physical entry or arbitrary-family classification follows; LRC(14) remains open.

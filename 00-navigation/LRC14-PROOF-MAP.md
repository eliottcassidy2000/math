...
**Affine/antipodal and arithmetic controls.** THM-4174/4175 close the fixed-pool all-/one-anchor lanes (`888,030/6,660,225` bodies per newcomer). THM-4178's `q=50` six-anchor profile adds `480,700` two-anchor bodies; two seven-cover blocks certify method failure only. No arbitrary-body entry follows; LRC(14) remains open.

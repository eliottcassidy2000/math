...
| Rank code / adaptive carry | THM-2052 gives rank eleven; THM-2144/2164 give two height-`<=105` relations; THM-2169 bounds every deletion relation by `1247`; THM-2171 repairs order/distinctness/primitivity with path cap `5,430,750`; THM-2178 gives rank three at an explicit height or a support-`<=3` mod-14 digit | Discharge the sparse digit or preserve zero-safety through a scale-sensitive current; finite relation/order state is no longer the missing coordinate. |

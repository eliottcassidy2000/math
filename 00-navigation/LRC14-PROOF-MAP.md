...
**Disconnected-low reduction.**  Its `36,520` realizable profiles have a complete-multipartite five-edge high tree. Large rulers, `q>=8p`, bounded-ratio gcd `>=19`, all `3:5`, non-`3:5` `g>=4`, and the 201,377-channel [raw head](../07-reflections/lrc14-disconnected-head263-finite-exact-certificate-20260812.md) close. OPEN: the `22,890` affine tails in the non-`3:5`, small-ruler `g<=3` bank; see the [frontier note](../07-reflections/lrc14-disconnected-low-geometry-and-g4-tail-20260812.md).

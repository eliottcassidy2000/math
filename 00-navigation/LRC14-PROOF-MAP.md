...
**Status: OPEN.** Caps are `1,579/216`; THM-3378 leaves `372,913/109/12` ledger/rows/families. THM-3352/3355 close connected/disconnected matched residues, THM-3360 proves the uniform `1/294` high-pair floor, and same-level edges complete `z_e=q_eL-e` on all `3,003` bodies. `k=0`, other/arbitrary `k=1` residues, projected `k=2,3`, rung, and LRC(14) remain open; `q<=25` is false.

...
**Status: OPEN.** THM-2923 leaves at most six body speeds. THM-2928 empties aligned `k>=4`; THM-2995/3114 cap projected `k=2,3` at `1,579/225`; the corrected THM-2941 assembly confines reflected-`k=1` certificate failure to the bank-uncovered wedge `561` bodies, `D>=6,1<=m<4D/3`. THM-3126 independently verifies THM-3113's six `z1=229` terminal prefixes. Arbitrary `k<=1`, the rung, and LRC(14) remain open; `q<=25` is false.

...
**Affine equality rays.** THM-4066 closes two three-exception shapes. THM-4070 recovers THM-2061's divisor-complete seam for `q<=14` and closes the `q=14` hostile/rays. THM-4075 reconnects THM-2066 owner words to close all such eleven-packs through maximum `30` (`1,824,236` total; clocks `<=38`). Higher packs, physical entry, and LRC(14) remain open.

...
### Live interfaces — THM-2586 makes the same-`b` arrival/deep rail genuinely later on all 84 cells; the missing map is selected old head to arrival sheet, then lawful co-shift/relation residue before full `X`

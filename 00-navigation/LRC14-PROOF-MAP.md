...
## 2026-08-25 current control panel
...
**Affine/antipodal and arithmetic controls.** THM-4066/4070/4075/4079 close small shapes, height `30`, and one-outlier AP10; THM-4081 leaves `kappa=7,8`. THM-4087 closes `{1,...,9,B,C}`, `70<=B<C`, through all dilations. THM-4092 reaches AP8 plus three speeds at `>=281`; THM-4100 lowers arbitrary parity to `93`. THM-4112 gives arbitrary-depth ancestry and direct AP8+5/non-AP+6 families. THM-4098/4109 handle weight-seven rows and AP7 odd-pair floors. THM-4095/4096 and THM-4105--4108 are type/physicality firewalls. THM-4119/4121/4125 classify fixed-phase tail banks; THM-4129/4132/4136 close `U`, ratio `(1,9)` over `2U`, and all odd-tail pairs there. THM-4142 closes `7,726,160` common-pool bodies; THM-4148 counts `60,301,653,510` first-window bodies. THM-4151 strengthens this to `16M<=156m+13`, eventual translation, and density `(35/39)^10`; unsafe `2{2,...,21} union {1,25}` makes its arbitrary-cardinality cap sharp. THM-4150/4152/4153 add reusable Haar/finite-exception criteria, but THM-4154 shows their concrete pools were already closed by the old mod-six clock. THM-4156 gives the repaired divisor-complete anchor family: `2,220,075` bodies, including `1,875,709` beyond both current first-window gates. THM-4160 makes the one-deletion extension exact (`11,100,375` bodies total), THM-4166 makes the two-deletion repair graph exact (`1,032` qualifying newcomers and `918,667,035` bodies with the base family), and THM-4170 completely classifies the triple-deletion transversal: exactly 61 newcomer labels fail, no `q>=925` fails, and every qualifier supplies `888,030` primitive cores with all contents and distinct positive odd tails. These are structured sufficient-certificate pools; a hostile cover is not an unsafe body. Arbitrary thirteen-speed bodies, physical entry/arrival, and LRC(14) remain open.

...
**Affine/antipodal and arithmetic controls.** THM-4066--4154 give family, type, tail, pool, and Haar gates. THM-4150 transfer plus THM-4156/4160/4166/4170/4174 make the all-anchor fixed-pool lane exact through six: failures `61,9,1,0`, hence `888,030` cores per newcomer. THM-4175 adds labelled failure-atom tomography and closes `6,660,225` one-anchor exchanges per newcomer by total depth six at `q=50`. This is not arbitrary-body closure; entry and LRC(14) remain open.

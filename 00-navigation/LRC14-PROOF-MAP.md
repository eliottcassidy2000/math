...
**Affine/antipodal and arithmetic controls.** THM-4156--4324 build and descend the fixed-pool carrier. [THM-4326](../01-canon/theorems/THM-4326-lrc14-rank-two-wall-graph-complete-typed-universe-closure.md) bypasses it for pair closure: THM-4231's `181,194` residual rows split `181,087` weighted-degree / `107` exact rank-two cases. With THM-4231/4150 this proves the fixed pool's arbitrary two-outsider and odd-tail charts. [THM-4330](../01-canon/theorems/THM-4330-lrc14-affine-two-adic-root-types-and-anchored-pool-entry-sieve.md) identifies the intrinsic first two-adic cut as `K_(m,14-m)`, closes the `1+13` root for every prescribed runner, and makes `2+12` the first unresolved type. In a degree-two anchored seam it upgrades the fixed-pool obstruction to at least three outsiders after every integral positive-rational projective refactorization and gives the actual-ratio Haar test. Re-referencing is forbidden; arbitrary-row entry and LRC(14) remain open.

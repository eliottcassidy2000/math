...
| Rank code / adaptive carry | THM-2196/2199 give finite carry charts and rank twelve; THM-2208/2212 give bounded anchors and rulers; THM-2144/2164 force height-`29` relations and `rank(W_105)>=2`; THM-2145/2166 give bounded low-carry crossing; THM-2270 makes one relation cross every balanced cut; THM-2275 gives a scalar crossing divisible by `13`; THM-2274/2283 force scalar ranks two and three at heights `2116` and `3540`; THM-2279/2282 anchor a mod-13 unit minor at `c_1` on the `120` interior rows | THM-2188 forbids static quotients. THM-2257/2258 leave `165` first-depth-one rows. THM-2261 makes raw expiration blind; THM-2263 gives sharp owner floors; THM-2267/2268 force ancestry-weighted gluing; THM-2269 gives energy in every nonzero mod-13 marked residue. Retain an integer lift and its ancestry, or control the signed whole residue class; modular address selection alone is insufficient. Treat the `15` repeated rows separately. Retain THM-2211/2216/2218/2238. |

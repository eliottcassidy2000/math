...
## 2026-09-01 current control panel
...
**Affine/antipodal and arithmetic controls.** THM-4156--4262 reduce the fixed-pool problem to `180,622` rows; THM-4266--4287 reach `22,647`, max `636`. THM-4295/4296 prove endpoint minima, depth nine, a 9,019-mask mixed carrier, and recursive ideals, leaving `21,323`, max `626`. [THM-4300](../01-canon/theorems/THM-4300-lrc14-size-preserving-response-staircase-and-index-297-ideal.md) reaches endpoint 597 and isolates 24 failures at `(210,596)`. [THM-4302](../01-canon/theorems/THM-4302-lrc14-endpoint-596-response-minimum-four-and-size-preserving-exchange.md) proves their mixed response minimum is four (rank-eight-only six), repairs them, and retains carrier size 9,019 through endpoint 596. [THM-4303](../01-canon/theorems/THM-4303-lrc14-endpoint-595-twenty-five-row-carrier-closure.md) raw-replays the 28-row endpoint-595 boundary and closes 25. [THM-4305](../01-canon/theorems/THM-4305-lrc14-endpoint-595-pair-tagged-response-exchange.md) proves the remaining 145 pair-tagged failures have exact arbitrary-rank response minimum five (mixed ranks eight/nine ten; rank eight alone 22), closes all three remaining rows with a size-9,024 carrier, and lowers the typed residual to `20,986`, max `594`. The protected 391-row family has only two strictly common-inactive carrier masks, so returning to size 9,019 needs three redundancy-aware deletions. Depth is endpoint-nonmonotone and activity is not left-compressed. These are fixed-pool certificates, not physical entry. Finite closure and LRC(14) remain open.

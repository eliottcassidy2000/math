...
**Status: OPEN.** THM-2923 leaves at most six body speeds. THM-2928/2941/2970/2972/2981/3033 empty aligned `k>=4` and cap projected `k=2,3` at `1,656/243`. THM-3032 confines reflected-`k=1` certificate failure to `617` bodies with `D>=6,1<=m<4D`. Arbitrary `k<=1`, the rung, and LRC(14) remain open; `q<=25` is false.

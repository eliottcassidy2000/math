...
**Scale-three resonance.** [THM-4373](../01-canon/theorems/THM-4373-lrc14-scale-three-signed-121-resonant-triple-comb-bound.md) proves the sharp `6/77` bound on the signed-`(1,2,1)` sector. THM-4386--4394 give the exact raw-carrier/Poisson languages and sharply close all minimal ternary-unit relation shells through norm `20`; this is not arbitrary nonresonance. The universal sector and entry remain open.

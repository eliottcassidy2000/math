...
**Status: OPEN.** Projected `k=2,3` caps are `1,579/216`; at `z1=216`, THM-3349 leaves ledger/rows/families `372,917/113/13`, next `gcd72/L720720` on rows `191,228,332`. Corrected THM-2941 leaves `561` reflected-`k=1` bodies. THM-3347 closes all-nine-low two-star dilations; THM-3348 closes both dense connected-low shapes at every scale and every non-dense connected-low shape from scale `11`, leaving `261,254` unlabelled finite heads. Arbitrary `k<=1`, disconnected component scales, the rung, and LRC(14) remain open; `q<=25` is false.

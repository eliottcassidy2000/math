...
**Affine/antipodal and arithmetic controls.** THM-4174/4175 close the fixed-pool all-three-/exactly-two-original-anchor lanes (`888,030/6,660,225` bodies per newcomer). THM-4178/4179 classify all six primitive `q=50` three-anchors: two depth-six blockers cross sharply at depth seven, giving `1,071,961` distinct exactly-one-original-anchor bodies (`591,261` beyond THM-4178). THM-4182 classifies the 32 zero-original four-anchors, collapses 27 depth-six blocker presentations to five bodies, crosses them by a sharp two-repair bank, and transfers `1,138,494` further bodies. The four disjoint original-anchor-count slices total `9,758,710` fixed-`q=50` cores. Maximal deletion identifies the all-depth repair test with the body's Haar threshold. No arbitrary-body entry follows; LRC(14) remains open.

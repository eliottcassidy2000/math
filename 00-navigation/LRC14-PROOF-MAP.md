...
**Status: OPEN.** THM-2923 leaves at most six body speeds. THM-2928--3033 empty aligned `k>=4` and cap projected `k=2,3` at `1,579/243`. THM-3041 confines its reflected-`k=1` certificate failure to the bank-uncovered wedge `582` bodies, `D>=6,1<=m<3D`. Arbitrary `k<=1`, the rung, and LRC(14) remain open; `q<=25` is false.

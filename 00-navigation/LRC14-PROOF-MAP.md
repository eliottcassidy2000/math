...
**Status: OPEN.** Caps are `1,579/216`; THM-3361 leaves `372,914/110/12` ledger/rows/families. THM-3352/3355 close connected/disconnected matched residues, THM-3360 proves the uniform `1/294` high-pair floor, and same-level edges complete `z_e=q_eL-e` on all `3,003` bodies. `k=0`, other/arbitrary `k=1` residues, projected `k=2,3`, rung, and LRC(14) remain open; `q<=25` is false.
**Disconnected-low closure.** The `36,520` complete-multipartite profiles close by THM-3355's weighted horn forest. MISTAKE-377 and THM-3360 repair the affine admissibility gate and prove the physical floor on all `22,890` lanes. Independently, THM-3372 combines a centered superunit continuum, `3,066,273,980` exact bridge masses through `p=698`, and a tail from `699` to prove `I>Dmax/5`. See the [THM-3360 note](../07-reflections/LRC14-disconnected-low-affine-limit-and-tail-certificate-kps-S171.md) and [THM-3372 note](../07-reflections/lrc14-disconnected-low-affine-tail-and-reflected-branch-closure-20260814.md).
...
**Typed transfer sidecars.** Raw drift ratios and denominator/unit passports do not determine located reflected-pair overlap. Nevertheless, four distinct reflected residue rays close projected `k=3` on all `3,003` bodies, five distinct reflected residue rays close projected `k=2` on the active `649`, and a centered-phase/fixed-tree inequality certifies explicit noncanonical `k=1` chambers. These results are [scoped survivors](../07-reflections/lrc14-reflected-pair-projected-transfer-and-affine-typed-survivor-20260814.md) and [phase-aware perturbations](../07-reflections/lrc14-reflected-residue-phase-stability-and-tree-obstruction-20260814.md), not a live-ledger decrement.

...
**Disconnected-low closure.** The `36,520` complete-multipartite profiles close by THM-3355's weighted horn forest. MISTAKE-377 and THM-3360 repair the affine admissibility gate and prove the physical floor on all `22,890` lanes. Independently, THM-3376 combines a centered superunit continuum, `3,066,273,980` exact bridge masses through `p=698`, and a tail from `699` to prove `I>Dmax/5`. See the [THM-3360 note](../07-reflections/LRC14-disconnected-low-affine-limit-and-tail-certificate-kps-S171.md) and [THM-3376 note](../07-reflections/lrc14-disconnected-low-affine-tail-and-reflected-branch-closure-20260814.md).

...
| Rank code / adaptive carry | THM-2187/2193 give rank seven; THM-2196/2199 give finite carry charts and rank twelve; THM-2208 leaves one primitive candidate per rank-eleven `(B,a)` state; THM-2203 pulls a rank-eight covector lattice through the actual dyadic scalar section | THM-2188 forbids static quotients. THM-2198/2204/2205 close `(1,1,2)/(2,2,3)/(1,1,3)`; THM-2201 retains triangular sheet motion and THM-2209 retains the sharp peel-pair layer. Prune finite states while preserving guard-hole/owner correlation, then discharge `(1,2,3)` and deeper profiles. |

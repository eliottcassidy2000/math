...
**Affine/antipodal and arithmetic controls.** THM-4188 gives the `15/19/23` resonance filtration; THM-4156 closes fixed-pool subsets by heredity (MISTAKE-520); THM-4203 retains its E8 census; THM-4191 closes one-newcomer bodies; and THM-4207/4211/4214 give fixed-pair, fixed-`50`, and Pascal charts. THM-4227/4228 retain scale/gcd methods. [THM-4231](../01-canon/theorems/THM-4231-arbitrary-pair-cofinal-depth-six-haar-repair-and-exact-outsider-lift.md) closes distinct `q,r>=1290` and fixed `q=1,r>=542`; its exact `17547/17548` repair transition remains a sidecar. Coverage-subsumed [THM-4233](../01-canon/theorems/THM-4233-pair-specific-primitive-observable-oscillation-haar-charts.md) retains the exact `(3713,5149)` observable, a unimodular compiler, and exact sufficient gate `k>=748`. [THM-4229](../01-canon/theorems/THM-4229-fixed-fifty-nineteen-label-petal-haar-charts.md)/[4234](../01-canon/theorems/THM-4234-fixed-fifty-twenty-label-pair-haar-charts.md) give the residual fixed-`50` petals, pair graph, one triple, and cofinal triple tails. Other unbounded rays have smaller label `2..1289`; arbitrary finite entry, triple remainders, physical entry, and LRC(14) remain open.

...
**Affine/antipodal and arithmetic controls.** THM-4156--4296 build the fixed-pool carrier and recursive ideals; [THM-4300](../01-canon/theorems/THM-4300-lrc14-size-preserving-response-staircase-and-index-297-ideal.md), [THM-4302](../01-canon/theorems/THM-4302-lrc14-endpoint-596-response-minimum-four-and-size-preserving-exchange.md), and [THM-4303](../01-canon/theorems/THM-4303-lrc14-endpoint-595-twenty-five-row-carrier-closure.md) descend to three endpoint-595 failures. [THM-4305](../01-canon/theorems/THM-4305-lrc14-endpoint-595-pair-tagged-response-exchange.md) proves response minima `5/10/22`. [THM-4309](../01-canon/theorems/THM-4309-lrc14-endpoint-595-support-threshold-residual-hypergraph-compression.md)--[THM-4313](../01-canon/theorems/THM-4313-lrc14-endpoint-592-fortythree-response-size-preserving-exchange.md) compress, extend, and exchange a 3,925-mask carrier across 467 rows through endpoint 592; the last response cover has full-universe bounds `8..43`. [THM-4314](../01-canon/theorems/THM-4314-lrc14-endpoint-591-complete-layer-closure-and-deletion-boundary.md) closes endpoint 591 unchanged and classifies all deletion sets through size two. [THM-4306](../01-canon/theorems/THM-4306-lrc14-index-265-recursive-ideal-two-mask-replacement.md) separately closes `H_265`. Typed `2,100/20,547`, max `590` on 13 rows. Decks remain separate; no entry or LRC(14).

...
**Affine/antipodal and arithmetic controls.** THM-4066/4070/4075/4079 close small shapes, height `30`, and one-outlier AP10; THM-4081 leaves `kappa=7,8`. THM-4087 closes `{1,...,9,B,C}`, `70<=B<C`, through all dilations. THM-4092 reaches AP8 plus three speeds at `>=281`; THM-4100 lowers arbitrary parity to `93`. THM-4112 gives arbitrary-depth parent-gap ancestry and direct AP8+5/non-AP+6 families. THM-4098 fills dilated weight-seven rows; THM-4109 gives AP7 odd-pair floors `197/232/268`. THM-4095/4096 are type firewalls. THM-4105/4106 decode reciprocal physicality but lose common time; THM-4107/4108 are tournament/radical firewalls. THM-4110 counts but does not synchronize the AP13 phase quotient. THM-4117's physical `11+2` row misses the three explicit THM-4112 shapes after every dilation; THM-4119 extends its body to a density-`14/19` fixed-phase family with the same exclusion. THM-4121 varies the projective tail multiplier and proves the sharp same-phase optimum `16/19`, again uniformly outside those three shapes. THM-4125 classifies arbitrary finite tail banks by signed projective support: fixed `1/14` density remains sharply `16/19`, but at seven tails the natural threshold admits all eighteen nonzero parameter classes. This is an explicit-family phase transition, not arbitrary-core closure; common arrival and LRC(14) remain open.

...
| Rank code / adaptive carry | THM-2196/2199 give finite carry charts, projective finiteness, and rank twelve; THM-2208/2212 reduce each rank-eleven plane to bounded anchors, one cofactor candidate, 91 ruler systems, and a signed equality skeleton; THM-2203 gives the scalar covectors | THM-2188 forbids static quotients. THM-2233/2239 reduce the scalar ledger to exactly `166`: `165` first-depth-one rows and `(3,4,5)`; THM-2250 forces the latter's normalized cores equal. THM-2239 identifies time-zero literal loss as the first-depth-one obstruction; THM-2234 gives private expansion. The sharp targets are cross-time owner switching/carry on depth one and the exact common-core depth-three Markov branch, retaining THM-2216/2218/2238 sidecars. THM-2237 proves the generic lower-moment ceiling exact; THM-2235 forbids a fixed-XOR/odd-sheet antipode shortcut. |

...
| Rank code / adaptive carry | THM-2270/2274/2275/2283 give bounded crossing and scalar ranks two/three; THM-2279/2282 anchor a mod-13 unit minor at `c_1`; THM-2276 lands the exact shallow ancestry atom for `m<=3` | THM-2276's `696` hard multipliers admit exact local private-flow cancellations, so only global cover/gluing can remove them. Treat the `45` boundary rows separately; retain THM-2211/2216/2218/2238. |

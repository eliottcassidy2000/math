...
**Affine/antipodal and arithmetic controls.** THM-4156/4191 close the zero/one-outsider layers; THM-4207/4211/4214 give fixed/cofinal/Pascal charts. [THM-4231](../01-canon/theorems/THM-4231-arbitrary-pair-cofinal-depth-six-haar-repair-and-exact-outsider-lift.md) closes every `max(q,r)>=770`, leaving 181,194 edges; its pure-ray `825`, fixed-one `542`, hybrid `1290`, direct `1307`, and activation `17547/17548` cutoffs remain distinct. [THM-4238](../01-canon/theorems/THM-4238-forty-small-label-uniform-r590-haar-tail-closure.md) closes `q in {2,...,49}\P`, `r>=590`, removing exactly 32 residual edges and leaving aggregate 181,162 with the same cutoff/top layer. THM-4227/4228/4233 retain scale/gcd/primitive methods; THM-4229/4234 retain fixed-`50` charts. Finite closure, physical entry, and LRC(14) remain open.

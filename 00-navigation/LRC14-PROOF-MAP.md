...
**Affine/fixed-pool controls.** [THM-4326](../01-canon/theorems/THM-4326-lrc14-rank-two-wall-graph-complete-typed-universe-closure.md) closes THM-4231's `181,194` residual pairs; THM-4329 completes the Pascal chart with `chi_q(P)=30`. [THM-4330](../01-canon/theorems/THM-4330-lrc14-affine-two-adic-root-types-and-anchored-pool-entry-sieve.md) closes anchored `1+13` and leaves `2+12`; its degree-twelve minority anchor has `420|h`. [THM-4335](../01-canon/theorems/THM-4335-lrc14-owner-permutation-component-address-and-minority-renewal.md) refines equality capacity to owner permutations, endpoint/determinant component boxes, and exact physical renewal tolls; its new `p=5` and `h=420` controls are safe, but transition reuse leaves the minority branch open. THM-4331/4332 give endpoint and literal boundaries. [THM-4333](../01-canon/theorems/THM-4333-lrc14-rank-three-surplus-and-cofinal-third-tail-completion.md) proves all-remainder `L_3/D>2/27`. [THM-4336](../01-canon/theorems/THM-4336-lrc14-two-pair-rank-four-surplus-and-cofinal-one-appender.md) proves `L_4/D>7/81` on `(50,70)` and `(509,640)` and lowers their direct one-appender cutoffs to `6021/5295`. Re-referencing, the other rank-four pairs, continuous completion of the `420|h` anchors, arbitrary entry, and LRC(14) remain open.

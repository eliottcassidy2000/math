...
| Rank code / adaptive carry | THM-2052 gives rank eleven; THM-2144/2164 give two height-`<=105` relations; THM-2169 bounds every deletion relation by `1247`; THM-2171 repairs order/distinctness with cap `5,430,750`; THM-2185 forces rank three by height `500` and rank two on every deletion by height `105000` | Preserve zero-safety through the rank-three pump or force a phase-sensitive terminal; existence, order, and finite rank are no longer missing. |
...
| Defect split / tail continuation | THM-2145/2166 give carry `<=708`; THM-2179 gives a `3/41` exit or body relation of height `180/140`; THM-735 closes fixed-core far cones; THM-2184 proves the varying grid tube; THM-2186 makes the affine toric profile/equality skeleton exact | Turn the body relation into a far-cone, grid-tube, or strict toric terminal while retaining phase; otherwise control the critical skeleton or changing-core residual. |

...
| Rank code / target landing | THM-2295/2298 force ranks five/six; THM-2307 gives the `77/7/1` dual ambiguity. THM-2323/2326/2327 force strict-row `91`-unit edges; THM-2349 extends the marked triangle and inverse boundary to all `165` rows at finite delayed clocks. THM-2331/2334/2337 retain target fibres, word twists, and the first jet. THM-2340 gives word ANOVA; THM-2343/2344 identify zero-only landing with a shifted endpoint inverse. THM-2350 identifies lawful dipoles but does not force a defect. THM-2356 exposes a `28,393`-dimensional refined-to-coarse kernel; THM-2363 lacks a lawful detector. THM-2436 closes deep-`c_3`; THM-2445/2442 give word-restored cells; THM-2452 gives a complete endpoint atom. THM-2457/2459 retain supplied service and drift; THM-2461 separates temporal word and roots. THM-2471/2474 saturate first-collision service. THM-2522--2527 give sharp live `L=1` drift and a fixed positive delayed-owner Boolean odd coordinate; THM-2528 gives intrinsic chiral paths and scalar norm banks. THM-2529--2531 replace the deep self-correlation quotient by a positive comb consumer, a lossless anchored Gram skew, and a quadratic target-selector star, refining zero target drift to full path-mask invariance. THM-2535 converts the free `C_7` scheduler torsor into a positive-mass clock-holonomy root dipole. Source and arrival times remain distinct. | Transfer one positive selector/Gram/holonomy coordinate into the scalar source--arrival row and inherit the old source/deep type; root orientation, target-root anchoring, and abstract clock covariance are closed. |

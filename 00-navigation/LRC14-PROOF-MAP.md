...
**Scale-three universal closure.** [THM-4434](../01-canon/theorems/THM-4434-lrc14-universal-scale-three-network-projection-bound.md) proves `min_i E_i<=6/77` for all primitive distinct positive odd ternary-unit triples, with equality only at `(1,5,11)`. It closes the physical triple-comb bound too, extending THM-4373 beyond resonance. The proof combines a zonotope/short-relation tail with exact coefficient and native interval certificates. [Actual-core measure and joint phase](../05-knowledge/results/lrc14_universal_haar_consumer_empty_core_certificate_sep06.md), mixed-parity entry, synchronization and LRC(14) remain open.

...
**Affine equality rays.** THM-4066/4070 close the small affine shapes; THM-4075 closes divisor-complete eleven-packs through maximum `30`. THM-4079 absorbs large single outliers by adaptive clocks and closes `{1,...,10,B}` for `12012|B`, even when fixed banks are blind. Arbitrary higher packs, physical entry, and LRC(14) remain open.

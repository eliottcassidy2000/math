...
**Status: OPEN.** THM-2923 leaves at most six body speeds. THM-2928 empties aligned `k>=4`; THM-2995/3113 cap projected `k=2,3` at `1,579/227`; repaired THM-2941 confines reflected-`k=1` certificate failure to `561` bodies, `D>=6,1<=m<D/2`. Arbitrary `k<=1`, the rung, and LRC(14) remain open; `q<=25` is false.

...
**Affine/antipodal and arithmetic controls.** THM-4174/4175 close the fixed-pool all-three-/exactly-two-original-anchor lanes (`888,030/6,660,225` bodies per newcomer). THM-4178/4179 classify all six primitive `q=50` three-anchors and transfer `1,071,961` exactly-one-original-anchor bodies. THM-4182 starts the zero-original slice; THM-4185 completes every declared good zero-original ten-body through the exact `32/297/24` size-`4/5/6` anchor hierarchy and repair staircase, transferring `1,491,665`. The four disjoint original-anchor-count slices total `10,111,881` fixed-`q=50` cores. Maximal deletion identifies the all-depth repair test with the body's Haar threshold. No arbitrary-body entry follows; LRC(14) remains open.

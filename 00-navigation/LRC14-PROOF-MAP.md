...
**Affine/antipodal and arithmetic controls.** THM-4066/4070/4075/4079 close small shapes, height `30`, and one-outlier AP10; THM-4081 leaves `kappa=7,8`. THM-4087 closes `{1,...,9,B,C}`, `70<=B<C`, through all dilations. THM-4092 reaches AP8 plus three speeds at `>=281` and the all-even row at `>=85`; THM-4100's component-ancestry refinement lowers arbitrary parity to `93`. THM-4098 fills dilated weight-seven rows; THM-4109 gives AP7 odd-pair floors `197/232/268` at gaps `4/8/12`, improving `264` only for gaps `4,8`. THM-4095/4096 are quantifier/type firewalls. THM-4105/4106 decode reciprocal physicality and non-all-odd primitive rows but lose common time; THM-4107/4108 are tournament/radical firewalls, with radical saturation ABC-conditional. THM-4110 counts the AP13 phase quotient but does not synchronize it. None gives arbitrary-core closure, common arrival, or LRC(14).
...
| Dyadic owner words | THM-2066/4075 close divisor-complete eleven-cores through `30`. THM-4087 supplies AP9 plus two outliers; THM-4092 supplies AP5--AP8 families. THM-4100 lowers the arbitrary-parity AP8-plus-three cutoff to `93` (all-even remains `85`). THM-4098 fills dilated weight-seven rows; THM-4109 gives unscaled AP7 selected-pair floors `197/232/268` at gaps `4/8/12`, superseding THM-4101 only at gaps `4,8`. | Arbitrary-core closure, general unscaled weight-seven absorption, and a residual-to-AP supplier remain open. |

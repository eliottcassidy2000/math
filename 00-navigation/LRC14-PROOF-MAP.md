...
| Rank code / adaptive carry | THM-2187 gives a saturated rank-six carrier; THM-2193 gives safe-torus floor `7^-21` and rank seven by `78*7^21`; THM-2196 gives finite circuit/carry charts, a `91||c||_infinity` one-carry terminal, and qualitative projective finiteness | THM-2188 proves static data target-blind and THM-2192 quantifies scalarization loss. THM-2197 proves scalar root-sheet coverage has the Boolean deficiency semilattice, not an intrinsic mask tournament; THM-2198 shows multiplication by thirteen additionally needs occupancy and coefficient winding, though it now closes profile `(1,1,2)`. Make THM-2196's rank lifts effective or discharge its finite primitive locus while preserving those sidecars. |

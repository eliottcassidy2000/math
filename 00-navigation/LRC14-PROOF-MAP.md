...
**Scale-three closure.** [THM-4445](../01-canon/theorems/THM-4445-lrc14-signed-111-sharp-obstruction-classification.md) gives sharp additive `6/55`; [THM-4441](../01-canon/theorems/THM-4441-lrc14-signed-122-sharp-ray-closure.md) removes `(1,2,2)`; [THM-4444](../01-canon/theorems/THM-4444-lrc14-signed-112-sharp-one-ray-classification.md) leaves only `(2,11,20)` above and `(1,5,11)` on the `6/77` boundary. [THM-4442](../01-canon/theorems/THM-4442-lrc14-bounded-ten-body-parity-free-scale-three-completion.md) completes every tail over ten-bodies in `[13]`; [THM-4446](../01-canon/theorems/THM-4446-lrc14-primitive-ten-pack-descent-and-dilation-rays.md) propagates all 286 bodies along every integer dilation ray and forces an actual survivor to have gcd-one pack and cross height above `91^6`. Component-address entry and LRC(14) remain open.

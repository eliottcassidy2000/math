...
**Affine/antipodal and arithmetic controls.** THM-4188 gives the `15/19/23` resonance filtration; THM-4191's full deck transfers all `C(30,10)=30,045,015` pool bodies per newcomer, sharply using depth seven at q50 and native depth six on 23 exceptions. THM-4201 gives the exactly-one projected profile: 65/69 rows close at depth five and four at depth six with `tau=10/9/10/10`; THM-4190 retains independent zeta margins. A [FINITE-EXACT single-path scout](../05-knowledge/results/lrc14-post-full-pool-two-newcomer-frontier-20260826.md) has `tau(E_7(50))=11`, a pair `{49,50}` depth-`7 -> 8` step, a `{6,50}` hostile, and a conditional separated tail. [THM-4207](../01-canon/theorems/THM-4207-two-newcomer-sharp-depth-transition-base-surplus-composition-and-variable-pool-chart-number.md) proves the comparable `(50,51)` transition `tau(E8)=8` but `tau(E9)>9`, closes all `14,307,150` fixed-pair eleven-body cores and their THM-4150 odd-tail LRC(14) families, and isolates base surplus as the missing marginal-composition coordinate. Arbitrary pairs, physical entry, and full LRC(14) remain open.

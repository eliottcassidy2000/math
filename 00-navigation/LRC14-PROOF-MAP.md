...
**Affine/antipodal and arithmetic controls.** THM-4156/4191 close the zero/one-outsider layers; THM-4207/4211/4214 give fixed/cofinal/Pascal charts. [THM-4231](../01-canon/theorems/THM-4231-arbitrary-pair-cofinal-depth-six-haar-repair-and-exact-outsider-lift.md) closes every `max(q,r)>=770`, leaving 181,194 edges; [THM-4238](../01-canon/theorems/THM-4238-forty-small-label-uniform-r590-haar-tail-closure.md) removes exactly 32, leaving aggregate 181,162 with the same cutoff/top layer. THM-4227/4228/4233 retain scale/gcd/primitive methods. THM-4229/4234/[4240](../01-canon/theorems/THM-4240-fixed-fifty-twenty-two-label-four-petal-haar-chart.md) grow fixed-`50` charts through four petals and prove `chi_50>=22`, but do not remove a universal full-`P` edge. Finite closure, physical entry, and LRC(14) remain open.

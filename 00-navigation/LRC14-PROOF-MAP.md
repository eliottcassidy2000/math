...
**Affine/antipodal and arithmetic controls.** THM-4156/4191 close the zero/one-outsider layers; THM-4207/4211/4214 give fixed/cofinal/Pascal charts. [THM-4231](../01-canon/theorems/THM-4231-arbitrary-pair-cofinal-depth-six-haar-repair-and-exact-outsider-lift.md) closes every `max(q,r)>=770`; THM-4238/4242/4254/4256/4261/4262 reduce the exact fixed-pool residual to `180,622`. THM-4266--4287 combine learned carriers, uniform decks, and signature-ideal surgery, reaching `22,647`, maximum `636`. [THM-4295](../01-canon/theorems/THM-4295-lrc14-endpoint-636-minimum-fourteen-exchange-and-recursive-signature-ideals.md) proves the exact row-aware rank-eight append-only minimum `14` for THM-4287's 101 endpoint-636 failures. A downstream-optimal 9,020-mask carrier closes every live row at endpoints `636..633` and first fails at `632` with 37 bodies. At `(256,632)`, body `1d106401` has no active disjoint rank-eight mask, so no larger append-only rank-eight carrier can repair that row. Separately, three complete recursive signature ideals of sizes `36,21,54` have exact replacement minima `2,4,4`. Their three common-deck nodes and the ten-row carrier node have typed union `118`, leaving `22,529`, maximum `632`, on ten rows. This zero-response result terminates one sufficient-certificate operation; it is not physical danger. THM-4227/4228/4233 retain scale/gcd/primitive methods. Finite closure, physical entry, and LRC(14) remain open.

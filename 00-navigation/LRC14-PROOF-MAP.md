...
**Affine/antipodal controls.** THM-4066/4070 close small affine shapes; THM-4075 closes divisor-complete eleven-packs through `30`; THM-4079 closes `{1,...,10,B}` for `12012|B`. THM-4081 classifies height-twelve antipodal obstruction by `D*={1,3,4,5,7,8,9,11,12}`, with odd/even dilation split and cited `7<=kappa<=9`. Arbitrary packs, physical entry, `kappa=7,8`, an antipodal-to-direct bridge, and LRC(14) remain open.
...
| Dyadic owner words | THM-2066/4075 close every divisor-complete eleven-core through `30`, including nonprimitive cores; clocks `15..38` suffice, while THM-2068's seven-clock minimum inside `15..34` is menu-relative | All-height closure remains open; THM-2072 makes every core-independent fixed bank blind somewhere. |

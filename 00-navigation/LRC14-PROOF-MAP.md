...
**Affine/antipodal and arithmetic controls.** THM-4156/4191 close the zero/one-outsider layers; THM-4188 retains the `15/19/23` filtration, and THM-4207/4211/4214 give pair, fixed-`50`, and Pascal charts. THM-4227/4228 retain scale/gcd methods. [THM-4231](../01-canon/theorems/THM-4231-arbitrary-pair-cofinal-depth-six-haar-repair-and-exact-outsider-lift.md) closes distinct `q,r>=1290` and `q=1,r>=542`. [THM-4238](../01-canon/theorems/THM-4238-forty-small-label-uniform-r590-haar-tail-closure.md) closes every genuine `q<=49`, `r>=590`, and pool nine-body. Coverage-subsumed THM-4233 retains its unimodular gate `k>=748`; [THM-4229](../01-canon/theorems/THM-4229-fixed-fifty-nineteen-label-petal-haar-charts.md)/[4234](../01-canon/theorems/THM-4234-fixed-fifty-twenty-label-pair-haar-charts.md) retain the fixed-`50` petals/triples. General `q=50..1289`, triple remainders, physical entry, and LRC(14) remain open.

...
**Affine/antipodal and arithmetic controls.** THM-4066--4154 give family, type, tail, pool, and Haar gates. THM-4150--4174 make fixed-pool deletions exact through six: failures at `d=3..6` are `61,9,1,0`, so every newcomer supplies `888,030` cores. This is not arbitrary-body closure; entry and LRC(14) remain open.

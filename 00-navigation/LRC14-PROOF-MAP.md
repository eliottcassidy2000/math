...
Independently audited THM-2449 says any rational lawful anchored continuation either fires all `72` mixed source-target colours after one rectangle defect or is exactly delta plus six replicas; its clock classes reduce to two additive matrices. The remaining obligation is semantic THM-2305 word/repair identification and canonical THM-2401 root orientation for the THM-2452 matched literal atom, not ownerless cancellation, missing-factor enumeration, or transition conversion.

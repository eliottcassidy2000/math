...
| Rank code / adaptive carry | THM-2196/2199 give finite carry charts and rank twelve; THM-2208/2212 give bounded anchors and rulers; THM-2144/2164 force height-`29` relations and `rank(W_105)>=2`; THM-2145/2166 give bounded low-carry relations through every `6+7` cut | THM-2188 forbids static quotients. THM-2257/2258 leave `165` first-depth-one rows. THM-2263 gives sharp owner floors, but THM-2261 proves raw expiration blind. THM-2267/2268 force the next carrier to retain ancestry-weighted gluing, not only static owner or raw carry. Couple that gluing to a bounded crossing frequency; treat the `15` repeated-first rows separately. Retain THM-2211/2216/2218/2238. |

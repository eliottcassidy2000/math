...
**Affine/antipodal and arithmetic controls.** THM-4156--4262 reduce the fixed-pool problem to `180,622` rows; THM-4266--4287 reach `22,647`, max `636`. THM-4295/4296 prove endpoint minima, depth nine, a 9,019-mask mixed carrier, and recursive ideals, leaving `21,323`, max `626`. [THM-4300](../01-canon/theorems/THM-4300-lrc14-size-preserving-response-staircase-and-index-297-ideal.md) reaches endpoint 597 and isolates 24 failures at `(210,596)`. [THM-4302](../01-canon/theorems/THM-4302-lrc14-endpoint-596-response-minimum-four-and-size-preserving-exchange.md) proves their mixed response minimum is four (rank-eight-only six), repairs them, and retains carrier size 9,019 through endpoint 596. [THM-4303](../01-canon/theorems/THM-4303-lrc14-endpoint-595-twenty-five-row-carrier-closure.md) raw-replays the 28-row endpoint-595 boundary and closes 25. Typed union `1,658`; complement `20,989`, max `595` only at `(96,595),(100,595),(210,595)`. Depth is endpoint-nonmonotone and activity is not left-compressed. These are fixed-pool certificates, not physical entry. Finite closure and LRC(14) remain open.

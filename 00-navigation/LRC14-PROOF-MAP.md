...
**Affine/antipodal and arithmetic controls.** THM-4188 gives the exact `15/19/23` resonance filtration. THM-4191 returns to the full unprojected repair deck and closes every `B in C(P,10)`: q50 depth seven and native depth six on the 23 resonances, with a q50 depth-six ten-cover making this certificate sharp. Thus all `C(30,10)=30,045,015` fixed-pool bodies transfer per newcomer. THM-4201 resolves the exactly-one projected profile: 65 of 69 resonance-anchor rows close at depth five; four close at depth six with `tau=10/9/10/10`. THM-4190 retains independent body-zeta margins on its `1,071,961` subfamily. Physical entry, a second uncontrolled label, and LRC(14) remain open.

...
**Affine/antipodal and arithmetic controls.** THM-4066/4070/4075/4079 close small shapes, height `30`, and one-outlier AP10; THM-4081 leaves `kappa=7,8`. THM-4087 closes `{1,...,9,B,C}`, `70<=B<C`, through all dilations. THM-4092 reaches AP8 plus three speeds at `>=281`; THM-4100 lowers arbitrary parity to `93`. THM-4112 gives arbitrary-depth ancestry and direct AP8+5/non-AP+6 families. THM-4098/4109 handle weight-seven rows and AP7 odd-pair floors. THM-4095/4096 are type firewalls; THM-4105--4108 decode reciprocal physicality and block tournament/radical shortcuts. THM-4110 counts but does not synchronize AP13 phases. THM-4119/4121/4125 classify fixed-phase `U`-body tail banks. THM-4129 closes all `5,855` scale-one slices of `U=(1,4,6,8,10,12,14,15,16,18,22)`. THM-4132 treats ratio `(1,9)` over `2U`; THM-4136 closes all odd-tail pairs there. THM-4142 closes `7,726,160` bodies from a common 26-speed pool. THM-4148 replaces common clocks by the movable first window: every body with `13/(14M)-1/(14m)>=2/189` has universal odd-tail completion; small clock banks close `m=1,2`, and the complete width census is `60,301,653,510` eleven-body families on labels `1..80`. Forty-six is sharp for consecutive blocks under this mechanism. Arbitrary bodies, entry, arrival and LRC(14) remain open.

...
| Rank code / adaptive carry | THM-2187 gives a saturated rank-six carrier; THM-2190 forces ranks `3,4,5,6` by `178,204,262,450`; THM-2193 gives safe-torus floor `7^-21` and rank seven by `78*7^21` | THM-2188 proves static finite data target-blind, while THM-2192 quantifies the scalarization kernel loss. Preserve critical scale/phase through a graded pump. |

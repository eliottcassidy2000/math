...
| Rank code / adaptive carry | THM-2196/2199 give finite carry charts, projective finiteness, and rank twelve; THM-2208/2212 reduce each rank-eleven plane to bounded anchors, one cofactor candidate, 91 ruler systems, and a signed equality skeleton; THM-2264 gives height-`29` relations and THM-2265 crossing relations through every `6+7` cut | THM-2188 forbids static quotients. THM-2233/2239 leave `165` first-depth-one rows; THM-2257/2258 close the last depth-three row. THM-2263 gives profile-sharp owner floors, but THM-2261 proves raw expiration surjective. Couple the global relation frequency to a marked multicore handoff; treat the `15` repeated-first rows separately. Retain THM-2211/2216/2218/2238 sidecars. THM-2237 proves the generic lower-moment ceiling exact; THM-2235 forbids a fixed-XOR/odd-sheet antipode shortcut. |

...
**Affine/antipodal and arithmetic controls.** THM-4188 gives the exact `15/19/23` resonance filtration. THM-4191 returns to its full unprojected repair deck and closes every `B in C(P,10)`: q50 depth seven has no ten-cover, every exceptional native depth-six deck has no ten-cover, and a q50 depth-six ten-cover makes this certificate sharp. Thus all `C(30,10)=30,045,015` fixed-pool bodies transfer for every newcomer. THM-4201 resolves the exactly-one projected depth profile: 65 of 69 resonance-anchor rows close at depth five; the four exceptions close at depth six with transversal numbers `10/9/10/10`. No physical entry or outside-pool classification follows; LRC(14) remains open.

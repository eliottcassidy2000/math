...
**Affine/antipodal and arithmetic controls.** THM-4156/4191 close the zero/one-outsider layers; THM-4207/4211/4214 give fixed/cofinal/Pascal charts. [THM-4231](../01-canon/theorems/THM-4231-arbitrary-pair-cofinal-depth-six-haar-repair-and-exact-outsider-lift.md) closes every `max(q,r)>=770`, leaving an exact 181,194-edge proof residual in `max(q,r)<=769`; its pure-ray `825`, fixed-one `542`, hybrid `1290`, direct `1307`, and activation `17547/17548` cutoffs remain distinct sidecars. [THM-4238](../01-canon/theorems/THM-4238-forty-small-label-uniform-r590-haar-tail-closure.md) further closes all `q in {2,...,49}\P`, `r>=590`. THM-4227/4228 and coverage-subsumed THM-4233 retain scale/gcd/primitive methods, the latter with gate `k>=748`; THM-4229/4234 retain fixed-`50` pair/triple charts. Finite residual closure, physical entry, and LRC(14) remain open.

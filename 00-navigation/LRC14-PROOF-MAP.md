...
**Affine/antipodal and arithmetic controls.** THM-4188 gives the `15/19/23` resonance filtration; THM-4156 closes every fixed-pool subset by heredity (MISTAKE-520); THM-4203 retains its sharp E8 census; and THM-4191 closes every one-newcomer body. THM-4207/4211/4214 give fixed-pair, fixed-`50`, and Pascal charts. THM-4227/4228 retain scale-order and common-gcd methods. [THM-4231](../01-canon/theorems/THM-4231-arbitrary-pair-cofinal-depth-six-haar-repair-and-exact-outsider-lift.md) exhausts all `C(30,9)` bodies: direct cutoff `1307`, two-path literal completion for distinct `q,r>=1290`, and fixed `q=1,r>=542` (certificate cutoff `543`); it fills every `C(32,11)` face in those charts, while the exact `17547/17548` repair transition remains a sidecar. Coverage-subsumed [THM-4233](../01-canon/theorems/THM-4233-pair-specific-primitive-observable-oscillation-haar-charts.md) retains the exact gcd-one `(3713,5149)` observable, a general unimodular cyclotomic-zero compiler, and its sharp period-seven sufficient-gate transition `k>=748`. [THM-4229](../01-canon/theorems/THM-4229-fixed-fifty-nineteen-label-petal-haar-charts.md) gives twelve fixed-`50` petals; [THM-4234](../01-canon/theorems/THM-4234-fixed-fifty-twenty-label-pair-haar-charts.md) proves their complete symmetric pair graph `K_12`, one universal maximin-surplus triple, and uniform cofinal tails for all 220 triples on the genuine residual `q=50` chart. Other unbounded outsider rays have smaller label `2..1289`; arbitrary finite entry, the other triple remainders, physical entry, and LRC(14) remain open.

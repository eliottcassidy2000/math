...
| Rank code / adaptive carry | THM-2295/2298 force ranks five/six by `196/526`; THM-2301 gives bright/dark banks; THM-2287 gives the interior anchored atlas; THM-2296/2299/2300/2305 give prescribed service, exact owner-word edges/forks, and multiples through `m=6`; THM-2303 types the missing component current | Derive lawful relative phase transport or composable owner overlap: THM-2299 kills the pair atom despite the anchored flag. The primitive/base bank stays `696`, the no-forced bank is `693`, and the fork/other-`45` branches need anchor-free structure. |

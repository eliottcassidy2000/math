...
**Status: OPEN.** Projected `k=2,3` caps are `1,579/216`; at `z1=216`, THM-3351 leaves ledger/rows/families `372,917/113/13`, next `gcd72/L720720` on rows `191,228,332`. THM-3349 closes all-nine-low two-star dilations; THM-3350/3352 close every labelled connected-low primitive ray; THM-3355 closes disconnected-low and repeated levels. Therefore every positive canonical reflected-residue assignment closes on all `3,003` bodies, including the former `561`-body residual. `k=0`, arbitrary six-drift `k=1`, other residue packets, projected `k=2,3`, the rung, and LRC(14) remain open; `q<=25` is false.
**Disconnected-low closure.**  Its `36,520` realizable profiles have a complete-multipartite five-edge high tree. [THM-3355](../01-canon/theorems/THM-3355-disconnected-low-affine-tail-and-reflected-branch-closure.md) proves every physical high edge exceeds `D_max/5`: far ratios, large rulers, `3:5`, `g>=4`, the `p<264` head, a `3,066,273,980`-mass bridge through `p=698`, and a centered superunit affine tail from `p=699` form an exhaustive partition. Five strict floors beat the whole debt. The old `22,890` affine-ray bank is closed, not current frontier.

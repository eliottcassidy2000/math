...
**Affine/antipodal and arithmetic controls.** THM-4174/4175 close the fixed-pool all-/one-anchor lanes (`888,030/6,660,225` bodies per newcomer). THM-4178/4179 classify all six primitive `q=50` anchors: two depth-six blockers cross sharply at depth seven, giving `1,071,961` distinct exactly-one-original-anchor bodies (`591,261` beyond THM-4178). Maximal deletion identifies the all-depth repair test with the body's Haar threshold. No arbitrary-body entry follows; LRC(14) remains open.

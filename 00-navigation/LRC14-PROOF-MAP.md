...
**Affine/antipodal controls.** THM-4066/4070/4075/4079 close small shapes, height `30`, and one-outlier AP10; THM-4081 leaves `kappa=7,8`. THM-4087 closes exactly `{1,...,9,B,C}`, `70<=B<C`, at adaptive `N<=14C` through all dilations. Its width/height hostiles leave arbitrary packs, AP9 supply, physical entry, and LRC(14) open.
...
| Dyadic owner words | THM-2066/4075 close every divisor-complete eleven-core through `30`, including nonprimitive cores; clocks `15..38` suffice, while THM-2068's seven-clock minimum inside `15..34` is menu-relative. THM-4087 supplies the all-height AP9 two-outlier family and all its dilations. | Arbitrary-core closure and a residual-to-AP9 supplier remain open; THM-2072 makes every core-independent fixed bank blind somewhere. |

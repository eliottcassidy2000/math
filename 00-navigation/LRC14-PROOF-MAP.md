...
**Scale-three closure.** [THM-4434](../01-canon/theorems/THM-4434-lrc14-universal-scale-three-network-projection-bound.md) proves the sharp odd ternary-unit `min E<=6/77` bound. [THM-4437](../01-canon/theorems/THM-4437-lrc14-all-parity-network-reduction-to-three-low-circuits.md) removes parity outside signed patterns `(1,1,1)`, `(1,1,2)`, `(1,2,2)`: every projection is `<=6/77`, the minimum is strict, and three coordinates attain equality. [Body-phase entry](../05-knowledge/results/lrc14_universal_haar_consumer_empty_core_certificate_sep06.md), low circuits and LRC(14) remain open.

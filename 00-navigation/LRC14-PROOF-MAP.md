...
**Status: OPEN.** THM-2923 leaves at most six body speeds.  THM-2941 gives wall `h/7` with empty zero excess; THM-2928/2941/2970/2972 and finite-exact boundary referees through the `z1=1616` shell empty aligned `k>=4`, give cap `k=2,3` at `1,615/270`, and empty the common-level reflected `k=1` diagonal.  The remaining censuses, arbitrary `k<=1`, rung, and LRC(14) are open; reserved THM-2980's full band statement is not proved; `q<=25` is false.

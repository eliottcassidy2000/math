...
| Rank code / adaptive carry | THM-2187 gives a saturated rank-six carrier; THM-2193 gives rank seven by `78*7^21`; THM-2196 gives circuit/carry charts; THM-2199 gives rank twelve by `78*182^13`; THM-2203 pulls a saturated rank-eight covector lattice through the actual dyadic scalar section | THM-2188 proves static data target-blind. THM-2198/2204 close `(1,1,2)/(2,2,3)` but expose labelled guard-hole correlation as the missing recursive state; THM-2201 retains triangular sheet motion. Preserve that sidecar and discharge `(1,1,3)/(1,2,3)`. |

...
| Rank code / adaptive carry | THM-2052 gives rank eleven; THM-2144/2164 give two height-`<=105` relations; THM-2171 repairs order/distinctness; THM-2190 forces rank six by height `450`, rank five on every deletion by `235800`, and rank seven at some absolute finite height | Convert the bounded rank-seven carrier into a phase-sensitive terminal; scalar relation rank alone cannot cross THM-2168's evaluation-kernel shear. |

...
**Affine/antipodal and arithmetic controls.** THM-4066/4070/4075/4079 close small shapes, height `30`, and one-outlier AP10; THM-4081 leaves `kappa=7,8`. THM-4087 closes `{1,...,9,B,C}` through dilations; THM-4092/4100 reach AP8 plus three speeds; THM-4112 gives arbitrary-depth ancestry and direct AP8+5/non-AP+6 families. THM-4095--4109 provide weight-seven, pair-floor, type, and physicality controls. THM-4119--4136 classify fixed-phase tails and odd-pair transfers. THM-4142--4154 give pool, first-window, Haar, and corrected-scope gates. THM-4150--4170 give an exact fixed-pool deletion ladder: arity three has exactly 61 certificate failures, none after `q=924`, and `888,030` cores per qualifier. Failure is not danger; arbitrary bodies, entry/arrival, and LRC(14) remain open.

...
**Status: OPEN.** THM-2923 leaves at most six body speeds. THM-2928 empties aligned `k>=4`; THM-2995/3111 cap projected `k=2,3` at `1,579/229`; the corrected THM-2941 assembly confines reflected-`k=1` certificate failure to the bank-uncovered wedge `561` bodies, `D>=6,1<=m<4D/3`. Audited THM-3126 closes six named `z1=229` prefix families, but only candidate THM-3113 proposes cap `227`. Arbitrary `k<=1`, the rung, and LRC(14) remain open; `q<=25` is false.

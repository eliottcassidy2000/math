...
**Finite-exact U_full sidecar.** [Minimum-address audit](../07-reflections/lrc_endpoint_ufull_minimum_joint_address_gate_20260816.md) retains pre-merge factor lineage and proves one joint mixed-Haar/address scalar is the minimum `2x2` bridge debt; its calibrated positive is only an API witness because no map from circle cells to THM-2471 sheets, horizons, and address is known.

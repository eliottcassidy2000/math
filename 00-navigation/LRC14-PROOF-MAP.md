...
**Status: OPEN.** Projected `k=2,3` caps are `1,579/216`; at `z1=216`, THM-3351 leaves ledger/rows/families `372,917/113/13`, next `gcd72/L720720` on rows `191,228,332`. Corrected THM-2941 leaves `561` reflected-`k=1` bodies. THM-3349--3352 close all connected-low rays. Disconnected-low closes for `q>=8p`, non-`3:5` small-ruler `g>=4`, and all-context `g>=19`; `3:5` and other `g<=3` remain open. Arbitrary `k<=1`, the rung, and LRC(14) remain open; `q<=25` is false.

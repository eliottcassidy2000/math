...
The useful signal was not to copy its formulas.  It was to separate four
invoices that had looked entangled in THM-3913:

```text
branch rationality;
normal cubic order;
actual three-class globalization;
plane/Keller realizability.                               (1)
```

THM-3918 pays the first three by a sparse deformation inside the THM-3913
family, with a different singular packet and no explicit rational maximal-
order chart.
...
positive atlas certificate.  THM-3920 and THM-3921 are presently
**RESERVED / UNPROVED** namespaces for the general boundary-address lemma and
the associated decic degeneration packet; no claim from either reservation
is used here.
...
6. **Compare the THM-3917 escape.**  Test whether its repeated-residual
   genus-zero mechanism can occur in the THM-3918 rational fibre without the
   six-address boundary collision.  Treat THM-3920/3921 as task namespaces
   until their reserved statements are independently promoted.

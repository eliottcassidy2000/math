...
See [[the-minimal-relation-binds-the-cusp]] (HYP-3585, the same-side version corrected here), [[even-graphs-as-first-class]] (the dual `E_n`), [[relations-not-things]] (the cyclicity is the only invariant), THM-588 (no cut invariant, only the quadratic), THM-586 (Paley = the optimum). New: HYP-3586.

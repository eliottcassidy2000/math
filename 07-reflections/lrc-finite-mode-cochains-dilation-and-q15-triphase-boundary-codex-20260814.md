...
**Current-canon update (2026-08-15):** THM-3398 now proves the all-`q`
finite-mode/cochain theorem, and THM-3402 proves the atomized cover and exact
locus reconstruction.  The provisional language below records the historical
pre-promotion state; its finite rank-bounded probes retain their stated scope.

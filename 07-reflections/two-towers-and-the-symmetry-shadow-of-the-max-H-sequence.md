...
- **The Paley tower** — primes `p ≡ 3 mod 4`: `3, 7, 11, 19, 23, 31, …`. Each `T_p` is vertex-transitive (`Z_p` rotation), `p | H = p·odd`, achieves `a(p)`, and has the full dihedral `D_{2p}` with the Burnside identity `(H+pf)/(2p) ∈ ℤ` (THM-584). The arithmetic side: `p | H`, `H/p` odd, `R(p)→e`.
...
See [[tournaments-are-number-theoretic-the-paley-bridge-and-the-multiplicative-spine]] (THM-584, HYP-3539), [[the-two-indices-redei-is-odd-lonely-is-even-half-tiling-is-the-quotient]] (THM-582), [[everything-is-the-triangle]]. New: THM-585. Towers: THM-448 (Mersenne doubling), THM-338 (circulant threshold), A038375.

...
- **Conjectural (n≥7):** `κ(7)=11` is a **454/456 near-miss** with the skip-2 diagonal (mac-mini) — the n=7 echo of my n=6 `42/56`, so whether `ρ(7)=11` (via another config) or `12` is open; MFAS-max = Paley for all n; the depth-extremality form of OPEN-Q-108. The closed form fits n≤6 exactly and is the natural conjecture, but the near-miss warns the coverage obstruction may cost another bit.

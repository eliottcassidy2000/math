...
interval atoms, endpoint labels, branch blockers, and two-adic descent data; it
should not collapse the problem to a harmonic scalar before the overlap sidecar
has been certified.

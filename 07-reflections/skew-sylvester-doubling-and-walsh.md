...
**Source:** kind-pasteur-2026-06-09-S1 (THM-447..448, THM-450..452, THM-454, T767, HYP-2332..2337 + 2350..2355, MISTAKE-065)
...
1. **HYP-2352:** prove Aut ≡ F_21 and the labeled link recursion from the closed-form arc law
   (both look inductive; the closed form makes them finite-check-per-level).
2. **HYP-2353:** n=7 stress test — separate cycle-spectrum from pair statistics in THM-454(5);
   also first nonzero-c7 test of the 128 coefficient.
3. **HYP-2351:** is H(T15) the n=15 maximum? Needs the score-class reduction (SC maximizer
   theorem machinery) — brute force is out of reach.
4. **HYP-2350:** the consecutive-circulant K₂≅SCblow coincidence — find the bijection, test n=9.

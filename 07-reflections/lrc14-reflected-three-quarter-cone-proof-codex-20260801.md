# LRC14 reflected levels: audit-required `4m >= 3D` cone candidate
...
> one-cone referee.  Its finite CSP census is retained, but its claimed
> all-assignment tail cover and cone conclusion are not proved.

...
[THM-4002](../01-canon/theorems/THM-4002-lrc14-signed-endpoint-cross-phase-and-fixed-scale-two-family.md)
...
collision and THM-4002's Graver/half-translate hostiles are complementary
...
does not recover its sign partition, owner, or endpoint phase.  THM-4002's
...
The proved LRC endpoint theorem moved again to collision-free THM-4002; the namespace
...
| LRC projected polyhedron | short Graver row | take a minimum-width flatness covector | necessary relation with `l1<=356` | sign partition, owner and physical phase | labelled endpoint word plus cross-phase | THM-4002 equal-Graver opposite-covariance hostile |

...
[THM-3952](../01-canon/theorems/THM-3952-lrc14-signed-endpoint-cross-phase-and-fixed-scale-two-family.md)
...
collision and THM-3952's Graver/half-translate hostiles are complementary
...
does not recover its sign partition, owner, or endpoint phase.  THM-3952's
...
| LRC projected polyhedron | short Graver row | take a minimum-width flatness covector | necessary relation with `l1<=356` | sign partition, owner and physical phase | labelled endpoint word plus cross-phase | THM-3952 equal-Graver opposite-covariance hostile |
...
1. **LRC anchor:** combine auxiliary-center and endpoint cross-phase uniformly
   ...
   keeping `t<U` separate.  THM-3952 closes only the 1,365 fixed bodies

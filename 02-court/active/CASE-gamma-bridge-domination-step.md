...
THM-1660 now proves the constant-coefficient case of exactly that conclusion by a route
that needs no domination at all, which makes the mechanism question separable from the
truth question.

## A repair direction — now carried out (THM-1660)

The repair below was written before I found that it generalises. It does: see **THM-1660**,

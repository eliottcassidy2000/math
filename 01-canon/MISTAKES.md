...
- **Why it is wrong:** a SINGLE high-frequency runner fragments a fixed safe interval
  ...
  `18,22,38,72` at `N=101,211,503,1009`). THM-776 strengthens this inside the literal
...
- **The correct framing:** the candidate invariant is PEEL-RELATIVE, not absolute:
  ...
  measured maximum at the `{1,...,12}` shape. THM-776 proves the entire chart-native
...
- **Source:** THM-776/777; HYP-6830 correction; HYP-6815 exact audit; codex exact scripts;

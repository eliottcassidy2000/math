...
27g. **Fourier co-support is not a raw common atom.** THM-2806's `D3` is bare-only; the tau-twelve simplex has `M=empty`. Clock shadows do not repair support or pay THM-2772's gate.
## NC2 / GMC

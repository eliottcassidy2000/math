...
67. **JC closures do not compose.** THM-3688 reaches `J_0,J_1,J_2` only and is pending audit; THM-3770 controls fixed-target poles, THM-3771/3772 close radial profiles, THM-3774 gives nonradial covers, and THM-3775--3777 type sheet/short-word gates. Residue packets do not survive arbitrary two-target maps; only degree-two `C` rows inherit THM-3773's all-map gate. Arbitrary quartics, interacting Cohn factors, synchronized nonbirational spectra, and `JC(2)` remain open; THM-3737 is pending.

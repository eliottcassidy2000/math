...
27c. **Current LRC reductions are not closures.** THM-2138 empties `6+1/5+2`, and THM-2139/2141 close only `(1,5,2)/(2,5,1)`; four fivefold profiles remain.
    THM-2140/2148/2168 give depth, polar, Fano, and valuation invoices; generated-lattice descent leaves scalar `5+3`. THM-2192 forces a unique deepest blocker; THM-2198/2204/2205/2207 close depth three, THM-2213/2215 close two depth-four profiles, and THM-2222/2224 force `lambda_1<=5`, removing all `455` profiles with `lambda_1>=6`. THM-2216/2218 retain labelled meet-tail Gram/Fourier data for the low-first-depth residue.
    ...
    THM-2187/2193 force rank seven; THM-2196/2199 force rank twelve and a finite box but do not enumerate it. THM-2203 closes scalar transport only in actual dyadic rank eight. THM-2198/2204/2205/2207 close all depth-three profiles, THM-2213/2215 close two depth-four profiles, and THM-2224 removes every `lambda_1>=6` row; `679` profiles at depths `4..19`, owner/current, and low-first-depth closure remain. None proves LRC(14).

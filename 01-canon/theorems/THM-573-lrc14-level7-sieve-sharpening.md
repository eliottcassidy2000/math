...
related:
  ...
  - HYP-3092    # O2/O3 shuttle + the dilation/aliasing correction
results:
...
- **Does NOT** close LRC(14). The residual (`<= 6` multiples of 7, equivalently a bounded core with
  ...
  `|H| = 1`. See [[HYP-3092]] for the dilation/aliasing correction to the "covering has a margin" idea.
...
→ THM-571, THM-570, THM-568, THM-523, LRC<=13, HYP-3084, HYP-3092, [[lrc14-thread]].

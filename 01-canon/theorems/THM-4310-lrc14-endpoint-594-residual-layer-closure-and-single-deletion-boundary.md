...
status: >
  PROVED RELATIVE TO THM-4306/4309 + FINITE-EXACT + DIRECT FULL-UNIVERSE
  RAW AUDIT AND OPTIMIZATION-LEVEL REPRODUCIBILITY PASS. The THM-4309
  3,925-mask carrier closes all 25 rows in the complete endpoint-594 layer of
  the THM-4309 residual. The 22 rows still residual after THM-4306 raise the
...
artifact_root: 05-knowledge/results/lrc14_endpoint594_complete_layer_closure_thm4310
artifact_manifest: 05-knowledge/results/lrc14_endpoint594_complete_layer_closure_thm4310/SHA256SUMS
artifact_manifest_sha256: 54d617eb2351f4a2f58b7d7c64b82700a681f779128c2bd50a3bc1fcd312c241
primary_scripts:
  - 04-computation/lrc14_endpoint594_complete_layer_closure_thm4310/endpoint594_carrier_audit.cpp
  - 04-computation/lrc14_endpoint594_complete_layer_closure_thm4310/endpoint594_all_singleton_quotient.cpp
  - 04-computation/lrc14_endpoint594_complete_layer_closure_thm4310/endpoint594_singleton_quotient.cpp
  - 04-computation/lrc14_endpoint594_complete_layer_closure_thm4310/typed_endpoint594_consumer.py
audit: >
...
# THM-4310 -- LRC(14) endpoint-594 residual-layer closure and exact single-deletion boundary
...
Retain THM-4309's complete endpoint-594 residual layer
...
Retain THM-4309's fixed-pool carrier

```text
C_595^(4309): size=3,925, rank8=3,858, rank9=67,
FNV=6fbd0bffcf0ed78b, all 421 joint masks retained.       (3)
```

This theorem tests `(3)` directly on every row of `(1)`. It does not identify
the THM-4306 rebuilt deck with `C_595^(4309)`.
...
Consequently `C_595^(4309)` closes the full 25-row layer `(1)`. Together with
THM-4309, the same carrier closes its inherited 391-row target and these 25
...
- The carrier replay covers all 25 rows in THM-4309's endpoint-594 residual
...
- The exact `3,911/14` split concerns deleting one mask from
  `C_595^(4309)` on the 25-row layer only. It says nothing about simultaneous
  deletions or preservation of THM-4309's older 391-row target.

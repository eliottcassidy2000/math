...
identifies the next cheap terminal tests from the fifth suffix singleton
coverage and either a two-edge matching cap or twice the pair-union cap, but
does not assert that they pass.  Seed branches still require nonscalar
cap/flag proofs.  Thus this theorem does not prove the seven-body rung or
LRC(14).

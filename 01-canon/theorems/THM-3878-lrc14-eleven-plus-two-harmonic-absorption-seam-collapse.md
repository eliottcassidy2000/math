...
status: >
  ...
  leaving 16 plus the scale-two `(1,9)` type; THM-3943 independently closes a
...
audit: >
  ...
  optimized and frozen streams byte-match.  THM-3910 and THM-3943 are the
...
related:
  ...
  - THM-3943-lrc14-signed-endpoint-cross-phase-and-fixed-scale-two-family
...
leaving 16 plus the scale-two type.  THM-3943 gives the exact signed-endpoint
...
THM-3943 closes no arbitrary-body type; the general conditional ledger after
...
THM-3910 later closes 41 scale-one types.  THM-3943 closes its fixed
...
explicit conditional implications above.  The safe-mass audit is a stopping
  ...
  THM-3943 are subsequent response theorems; only THM-3910 changes the general

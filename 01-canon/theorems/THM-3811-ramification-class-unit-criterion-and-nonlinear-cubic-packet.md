...
status: >
  ...
  subsequently REFUTED for this surface by THM-3841, independently also by
  THM-3845's etale degree packet.  No general Jacobian
...
audit: >
  ...
  subsequently closed by THM-3841/3845.
depends_on: []
related:
...
SUPERSEDED-OPEN-3811:
  THM-3841 proves that no dominant plane morphism exists at all; independently,
...
THM-3841/3845.  **QED for `(2)--(55)`; `(56),(57)` are SUPERSEDED.**

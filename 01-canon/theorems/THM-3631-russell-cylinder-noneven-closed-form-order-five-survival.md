...
audit: PENDING -- namespace reservation only; no mathematical claim yet
depends_on: []
related:
...
two-form matching the normalized common Jacobian through total source degree
five, while THM-3627 already obstructs every target two-form at degree six.
Until a pinned proof package and independent audit exist, this is not a theorem
or dependency.

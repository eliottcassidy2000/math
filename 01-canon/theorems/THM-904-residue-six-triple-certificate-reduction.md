...
status: PROVED exact pointwise reduction; FINITE-EXACT primitive triple scan through 60; standalone universal relation-lattice sharpening open and bypassed for propagation by THM-909
...
`THM-909` independently closes the required limiting sign at `32/343`, so the open

...
the Farey theta channel, together with a strengthened LRC hostile in which
right multiplication by `L^1274` preserves the current mod-2, mod-49, and
mod-91 address data while traversing the ternary part of `C_6`.

...
script: 04-computation/lrc14_unshifted_root_accessibility_thm2604.py
output: 05-knowledge/results/lrc14_unshifted_root_accessibility_thm2604.out
script_sha256: e8d52908fc1247fc2e2d80fae42aa376c5a7d778c3b17e52a6c7314b0eee848d
output_sha256: 0bed67c912d1294057ddc457e86aa56d5e3bde3861290e73722f7911b8220224
hash_basis: working-tree bytes (LF)
---

# THM-2604 -- every canonical selected head has a later target-active return
...
```bash
python3 04-computation/lrc14_unshifted_root_accessibility_thm2604.py
python3 -O 04-computation/lrc14_unshifted_root_accessibility_thm2604.py
```

Both executions byte-match

```text
05-knowledge/results/lrc14_unshifted_root_accessibility_thm2604.out.
```
...
arc containment (30)--(31).  An independent hostile audit rederived all
three extremal constants with a separate exact wall-cell engine: the no-big
image minimum `171/245`, forced-ordinary floor `43/77`, and forced-guard
floor `1791/2695`.  It also checked strict-null handling, the image cap,
role typing, cross-mixing scope, both execution modes, stored output, and
hashes; no mathematical or computational defect remained.

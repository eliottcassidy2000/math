...
script: 04-computation/ak_strict_c4_score_seven_four_thm3892.py
output: 05-knowledge/results/ak_strict_c4_score_seven_four_thm3892.out
...
independent_audit_script: 04-computation/ak_strict_c4_score_seven_four_independent_audit_thm3892.py
independent_audit_output: 05-knowledge/results/ak_strict_c4_score_seven_four_independent_audit_thm3892.out
...
# THM-3892 -- the strict two-by-two cyclic optimum is `7/4`
...
```bash
python3 -B 04-computation/ak_strict_c4_score_seven_four_thm3892.py
python3 -B -O 04-computation/ak_strict_c4_score_seven_four_thm3892.py
python3 -B 04-computation/ak_strict_c4_score_seven_four_independent_audit_thm3892.py
python3 -B -O 04-computation/ak_strict_c4_score_seven_four_independent_audit_thm3892.py
```

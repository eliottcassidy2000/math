...
**Status:** PROVED (exhaustive computation n=4,5,6,7)
**Proved by:** kind-pasteur-2026-03-08-S40

## Statement

For any tournament T on n vertices, the H-maximizers (maximum number of Hamiltonian paths)
always have nontrivial GLMY path homology. The topological dimension increases with n:

| n | max H | #max | Betti vectors | Top dim | Phase |
|---|---|---|---|---|---|
| 3 | 1 | 2 | [1] | 0 | trivial |
| 4 | 5 | 24 | [1,1,0,0] ×24 | 1 | ALL C-phase |
| 5 | 15 | 64 | [1,1,0,0,0] ×64 | 1 | ALL C-phase |
| 6 | 45 | 480 | [1,1,0,0,0,0] ×240 + [1,0,0,1,0,0] ×240 | 1 and 3 | SPLIT C/S |
| 7 | 189 | 240 | [1,0,0,0,6,0,0] ×240 | 4 | beyond S-phase |

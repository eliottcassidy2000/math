...
external: Zarankiewicz's conjecture (proved min(m,n) ≤ 6, Kleitman 1970; open at 7×7); Guy's conjecture; AAFRS 2012
...
machinery as THM-913. For m ≤ 6 this is optimal unconditionally (Kleitman); at the open
7×7 the construction meets the conjectured value. The even-n complete case also closes

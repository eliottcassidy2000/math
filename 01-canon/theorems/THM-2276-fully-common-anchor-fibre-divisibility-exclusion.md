...
status: >
  ...
  interior first-depth-one packet in which the guard and all five unit
  coefficients are bounded multiples of the shallow normalized owner.
  The candidate combines exact common-anchor root-fibre counts with the
  THM-2137 boundary-complexity inequality. No statement in this file is a
  proved dependency.
...
Nothing may depend on this file until its status is promoted explicitly.

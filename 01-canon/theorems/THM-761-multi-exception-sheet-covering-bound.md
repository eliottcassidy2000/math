...
related: [THM-531, THM-668, THM-724, THM-755, THM-757, THM-758, HYP-6780, HYP-6785, HYP-6820, HYP-6825, HYP-6830]
...
(the scale-uniformization route of HYP-6830: the discrete 7-clock, one level down;
...
4. Families with **no scale structure at all** (no `c >= 2` divides `>= 7` elements):
   outside this theorem's hypotheses. They need not have low `r_P`: THM-792 and

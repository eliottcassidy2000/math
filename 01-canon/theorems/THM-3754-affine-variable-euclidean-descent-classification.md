...
of `Q`.  THM-2071 and THM-2118 close the general source-foliation degrees two
and three.  The first honest general degree boundary is therefore four.
THM-3755, THM-3758, THM-3759, and THM-3765 close structured nonlinear or
radial slices across that boundary, but arbitrary quartic components remain
open; multi-charge substitutions such as `Q=X+F(X^mT)` are controlled probes,
not a general closure.

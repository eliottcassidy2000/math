...
status: >
  PROVED + VERIFIED-EXACT.  The curved collision component C=0 of the fixed
...
script_sha256: d6e6fc9384fe31de8e0d2037e7ed70a9fd8359faf82bb7cc68283fa1208ecb6e
...
**PROVED + VERIFIED-EXACT.**  The two nonfixed points in THM-1300's triple
...
The field has characteristic zero unless the stronger algebraically closed
hypothesis is explicitly stated.
...
Thus the collision is exactly the nontrivial Kummer deck orbit.  Moreover,
the image of `S` in the target plane is precisely the complement of the
parabola

```text
D: beta^2-16alpha=0.                                   (17)
```

Over `(17)` the two square-root sheets would have to meet.
...
artifact of the chosen closure.  Assume now that `k` is algebraically closed.
There is no dominant etale morphism
...
This identifier is reserved for an audited normal-form theorem for the
restriction of the fixed THM-1300 three-dimensional Keller map to its
distinguished collision surface.  No theorem, proof, or dependency is
asserted by this stub.

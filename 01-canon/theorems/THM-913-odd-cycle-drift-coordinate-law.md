...
status: PROVED at the census level for n = 4..7 (machine-exact, exhaustive over all tournaments via the tiling fibration; scripts cited below). The all-n sufficiency — E[ΔH|T] = f_n(H, c₅, c₇, …, c_{odd ≤ n}) for every n — is HYP-7090 (open)
...
related:
  ...
  - HYP-7090 (the all-n sufficiency conjecture)
  - OCF / Rédei (H odd; the census as the fundamental parity object)
---

# THM-913 — the odd-cycle drift coordinate law
...
into c₇. Conjecture (HYP-7090): at every n the census (H, c₅, …, c_{odd≤n}) remains a sufficient
...
- [ ] HYP-7090: all-n sufficiency; n=8 census (2^21 tilings — needs the bit-packed engine)

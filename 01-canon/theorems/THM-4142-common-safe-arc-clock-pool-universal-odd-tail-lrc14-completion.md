...
This file reserves the identifier and slug only. The exact pool-maximality
scan, inherited infinite cross-comb argument, residual-clock margins, direct
full-row hostiles, source/output hashes, and an independent derivation must
all pass before promotion.

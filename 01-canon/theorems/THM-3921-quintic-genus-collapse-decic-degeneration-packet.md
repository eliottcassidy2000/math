...
They generate the unit ideal, but all four vanish at `(A,C)=(0,0)`. Hence
`I(U,V)` can never be a unit for polynomial `U,V`; no element generates
`B`. This proves global nonmonogenicity.

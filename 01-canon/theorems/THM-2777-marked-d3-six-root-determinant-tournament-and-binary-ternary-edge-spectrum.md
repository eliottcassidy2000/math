...
status: >
  ...
  AUDIT.  Marking one even-sign body diagonal h in D3 identifies its
...
script_sha256: e096d82896cdd0680e25db9ae2bb6706a430693b0db660b286b04af41e7b2d21
output_sha256: 4529d8c64d95f6c29e219f8711fd9a3471cd74848a1fa81776932c85e5ca547c
...
The `a_ij` are exactly the six-root lines orthogonal to `h`, one orientation
from each of the three lines; they form the positive roots of `A2`.  The
...
statistics classify the displayed oriented object; they are not invariants
of an un-oriented root-line set.
...
representative of one root line reverses every incident arc.  The six
unoriented lines therefore determine a `32`-element labelled vertex-
switching class, not one tournament.  The weight function `(12)` survives
all of these sign switches, but the individual scores and directed cycles
do not.
...
```text
PROVED HERE (candidate):  marked-state W(D3)/W(A2) decomposition;

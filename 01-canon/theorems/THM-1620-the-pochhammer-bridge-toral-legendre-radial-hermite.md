...
status: >
  ...
  (I) From THM-1615; re-verified here on four (w,b).
  ...
  hard.
  (III) PROVED (both recurrences are classical; the descent is the argument of THM-1615).
...
depends_on:
  - THM-1615    # the radial layer is Hermite; the no-common-root descent

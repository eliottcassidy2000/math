...
renumbered: was THM-701 (klein wire priority, voluntarily ceded to kps's wide-spread recursion, S251), briefly THM-705 (collided with mac-mini cont.31's linear-moment-requirement which landed first on the wire) — now THM-706, checked free against canon at rename time.
...
# THM-706 — the quantitative supply

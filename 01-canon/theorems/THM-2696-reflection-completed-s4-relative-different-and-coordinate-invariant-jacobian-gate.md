...
status: >
  ...
  AUDIT.  For the even-sign-change semidirect product
  V4 semidirect S3=S4, the quotient map from the S3 source quotient to the S4
  target quotient has intrinsic Kahler different
...
script_sha256: 034a3308929985c1bdf86ae37d736cb7f9d209200fb5e029045bea9c03d2ff45
output_sha256: ee84c14ec4cd19c872dfdbf4d488fa320a30ddebe02a7ca7db3bfb51d30ed715
...
There is an intrinsic explanation.  The reflection arrangement of `H`
has anti-invariant
...
`L!=0`.  The same elimination shows that `(R_c)` is the contraction kernel.

...
renumber_note: claimed locally as THM-780, then THM-784, then THM-793;
  then THM-795; renumbered to THM-799 after the shared THM-792--797 claims landed.
depends_on:
  - THM-755   # capped-envelope criterion
  - THM-780   # strict-margin phase floor for the uniform corollaries
related: [THM-752, THM-761, THM-766, THM-798, THM-777, HYP-6815, HYP-6830]
...
# THM-799 - Good-set-state transverse-tooth cap lemma
...
Thus THM-799 supplies the elementary infinite tail in THM-798. THM-798's
...
THM-799 proves that positive safe mass persists under one high-frequency

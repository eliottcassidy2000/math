...
status: >
  ...
  project-internal effective compound-root theorem THM-2101, whose proof is
...
formalization_status: >
  ...
  proposition `DvdK1` is now the sole explicit premise; THM-2101 proves its
...
(`THM-2101-effective-compound-root-bound-for-one-variable-constant-terms.md`),
...
THM-2101 is Galois-free.  For bare existence one may instead cite THM-2067's
...
THM-2101 supplies a project-internal effective proof of the constant-term
...
4. `GMC2DvdKInterface` states the one-variable input as an explicit
   ...
   THM-2101 (with THM-2067 as an alternate route), while the Lean proof remains
...
paper proof: THM-2101 gives the required existence statement effectively and

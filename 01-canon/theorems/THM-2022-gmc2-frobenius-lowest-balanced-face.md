...
status: >
  ...
  project-internal effective compound-root theorem THM-2111, whose proof is
...
(`THM-2111-effective-compound-root-bound-for-one-variable-constant-terms.md`),
...
THM-2111 is Galois-free.  For bare existence one may instead cite THM-2067's
...
THM-2111 supplies a project-internal effective proof of the constant-term

...
status: >
  ...
  project-internal effective compound-root theorem THM-2098, whose proof is
...
formalization_status: >
  ...
  proposition `DvdK1` is now the sole explicit premise; THM-2098 proves its
...
(`THM-2098-effective-compound-root-bound-for-one-variable-constant-terms.md`),
...
THM-2098 is Galois-free.  For bare existence one may instead cite THM-2067's
...
THM-2098 supplies a project-internal effective proof of the constant-term
...
4. `GMC2DvdKInterface` states the one-variable input as an explicit
   ...
   THM-2098 (with THM-2067 as an alternate route), while the Lean proof remains
...
paper proof: THM-2098 gives the required existence statement effectively and

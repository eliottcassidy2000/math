...
**Related:** THM-447/448, THM-449(6) (op-asymmetry of D — the same chirality at tournament level).
...
doubling (THM-450(6)), H(D(T)) ≠ H(D(T^op)) in 50/74 classes (THM-449(6)), and the tower cores

...
source: kind-pasteur-2026-07-20-S128c129 (owner: work the named-next questions of THM-1750)
depends_on:
  - THM-1750    # the moment-nullcone template and its ladder
...
# THM-1765 — H leaves the spectral ladder at n = 6

THM-1750 placed the tournament trace moments `tr(A^m)` on the rational floor of the

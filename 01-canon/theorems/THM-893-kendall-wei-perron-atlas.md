...
related: [07-reflections/the-intersubjective-object-boxeph-S28.md (this is its tournament-side theorem), klein cont.8 (composition defect = 3c₃ — the defect is the same R∘R object's antisymmetric shadow), kps coordinate atlas (C3 = score variance — λ refines it), THM-853(III) locker tournament (next: its λ)]

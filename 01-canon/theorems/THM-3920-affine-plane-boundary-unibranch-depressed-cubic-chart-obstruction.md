...
audit: >
  ...
  LF-normalized normal and optimized stdout streams byte-match the frozen LF
  output; raw script/output hashes and documentation checks pass. No repair
  was required.
depends_on:
...
| THM-3921 | audited `6`-address degeneration packet | excluded (`6>3`) |

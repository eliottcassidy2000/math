...
depends_on: [THM-1920 (char_S subleading coeff = C(n,2) = triangular; the coefficient degrees), THM-1930 (var-max=2C(n,3)), THM-1970/1975 (H at the formula/#P harmonic edge), THM-1370 (H-spectrum = odds minus {7,21}), kps THM-1980 (2-adic edge: Redei parity is the last formula)]

...
status: >
  ...
  THM-4134/4138 empty the Delta_V wall at degrees 20/19/16/15. JC(2), the
  other two walls, other cells, and maximum residual weight at least nine
  remain OPEN.
...
contradicting the inherited boundary packet. THM-4134/4138 later normalize
and empty `Delta_V=0`, excluding degrees `20,19,16,15`; the other two
collision walls remain open.

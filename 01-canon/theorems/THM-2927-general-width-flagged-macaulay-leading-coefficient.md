...
Reserved for the exact Borel-semi-invariant factorization and strict
total-positivity proof of the leading coefficient of the fixed
`20Q+10C+6F` Macaulay minor at every width.  No statement here is a
proved dependency.

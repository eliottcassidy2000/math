...
THM-3200 now excludes the same resonances `d=p+1` more economically because
they are even.  The present theorem remains a stronger structural sidecar:
it identifies the adjacent-prime Newton polygons, isolates the left-factorial
residue, and proves that even a hypothetical Kurepa failure cannot destroy
slope separation.

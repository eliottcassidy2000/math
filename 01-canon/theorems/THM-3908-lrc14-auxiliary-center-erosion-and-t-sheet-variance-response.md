...
status: >
  ...
  not a theorem, has no proved dependencies, and must not enter the proof
  graph until the auxiliary-center and lift-count proof candidate passes its

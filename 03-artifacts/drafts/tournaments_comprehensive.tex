...
(see also~\cite{Moon1968} for background and~\cite{Forcade1973, ElSahili2020, SchweserStiebitzToft2025} for refinements).
...
See also~\cite{TangYau2026} for related path homology computations of circulant digraphs.

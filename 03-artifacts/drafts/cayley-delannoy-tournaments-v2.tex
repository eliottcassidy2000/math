...
By Cauchy's integral formula under the substitution $u = Q(x)$, $x = (u-1)/(u+1)$: $2g_k(m) = \frac{1}{k!}[d^k/du^k\,u^m(u+1)^{k-1}]_{u=1}$. The Delannoy identity follows by the Leibniz rule.
\end{proof}

...
to infinity (\textsc{thm}-776; \textsc{hyp}-6830). The same theorem proves every member
...
endpoint ownership. More generally, \textsc{thm}-777 proves that base good-set mass

...
to infinity (\textsc{thm}-775; \textsc{hyp}-6830). The same theorem proves every member
...
endpoint ownership. More generally, \textsc{thm}-776 proves that base good-set mass
...
terminal at an explicit rational threshold. On the executed exact checks the
...
then execute the resulting terminal leaves. This is the corrected splice of

...
to infinity (\textsc{thm}-771; \textsc{hyp}-6830). The same theorem proves every member
...
endpoint ownership. More generally, \textsc{thm}-772 proves that a fixed safe interval
survives a new frequency $N$ with asymptotic duty cycle $6/7$, while the component
count grows at most linearly; any sufficiently fast proportional peel is therefore
eventually terminal at an explicit rational threshold. On the executed exact checks the

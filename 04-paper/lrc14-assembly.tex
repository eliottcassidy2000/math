...
remaining domain has not yet been reduced to a globally bounded one: a peel-relative splice, together with the
$r\ge7$ deck residue, is the honest open remainder. We state precisely what is proved,
...
to infinity (\textsc{thm}-771; \textsc{hyp}-6830). This does not refute a bounded
peel-relative domain; it shows that any proof must retain normalized cap load and
endpoint ownership. On the executed exact checks the

...
to infinity (\textsc{thm}-772; \textsc{hyp}-6830). The same theorem proves every member
...
endpoint ownership. More generally, \textsc{thm}-773 proves that base good-set mass

#!/usr/bin/env python3
"""r5_finite_horn_fixed_kps_S128c63.py -- kind-pasteur S128 cont.63.
...
print("  CORRECTION: the bound must exceed max T over those quadruples, not max k4 --")
print("  the fifth killer is certified by the measure horn only once it exceeds T.")
print("  max T over the R>=1 region: %.1f"%maxT)
KB=int(maxT)+25
print("  => finite horn bound KB = %d (max T + 25 margin)"%KB)
print()

#!/usr/bin/env python3
"""Exact THM-2941 scalar band for projected k=2, 1780 <= z1 <= 1789."""
...
EXPECTED_PROFILE_SHA256 = "7a25a91757729e370b12a3b891985f4cb79042420e945c4eae90043d0d2bedcd"
EXPECTED_SURVIVOR_SHA256 = "febd131e21f049211862cb734869f7d607616c25ff351c1c5f9be5d3ecdb8c9b"
EXPECTED_SEMANTIC_SHA256 = "514e537f4150b6aa5bfc61b7d98f3b9e1a7a066692fe7da49bb5ad5ca04edddd"
...
SPEC = spec_from_file_location("k2_band_1800_base_for_1780", BASE)
...
def render(profiles) -> str:
    ...
    lines = [
        "LRC14 projected k=2 scalar band 1780..1789",

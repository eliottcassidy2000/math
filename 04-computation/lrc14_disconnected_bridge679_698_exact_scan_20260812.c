/* Exact bulk scan for disconnected high edges with gcd<=3 and 679<=p<=698.
...
static const char EXPECTED_TASK_SHA256[]="9b2087d4a05e1ed453b05594d3c4d6ec748ff9c4f5cab95ea615d8238e002fa3";
...
static void make_tasks(void){
 ...
 for(int p=679;p<=698;p++)for(int q=p+1;q<8*p;q++)
  if(gcd64(p,q)<=3)tasks[ntasks++]=(Task){p,q};
 if(ntasks!=79898){fprintf(stderr,"task count %d\n",ntasks);exit(3);}
...
int main(int argc,char **argv){
 ...
 printf("universe 679<=p<=698;p<q<8p;gcd(p,q)<=3;all 2530 L<4592 contexts\n");

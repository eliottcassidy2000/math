...
dzero(
    sp.discriminant(Q, h)
    - c**2 * (R - S) * (R + S) * (R + d * S) * (3 * R + d * S) ** 3 / 3,
    "common debt is a square factor in the residual discriminant",
)
...
summary = {
    "checks": CHECKS,
    "forest": "boundary primes are rational; two boundary primes cannot have two distinct smooth incidences",
    "universal": "positive-genus residual excludes all c; clean gcd gives three colors and at least two finite incidences",
    ...
    "scope": "clean two-incidence requires gcd; normalization-parameter descent, other fields and factor distributions remain open",
}
...
print("BOUNDARY_PRIMES=RATIONAL;GENUS=RESIDUAL_BOUNDARY_NONENTRY_WITHOUT_C_GCD")
...
print("SCOPE=CLEAN_TWO_INCIDENCE_REQUIRES_GCD;NORMALIZATION_PARAMETER_DESCENT_OTHER_FIELDS_AND_FACTOR_DISTRIBUTIONS_OPEN;JC2_OPEN")

#!/usr/bin/env python3
"""Independent exact referee for the fixed projected z1=1940 state.
...
OUTPUT_PATH = (
    ...
    / "05-knowledge"
    / "results"
    / "lrc14_j7_k2_z1940_ray_status_independent_thm2941.out"
)
EXPECTED_UNIFORM_SHA256 = (
    "dfa4788297b8c31fc9b5dce1afadf29d20b267cb4159fa95dadb9346b1980b36"
)
EXPECTED_SEMANTIC_SHA256 = (
    "fa174fed4ecbab653d1e600e784159eb6d91d086e5f3f417abc80b6a14f2d6bd"
)
BODY = (1, 4, 8, 10, 12, 14)
FIRST = 1940
LABELS = (1940, 2060, 2142, 2172, 2534)
DS = (280, 588, 588, 840, 980)
D = 5880
Q = 840
M = 7
...
def main():
    ...
    lines = [
        "LRC14 projected k=2 z1=1940 independent fixed-state referee",
        f"uniform_ray_status_source_sha256={file_sha256(UNIFORM)}",
        "primary_z1940_source_imported=False;tree_engine=Pruefer;LP_used=False",
        (
        ...
        "conclusion=fixed projected z1=1940 scalar state is impossible",

#!/usr/bin/env python3
"""Global one-pass projected k=2 scalar atlas on 1940 <= z1 <= 1991.
...
E=(1,4,8,10,12,14) at z1=1940.  Its chosen suffix is exact
...
EXPECTED_PROFILE_SHA256 = (
    "f0844210d8a887e200140f44cd41810779318ba81c4907a9d0839d11214c517c"
)
EXPECTED_SEMANTIC_SHA256 = (
    "ace434534aa6a5e276c6660a5b4a69076bcb8ae7c4704985cce4dec29d7e66e3"
)
...
def render(profiles):
    ...
    lines = [
        "LRC14 global projected k=2 scalar band 1940..1991",
    ...
    lines.extend(
        (
            "interval_1941_1991_global_survivors=()",
            "interval_1940_1991_global_survivors=(1940,)",

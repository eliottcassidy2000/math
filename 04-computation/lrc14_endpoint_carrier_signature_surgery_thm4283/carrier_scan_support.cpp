// Mechanically inherited THM-4282 carrier-via-joint-exposure implementation.
// Only the entry-point name is changed so THM-4283 can reuse the exact typed
// helpers in a wrapper translation unit without changing THM-4282's source.
//
...
int thm4282_frozen_main(int argc, char** argv) {
    try {

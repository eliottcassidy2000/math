#!/usr/bin/env python3
"""Exact companion for THM-2448.

The proof in THM-2448 is uniform.  This dependency-free companion supplies
...
def main():
    ...
    print("THM-2448 finite-hole relative-atom exact audit")

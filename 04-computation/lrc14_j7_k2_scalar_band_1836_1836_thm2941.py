#!/usr/bin/env python3
"""Global one-pass projected k=2 scalar atlas at z1=1836.
...
Exactly five scalar necessary rows survive globally.  Three chosen suffixes
are exact; two contain explicit rigorous analytic tail placeholders.  These
rows are an upper-envelope superset pending all-label transport closure.
"""
...
EXPECTED_PROFILE_SHA256 = (
    "7a0e3b4937cee35d5f9f686523908ef555c15b3cfda859051fe8dfc89b1fac5f"
)
EXPECTED_SEMANTIC_SHA256 = (
    "5afe9b0c592bed475acb997017436687088ff3d1c2acb6777290a01986906975"
)
START = 1836
END = 1836
HORIZON = 7000
...
EXPECTED_SURVIVORS = (
    (
        ...
        (
            ...
            (F(2617, 3436860), 2004, "EXACT"),
            (F(1573, 2119740), 2060, "EXACT"),
            (F(1333, 1862490), 2172, "EXACT"),
        ),
        F(650892934, 163387121499),
        F(1049, 267540),
        F(2669392721, 42480651589740),
        F(1049, 2940),
        34,
        11760,
        1020,
    ...
    (
        ...
        F(130014131, 29350979910),
        F(1049, 267540),
        F(77644367, 152625095532),
        F(1049, 2940),
        34,
        11760,
        1020,
    ...
    (
        ...
        F(6269, 8186724),
        (
            (F(204, 343049), None, "HIGH-TAIL"),
            (F(239, 267540), 2340, "EXACT"),
            (F(3425, 4467918), 2004, "EXACT"),
            (F(1873, 2693236), 2114, "EXACT"),
        ),
        F(26852330264839, 7226593891875540),
        F(853, 231868),
        F(867788799028, 23486430148595505),
        F(853, 2548),
        34,
        76440,
        6625,
    ...
    (
        ...
        F(1081, 1364454),
        (
            (F(114, 324625), None, "HIGH-TAIL"),
            (F(149, 160524), 2340, "EXACT"),
            (F(1877, 2233959), 2004, "EXACT"),
            (F(228, 343049), None, "TAIL-0"),
        ),
        F(25199172109807, 7045796105029500),
        F(811, 231868),
        F(1804510506529, 22898837341345875),
        F(811, 2548),
        38,
        152880,
        13250,
    ...
    (
        ...
        F(563, 524790),
        (
            (F(1633, 1862490), 2172, "EXACT"),
            (F(229, 262395), 2142, "EXACT"),
            (F(799, 931245), 2534, "EXACT"),
            (F(893, 1059870), 2060, "EXACT"),
        ),
        F(44250229, 9783659970),
        F(281, 66885),
        F(40907311, 127187579610),
        F(281, 735),
        36,
        11760,
        1020,
...
def render(profiles):
    ...
    require(
        all(
            all(
                ...
                or (label is None and kind in ("HIGH-TAIL", "TAIL-0"))
                for _value, label, kind in row[3]
            )
            for row in survivors
        ),
        "a surviving suffix has a malformed exact/tail certificate",
    )
    ...
    lines = [
        "LRC14 global projected k=2 scalar band 1836..1836",

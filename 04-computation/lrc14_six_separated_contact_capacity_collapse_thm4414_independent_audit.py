#!/usr/bin/env python3
"""Independent exact raw-carrier audit for the THM-4414 reduction.
...
envelope of each of the three component contact networks.  THM-4409 gives

    network max-flow <= sum_edges min(endpoint capacities),

so an envelope at most 6/77 is an exact certificate for the actual network.
The converse is neither used nor asserted.
...
def main():
    ...
    parser.add_argument("--height", type=int, default=149)
    ...
    print("LRC14 SIX-SEPARATED CAPACITY COLLAPSE -- THM-4414 INDEPENDENT AUDIT")
    print("status=PASS INDEPENDENT_FINITE_EXACT; universal_6/77=OPEN; LRC14=OPEN")

...
def hroad_twist(scale=7):
    ...
    print("   OBSERVATION: 'slow' bands s=0,1 (smallest rotation step) are where")
    print("   consec LOSES (HYP-2703 R1) -- the +s rotation explores Z/7 SLOWEST")
    print("   there, so coverage is hardest and the spread adversary can exploit it.")
    print("   The twist is exactly the road-coloring state relabel; coverage SPEED")
    print("   (reset length) is the q-invariant explaining the per-band failure.")
...
def main():
    ...
    print()
    print("=" * 74)
    print("VERDICT printed in final structured assessment.")
    print("=" * 74)

#!/usr/bin/env python3
"""OPUS VARIANT (collatz-exponent-atlas-20260926): the THM-4468 finite certificate re-run with c = 158/100 (only the constant changed).
...
C = Fraction(158, 100)   # overwritten from the command line (--cnum/--cden) in main()

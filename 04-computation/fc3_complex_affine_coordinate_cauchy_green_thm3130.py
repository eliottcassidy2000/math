...
print("THM-3130 FC(3) COMPLEX AFFINE-COORDINATE CAUCHY-GREEN AUDIT")
...
# source all collapse together; THM-3129's one-dimensional spline takes over.
...
print("ALL THM-3130 CONTROLS PASSED")

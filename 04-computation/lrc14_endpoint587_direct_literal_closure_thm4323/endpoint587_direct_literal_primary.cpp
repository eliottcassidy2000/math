// Finite-exact direct literal audit for every endpoint-587 body missed by
...
int main(int argc, char** argv) {
    try {
        require(argc == 3, "usage: endpoint587_direct FAILURES DETAIL_CSV");
        ...
        Fnv summary_ledger;
        std::cout << "LRC14_ENDPOINT587_DIRECT_LITERAL_PRIMARY_V1\n"
        ...
        std::cerr << "ENDPOINT587_DIRECT_LITERAL_PRIMARY_ERROR "
                  << error.what() << '\n';
        return 1;
    }
}

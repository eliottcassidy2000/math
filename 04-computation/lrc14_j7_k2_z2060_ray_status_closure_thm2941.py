#!/usr/bin/env python3
"""Close the projected k=2 z1=2060 row for all later labels.

Body E=(1,4,8,10,12,14), first drift 2060, and four later drifts.  The
periodic/antipodal ray law gives exact all-label maxima in every denominator
multiset.  The exact quotient leaves sixteen denominator states.  All
survive the crude all-q capacity screen, but the all-arity common-table
transport of THM-2928, with five-needle Hunter caps, rejects every state by
an exactly checked rational Farkas certificate.  No finite label horizon
occurs.  The inherited projected suffix is one of the sixteen states.
"""
...
BAND_OUTPUT = (
    ...
    / "lrc14_j7_k2_scalar_band_2004_2142_thm2941.out"
)
OUTPUT_PATH = (
    ROOT
    / "05-knowledge"
...
EXPECTED_FRONTIER_ROW = (
    ...
    "suffix=2172:263/310415,2142:821/1049580,"
    "2534:2911/3724980,3180:279/363580;"
    "lower=1049/267540;upper=1052387671/259266989205;"
    "gap=1862920471/13481883438660"
)
BODY = (1, 4, 8, 10, 12, 14)
FIRST = 2060
K = 2
...
EXPECTED_FIXED_SCALAR = (
    (196, 280, 588, 840, 980),
    F(1052387671, 259266989205),
    (2060, 2142, 2172, 2534, 3180),
)
EXPECTED_SCALAR_COUNT = 16
...
def main():
    ...
    require(
        (
            ...
            control_capacities5[5],
            control_capacities5[21],
    ...
    lines = [
        ...
        "conclusion=projected k=2 z1=2060 row is empty uniformly",

#!/usr/bin/env python3
"""Close the projected k=2 z1=1940 row for all later labels.

Body E=(1,4,8,10,12,14), first drift 1940, and four later drifts.  The
...
the crude all-q screen, but the all-arity common-table transport of THM-2928,
with five-needle Hunter caps, rejects it by an exactly checked rational
Farkas certificate.  No finite label horizon occurs.
"""
...
PRIOR_ENGINE = (
    ROOT
    / "04-computation"
    / "lrc14_j7_k2_z1992_ray_status_closure_thm2941.py"
)
BAND_OUTPUT = (
    ROOT
    / "05-knowledge" / "results"
    / "lrc14_j7_k2_scalar_band_1940_1991_thm2941.out"
)
OUTPUT_PATH = (
    ROOT
    / "05-knowledge"
    / "results"
    / "lrc14_j7_k2_z1940_ray_status_closure_thm2941.out"
)
EXPECTED_UNIFORM_SHA256 = (
    "34ab29162ed33d90093e6d2bf781def36c420a1cd6596158b5d6579a3a8f3f46"
)
EXPECTED_PRIOR_ENGINE_SHA256 = (
    "8abe33a474c71bb90b5320c55c71aeeae7ba280963d42b4b334f95a6a0d53047"
)
EXPECTED_BAND_OUTPUT_SHA256 = (
    "30233f73ad830c4b6f8c43245ba96539e434b55d6fc341782ad0c0f0030e100a"
)
EXPECTED_SEMANTIC_SHA256 = (
    "a1823246b03c3731046322a031a9729547c704211eb5dfe5c7540372794d7e5b"
)
EXPECTED_FRONTIER_ROW = (
    "z1=1940;delta1=1273/1996260;"
    "suffix=2060:1867/2119740,2172:263/310415,"
    "2142:821/1049580,2534:2911/3724980;"
    "lower=1049/267540;upper=1864535549/474507508545;"
    "gap=209808419/24674390444340"
)
BODY = (1, 4, 8, 10, 12, 14)
FIRST = 1940
K = 2
...
EXPECTED_FIXED_SCALAR = (
    (280, 588, 588, 840, 980),
    F(1864535549, 474507508545),
    (1940, 2060, 2142, 2172, 2534),
)
EXPECTED_SCALAR_COUNT = 1
EXPECTED_SCALAR_SHA256 = (
    "4d7cb8424b56bd95aebed8c21bef54a825c60f2f48001c3dd42049d176956615"
)
EXPECTED_CRUDE_KILLS = ()
EXPECTED_STATUS_INSTANCE = (840, 7, (120, 0, 0, 120, 0), (3, 4, 5, 6, 7), ((0, 120), (3, 420), (4, 112), (5, 168), (6, 20)))
...
def main():
    require(
        ...
        "inherited projected k=2 z1=1940 row changed",
    )
    ...
    require(
        ...
        and len(crude_survivors) == EXPECTED_SCALAR_COUNT,
    ...
    require(
        ...
        "prior referee engine disagrees on the fixed z1940 state",
    )
    require(
        (
    ...
    lines = [
        "LRC14 projected k=2 z1=1940 all-label ray/status closure",
        ...
        (
            "scope=inherited projected k=2 z1=1940 body row;"
        ...
        "conclusion=projected k=2 z1=1940 row is empty uniformly",

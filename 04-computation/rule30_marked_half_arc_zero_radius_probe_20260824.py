...
print("haar_finite_line_terminal_mass=P(Z_k=infinity)=2^{-(2k-1)}")
print("haar_center_given_radius=P(c=1|Z=1)=3/4;P(c=1|Z=r)=1/4_for_r>=2")
print("haar_center_given_terminal=P(c=1|Z_k=infinity)=1/4")
print("haar_joint_law=P(c=1,Z=1)=3/8;P(c=1,Z=r)=3*2^{-(2r+1)}_for_r>=2")
print("haar_terminal_joint_law=P(c=1,Z_k=infinity)=2^{-(2k+1)}")

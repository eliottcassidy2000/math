/- LRCClusterGap.lean -- opus-2026-07-17-S338 (HYP-7210 / THM-955). DRAFT.
   THE CLUSTER GAP LEMMA: whenever the displayed safe-mass numerator is
   positive, k ≤ 6 positive speeds leave in [a, b] a nonempty closed
   subinterval safe for all of them (arcSafe (1/14) w 0), with the stated
   quantitative width.  Positivity is essential: a short window can lie
   entirely inside one danger tooth.

...
theorem q2_majorizes : ∀ N : Fin 8, gQ N ≤ q2 (N : ℚ) := by decide

/-- **THM-712 certificate**: q₃ majorizes g on the cells. -/
theorem q3_majorizes : ∀ N : Fin 8, gQ N ≤ q3 (N : ℚ) := by decide
...
theorem q2_contact : q2 0 = gQ 0 ∧ q2 3 = gQ 3 ∧ q2 4 = gQ 4 := by decide

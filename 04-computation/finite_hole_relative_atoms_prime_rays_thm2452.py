#!/usr/bin/env python3
"""Exact companion for THM-2452.

The proof in THM-2452 is uniform.  This dependency-free companion supplies
...
def main():
    ...
    print("THM-2452 finite-hole relative-atom exact audit")

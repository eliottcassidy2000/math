#!/usr/bin/env python3
"""Global one-pass projected k=2 scalar atlas on 2004 <= z1 <= 2142.
...
Only three scalar necessary rows survive globally: the hostile body
E=(1,4,8,10,12,14) at z1=2004,2060,2142.  Their chosen suffixes are exact
...
EXPECTED_PROFILE_SHA256 = (
    "56412ac97f1c46f33905f0dfad5e13f9836f8e81cba2fae8d41e89903a11c0b2"
)
EXPECTED_SEMANTIC_SHA256 = (
    "9b18e07b31bca513e4212439dbef68fb0a81774abcfc2802b4491dd4b40e1eed"
)
...
EXPECTED_SURVIVORS = (
    ...
    (
        ...
        (
            ...
            (F(2911, 3724980), 2534, "EXACT"),
            (F(279, 363580), 3180, "EXACT"),
            (F(9419, 12327420), 2396, "EXACT"),
        ),
        F(5944239779, 1507775985765),
        F(1049, 267540),
        F(336828043, 15680870251956),
        F(1049, 2940),
        34,
        11760,
        1020,
...
def render(profiles):
    ...
    lines = [
        "LRC14 global projected k=2 scalar band 2004..2142",
    ...
    lines.extend(
        (
            "interval_2061_2141_global_survivors=()",
            "interval_2005_2060_global_survivors=(2060,)",

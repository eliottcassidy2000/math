#!/usr/bin/env python3
"""Independent cumulative-integral verifier for THM-1259."""
...
def require(condition: bool, message: str) -> None:
    if not condition:
        raise RuntimeError(f"independent THM-1259 verification failed: {message}")
...
def main() -> None:
    ...
    print("THM-1259 CARRIER-43 INDEPENDENT CUMULATIVE REPLAY")
    print(
    ...
    print("RESULT=no six-comb cover at carrier 43")

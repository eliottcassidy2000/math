...
import TournamentH7.LRCZarankiewiczGuardrail  -- codex-S26: exact pair-incidence guardrail for THM-935 relation supports. Pair-unique support >=3/4/5 families have at most 26/13/7 members; >26 forces a shared parallel-class owner pair. This quotient counts multiplicity only and deliberately carries no B5 sign claim. Foundational axioms only

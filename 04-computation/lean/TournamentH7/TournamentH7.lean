...
import TournamentH7.LRCFinsetBridge  -- boxeph-S109, corrected codex-2026-07-18: LRC14_finset_of_INVcov transfers the Lonely-form reduction to LRC14.LRC14 (Finset ℕ, t∈[0,1]). The exact open premise is INVcov: Covering(2..14) ∧ no Lonely13 => 13-fold dominance. Standard axiom trio
import TournamentH7.LRCMSplit  -- boxeph-S108, corrected codex-2026-07-18: the covering M-split derives Covering(2..14) from no Lonely14 via counterexample_needs_all_divisors, derives no Lonely13 by band monotonicity, then applies INVcov + ap_core_bridge. LRC14_of_INVcov: LRC(≤13)[cited] + INVcov[open] => LRC(14), kernel-checked. The omitted-covering INV was false (MISTAKE-166). Standard axiom trio

...
import TournamentH7.LRCB5RelationEndgame  -- codex-S29: proof-producing THM-935 certificate interface. Exact model equality plus the quarter/three-quarter tail split yields integer B5>0 on the chain-dense core, then composes with the q=2,3/two-adic exceptional dispatch to LRC14. Foundational axioms only

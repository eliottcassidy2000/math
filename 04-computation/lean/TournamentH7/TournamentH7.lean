...
import TournamentH7.LRCReflectedChromatic  -- reflected signed-pair candidate: K6 six-into-five repeat, exact chi=4 exceptional P4/matching cores, and formal D4 four-colour guardrails. No sorry/native_decide

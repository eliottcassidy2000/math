...
import TournamentH7.LRCMomentFloorDischarge  -- mac-mini-S65cont14: witnessG2-concretization plumbing leg 1 -- hsize DISCHARGED against the concrete shapeOf (clusterSize_shapeOf_le, pure list arithmetic); lrc14_from_momentfloor_nodes-prime = LRC(14) from FIVE parameters {hbonf, hMoment, hB, hsmall, hpartA}; remaining three legs mapped to their target proof terms

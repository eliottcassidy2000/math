...
import TournamentH7.LRCRoute2Assembly  -- opus-2026-07-06-S129: (A)<=(C) wired end-to-end -- torus_loose_of_rank2 composes GREEN projection floor + GREEN rigidity wrapper; rank-2 torus is loose given the C-bridge; + JKReduction obligation + lrc14_via_route2 top-level conditional (HYP-4617)
import TournamentH7.LRCCoveringDisjunction  -- opus-2026-07-06-S129: branch-2 endpoint -- loose_of_covering_set packages mac-mini's per-q reach_ge_of_covering atom into the OR-over-q disjunction the residue check emits (with mu/q>=2/25 folded in); reduces branch 2 to a purely arithmetic witness-existence (HYP-4617)

...
import TournamentH7.LRCB5PairGridBridge  -- codex-S54: exact full-grid/nonzero-grid normalization and all-pair aggregation. Half-open interval ledgers with at most |vi|+|vj| components imply the target (24 sum|vi|+78)/(q-1) discrepancy. Ledger construction remains explicit. Foundational axioms only

...
import TournamentH7.LRCB5NormalizedBridge  -- codex-S46: THM-940 aggregate deviations Möbius-invert exactly to the THM-935 model. Singleton deviations help; the exact residual is M2 >= -13/30 and a harmful depth moment average < -65218/84035. Depths <=6 give credit and depths >=7 give debt. Foundational axioms only
import TournamentH7.LRCB5RelationEndgame  -- codex-S29/S31/S45/S46: proof-producing dense-core consumer. The concrete certificate now chooses only a clean-modulus height and proves the pair lower tail plus harmful depth budget; modulus, coprimality, singleton sign, and THM-940 identification are automatic. Foundational axioms only

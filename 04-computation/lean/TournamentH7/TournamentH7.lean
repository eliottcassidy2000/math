...
import TournamentH7.LRCCenteredBlockerAddressCompression  -- codex-S82 / THM-1248: lower-gap cocycle/gauge, determinant-gcd remainder, finite/binary relative digits, oriented-germ and lasso-tail reconstruction, affine transport, positive holonomy, and wall arithmetic. Arbitrary-cycle and wall-seam topology remain paper providers. No sorry/native_decide
...
import TournamentH7.LRCBinaryPhaseWordLanding  -- codex-S82 / THM-1256: every coherent blocker aligns with one minimal tooth word; sharp target-free corridor, nonadjacent cycle-minimum marks, nested/two-cycle tariffs, six-word exclusion, and ABAB run break. No sorry/native_decide
...
import TournamentH7.LRCMod23NearBijection  -- codex / THM-1263: a global margin below 2/23 and no zero residue force the twelve speeds onto all eleven nonzero antipodal pairs mod 23, with one double fibre. No sorry/native_decide
import TournamentH7.LRCChronologicalReturnPolygon  -- codex / THM-1264: literal consecutive owner returns telescope to reciprocal perimeter minus integral address drift; closest six-fast returns force a 6/5 ascent and literal triangles force factor three. No sorry/native_decide
import TournamentH7.LRCCarrier45BVNeedle  -- codex / THM-1265: exact 23-row BV density certificate excludes six-comb coverage on every carrier-45 gap; reflection has the unique fixed phase k=22 and the first multiplier-108 row records variation cost. No sorry/native_decide
...
import TournamentH7.LRCCenteredTailReturnOrTerminal  -- codex-S82 / THM-1274: protrusion orientation fixes the slowest two-cycle descent digit; five-owner continuation gives a 3/2 closest-return leaf or a length-five terminal, while six private counts force the abstract d_i<=7c cap. Topology/count suppliers remain explicit. No sorry/native_decide
import TournamentH7.LRCTerminalEndpointTransferGcdTax  -- codex-S82 / THM-1277: the terminal endpoint exports a proper exterior carrier-owner seam; survivor subtraction yields exact centered-error/residue and gcd taxes, including the sharp-row exclusion. No sorry/native_decide

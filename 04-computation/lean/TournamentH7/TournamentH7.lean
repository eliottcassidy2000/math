...
import TournamentH7.LRCDenseCoreEndgame  -- codex-S25: composes THM-934 chain splitting inside the primitive/dissociated route; positive B5 is now required only on ChainDenseCore. No loneliness-to-B5 conversion; foundational axioms only

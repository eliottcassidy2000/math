...
import TournamentH7.GMC2ParityGuardrail  -- codex: exact Bool^3 parity fibers agree on every degree<=2 Walsh observable but have opposite cubic character; xor convolution closes with factor 4. Ordinary kernel reduction only

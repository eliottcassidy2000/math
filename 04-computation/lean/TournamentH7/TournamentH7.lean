...
import TournamentH7.LRCB5RelationEndgame  -- codex-S29/S31/S45/S46/S47: proof-producing dense-core consumer. Two concrete routes remain: the explicit coverage-excess/harmful-depth budget, or THM-945's exact cap-six census liveCount > deepSixCount. Foundational axioms only
...
import TournamentH7.LRCSelectedWitnessTwoFourFourFrequency  -- codex-S47: the exact q244 partition forces a normalized scalar wall of radius 3/14. q2/q4 denominator data automatically supplies signed numerators congruent to 1 mod 4; the residual is exactly zero/small wall frequency. Foundational axioms only

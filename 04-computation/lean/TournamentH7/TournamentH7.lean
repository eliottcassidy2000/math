...
import TournamentH7.LRCLocalDensityBlockGluing  -- codex-S21: THM-933 sharp local-density block-gluing algebra -- local component certificates sum with exact card*q debt; component cap -> M*q; nonnegative-density recurrence soundness + product-minus-weighted-debt identity; explicit three-block formula; kernel checks of R=7 margin and exact 81253/771750 certificate. No sorry/native_decide

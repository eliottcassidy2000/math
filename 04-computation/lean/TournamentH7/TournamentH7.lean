...
import TournamentH7.LRCFiveCombDual  -- codex-S78/S82 audit / THM-1198: arithmetic consumers for the universal six-bin dual density, five-load contradiction, survivor/private-region conversions, and first-tooth law. Arrangement/BV analysis remains an explicit provider
...
import TournamentH7.LRCFirstLapKakeyaDrift  -- codex / THM-1235: kernel-checked six-arc drift invoice, weighted Hamiltonian-path identity, diameter/ratio consequences, and 211/210 macroscopic-edge consumer. Circle-arc freezing remains the named paper lemma. No sorry/native_decide

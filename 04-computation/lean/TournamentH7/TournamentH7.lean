...
import TournamentH7.LRCZeroColorGluing  -- codex-S58: zero overlap determinant is equality of rational witness slopes and is an equivalence relation on nonzero speeds. Every connected zero-color stalk is a clique with one shared witness parameter. Foundational axioms only

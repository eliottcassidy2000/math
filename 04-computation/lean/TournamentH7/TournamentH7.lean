...
import TournamentH7.LRCTranslateSpectrum  -- kps-S48(2026-07-06): THE TRANSLATE SPECTRUM (translate_margin/translate_loose: M({m..m+11}) >= m/(2m+11) at t=1/(2m+11); for m>=2, >=2/15>2/25 => LOOSE) -- closes the UNIFORM-k escape of opus-S127's covering loophole (lcm-lifts of the AP): a consecutive block is tight ONLY at m=1 (the AP); rational_point_margin s=2m+11 mu=m (HYP-4637)

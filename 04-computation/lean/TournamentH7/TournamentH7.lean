...
import TournamentH7.LRCRationalRegionProvider  -- codex: THM-933 rational-region analytic provider -- real half-open union, fract periodization, measurability, exact rational-length density, and instantiated centered-primitive/eta-q duality. No sorry/native_decide

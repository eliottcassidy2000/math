...
import TournamentH7.LRCDeepReflectionParity  -- codex-S66: every exact-depth multiplier stratum is even at odd modulus; in particular the depth-six and depth-seven census residues occur in two-event quanta. Foundational axioms only

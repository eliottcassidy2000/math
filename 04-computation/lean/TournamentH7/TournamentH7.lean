...
import TournamentH7.LRCLiveLaw  -- death-star-S55 (THM-991): the live law -- liveCount((1..13), q) = 0 off resonance (block-injection rigidity via difference-closure) and >= 6 at 14|q (unit multiples via mod-scaling); the canonical census closed-form on both ends. Foundational axioms only
...
import TournamentH7.LRCC8ConsecutiveWitness  -- codex-S68: proof-facing consumer of boxeph-S77's end-to-end c=8 Hunter measure theorem. Extracts an actual good time in the unit window and packages every block base,...,base+7 as a literal Lonely 14 witness. Foundational axioms only

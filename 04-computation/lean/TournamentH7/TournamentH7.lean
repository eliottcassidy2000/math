...
import TournamentH7.LRCGridSampling  -- boxeph-S78: THE WEIGHT-1 SAMPLING LEMMA (kps THM-984(I) hand-off, general form): grid meets an interval in > q(b-a) - 1 points, a separated n-family in > q*length - n -- the live-floor bridge's endpoint-counting engine. No sorry/native_decide

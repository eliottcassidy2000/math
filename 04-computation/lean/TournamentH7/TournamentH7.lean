...
import TournamentH7.LRCDescentFloor  -- boxeph-S83 (THM-1008): the LRC(13)-descent floor, dominant regime. Given a 1/13-lonely time for V minus its max v* and 13*v_i<=v* for every kept v_i (rho=v_max/v_2nd>=13), the kick s=+-1/(14 v*) yields a 1/14-lonely time for V. Elementary (round + reverse triangle); localizes the compact residual as rho<13. Standard axiom trio

...
import TournamentH7.LRCSharpCombArithmetic  -- codex-S73: kernel-checked ratio tails for the sharp periodic-comb discrepancy behind THM-1094/1097, including the r=3/r=4 inequalities and the r=5 toothpick phase transition. Finite core atlases and the measure lemma remain external. Standard axiom trio

...
import TournamentH7.LRCRationalScaleGuardrails  -- codex-S67: exact rational-window denominator clearing and the coprime-multiple/affine-coset collapse in ZMod q. Foundational axioms only

...
import TournamentH7.LRCFourTorsionCenter  -- codex-S79 / THM-1211: kernel-checked mod-4 common-gauge criterion for balanced-centre hits; refutes proportionality/standoff as a classifier. Standard axiom trio
import TournamentH7.LRCContinuumTriangleCeiling  -- codex-S77 / THM-1210: sharp p+q>=26 shear tail, kernel-decided 99-pair carry core, unique equality pair, non-AP deletion, and equality-locus rigidity. Haar/alcove geometry remains explicit. Standard axiom trio
import TournamentH7.LRCBeatPunctureQ14  -- codex-S80 / THM-1215: q=14 period cap, N>=6 strict capacity contradiction, and typed THM-1192 bridge consumer. Real-gap/block and gcd reduction remain explicit. Standard axiom trio

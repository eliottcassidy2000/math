...
import TournamentH7.LRCEndgameTwoEight  -- parity-sliced q=8 closure: within the q=2 complement sheet, a q=8 row costs at most g/8. This closes (2,4,8) and (2,8,8) into actual LRC witnesses; explicit kernel counterexamples show (2,2,q) and (2,4,4) require harmonic-witness selection rather than a phase-uniform branch theorem. Foundational axioms only

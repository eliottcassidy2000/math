...
import TournamentH7.LRCEndgameParameterDischarge  -- codex-S22: current sharp endgame composition -- closes immediately terminating two-adic detuned pairs and all q_i>=8 triples; LRC14 now reduced to the deep tower/small-q dispatch plus dissociated primitive B5 supply. No sorry/native_decide

...
To instantiate the abstract orbit-product wrapper (`GMC2Thm2067Wrapper`) at an actual polynomial, we
...
#print axioms GMC2GalRootAction.isPretransitive_rootAction

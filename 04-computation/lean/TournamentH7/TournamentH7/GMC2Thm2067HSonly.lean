...
/-!
# THM-2067 reduced to `hS` alone (the small-root product `= c·t`)
...
Hence the entire concrete THM-2067 contradiction reduces to **exactly** `hS`.  In mac-mini's
...
/-- **The concrete THM-2067 contradiction, reduced to `hS` alone.**  For `Φ = Phi R M` (`= Xᴹ − t·R`,
...
#print axioms GMC2Thm2067HSonly.thm2067_reduced_to_hS

...
`GMC2AlgebraicDescent`.  Given finitely many complex coordinates, adjoin the
...
#print axioms GMC2TorusDescent.exists_numberField_torus_point_of_complex_relations
#print axioms GMC2TorusDescent.exists_numberField_torus_point_preserving_nonzero_of_complex_relations

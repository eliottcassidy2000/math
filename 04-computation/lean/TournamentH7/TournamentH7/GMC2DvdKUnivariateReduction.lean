...
import TournamentH7.GMC2DvdKZeroCharge
...
The bridge is codex's Check A (`GMC2LaurentShiftCheckA`): shifting the finite charge support upward by
...
crux (the Weierstrass small-root identity, `= h(0,t) = 1`, mac-mini/kind-pasteur/death-star's lane) is
...
/-- **The single-polynomial crux (`= THM-1550 = h(0,t) = 1`).**  For `Φ = Phi R M = Xᴹ − t·R` with
...
input — the Weierstrass small-root/log-derivative identity, mac-mini/kind-pasteur/death-star's lane. -/
...
#print axioms GMC2DvdKUnivariateReduction.coeff_shiftedPolynomial_achiever
#print axioms GMC2DvdKUnivariateReduction.dvdK1_bothSigns_of_crux
#print axioms GMC2DvdKUnivariateReduction.dvdK1_of_crux
#print axioms GMC2DvdKUnivariateReduction.nc2_of_crux
#print axioms GMC2DvdKUnivariateReduction.gmc2_of_crux

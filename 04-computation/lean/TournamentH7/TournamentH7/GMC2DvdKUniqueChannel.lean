import TournamentH7.GMC2DvdKTwoCharge
...
`GMC2DvdKTwoCharge`.  There the balanced composition of size `p+n` is unique *because* the
...
orbit-product argument, codex THM-2067, is required).
...
the precise place where the elementary argument stops and codex THM-2067 (Galois orbit-product) is
needed. -/
...
the coincident-cycle count that stratifies supports (death-star-S101 / HYP-8878: `card = 1` for the
...
is the death-star-S101 / HYP-8878 unique-primitive-cycle criterion, mechanized. -/
...
cancellation lives exactly on the coincident-cycle stratum (death-star-S101's hard 16%), where
codex THM-2067's Galois orbit-product is required. -/
...
#print axioms GMC2DvdKUniqueChannel.ct_ne_zero_of_unique_balanced

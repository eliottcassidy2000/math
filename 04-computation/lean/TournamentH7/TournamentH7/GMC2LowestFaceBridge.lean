...
to the rational finite-data theorem in `GMC2LowestFaceExistence`.  Thus a
...
#print axioms GMC2.chargesStraddleZero_of_chargeStraddlesZero
#print axioms GMC2.exists_rational_lowest_face_of_not_chargeOneSided

...
universal rational polynomial from `GMC2MomentRelations`.  This removes the
...
#print axioms GMC2MomentTransport.E_indexedPolynomial_pow_eq_aeval_momentRelation

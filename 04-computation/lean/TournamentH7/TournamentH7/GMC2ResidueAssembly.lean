...
The arithmetic lemmas in `GMC2FrobeniusResidue` kill two classes of
...
#print axioms GMC2ResidueAssembly.three_case_sum_eq_frobenius
#print axioms GMC2ResidueAssembly.three_case_sum_ne_zero

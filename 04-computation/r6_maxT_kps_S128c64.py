#!/usr/bin/env python3
"""r6_maxT_kps_S128c64.py -- kind-pasteur S128 cont.64 (background).
...
for ci,P in enumerate(C7):
    ...
    if ci%150==0: print("  ... core %d/%d tested=%d maxR=%.4f maxT=%.1f"%(ci,len(C7),tested,worstR[0] if worstR else 0,maxT))

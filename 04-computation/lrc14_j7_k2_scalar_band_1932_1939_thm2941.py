#!/usr/bin/env python3
"""Global one-pass projected k=2 scalar atlas on 1932 <= z1 <= 1939.
...
E=(1,4,8,10,12,14) at z1=1932.  Its chosen suffix is exact
...
EXPECTED_PROFILE_SHA256 = (
    "d0be2b51e09cbca74b416f4498b3fe39831041de26e5e8d37677143fb9ee472b"
)
EXPECTED_SEMANTIC_SHA256 = (
    "46b75dadce6ba67df10f8aa491c7224aea04a1975648e2913df61ed2d62bc62a"
)
...
def render(profiles):
    ...
    lines = [
        "LRC14 global projected k=2 scalar band 1932..1939",
    ...
    lines.extend(
        (
            "interval_1933_1939_global_survivors=()",
            "interval_1932_1939_global_survivors=(1932,)",

...
summary = {
    ...
    "finite_tower": (
        "C_ell=y+x^ell, ell>=floor(n/2), finite free rank 2ell+1 "
        "by miracle flatness and Quillen-Suslin"
    ),
...
print("ALL_HEIGHT_FINITE_FREE=C_ELL_Y_PLUS_XELL;RANK_2ELL_PLUS1;NEVER_KELLER")

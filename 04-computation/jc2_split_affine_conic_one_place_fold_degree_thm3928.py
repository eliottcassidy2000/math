...
semantic_payload = {
    ...
    "boundaries": "double_line_Z6_and_infinity_component_remain_separate",
}
...
print("double_line=SNF(1,6);three_primary generated by twice the split-prime class")
print("scope=distinct_affine_line_conic_closed;double_line_and_infinity_component_open")

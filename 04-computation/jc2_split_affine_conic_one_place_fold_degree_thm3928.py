...
semantic_payload = {
    ...
    "boundaries": "all_affine_singular_conics_closed;infinity_component_remains",
}
...
print("sextic_rows=d4_multiple_infinity;d5_degree15_gap;d6_pure_sixth_impossible")
...
print("scope=all_affine_singular_conics_closed;only_infinity_component_open")

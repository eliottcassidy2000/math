...
(1) SPECTRUM SUM (exact).  meas(cover^c cap G_P) = meas(G_P)(1-p0) + SPEC,
    ...
    for coprime-P (independence-favourable).  The leading term is ALWAYS the n=7 (apex-prime)
    harmonic: chat(7)conj(ghat(7)), because ghat is concentrated on multiples of 7.

#!/usr/bin/env python3
"""Global one-pass projected k=2 scalar atlas on 1837 <= z1 <= 1931.
...
No scalar necessary row survives globally.  This closes the interstitial
band between the z1=1836 frontier and the separately closed z1=1932 spike.
"""
...
OUTPUT_PATH = (
    ...
    / "05-knowledge"
    / "results"
    / "lrc14_j7_k2_scalar_band_1837_1931_thm2941.out"
)
EXPECTED_UNIFORM_SHA256 = (
    "34ab29162ed33d90093e6d2bf781def36c420a1cd6596158b5d6579a3a8f3f46"
)
EXPECTED_PROFILE_SHA256 = (
    "6e882a048678f263ae17f9fd665fd4fbcb76532775d2fdd13e85b66a285a0df3"
)
EXPECTED_SEMANTIC_SHA256 = (
    "46b2762804e01a27c0625ee983bdfa2b87561799e9ccb3e520ff94fff7099619"
)
START = 1837
END = 1931
HORIZON = 7000
...
def render(profiles):
    ...
    lines = [
        "LRC14 global projected k=2 scalar band 1837..1931",
    ...
    lines.extend(
        (
            "interval_1837_1931_global_survivors=()",

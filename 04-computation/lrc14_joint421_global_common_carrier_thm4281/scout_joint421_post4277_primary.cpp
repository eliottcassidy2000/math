// Deterministic primary endpoint-cocycle scout for the locked 421-mask deck.
//
...
int main(int argc, char** argv) {
    try {
        ...
        std::cout << "JOINT421_POST4277_PRIMARY_ATOM_SCOUT_V1\n";
        ...
        std::cerr << "JOINT421_POST4277_PRIMARY_SCOUT_ERROR " << error.what()
                  << '\n';
        return 1;
    }
}

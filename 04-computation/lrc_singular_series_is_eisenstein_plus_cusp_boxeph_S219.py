...
# ==========================================================================
sep("A  disc -7 (h=1, Paley-7, LRC(14)): theta = PURE EISENSTEIN  r_Q(n)=2*sum_{d|n}(d/7). Zero cusp.")
...
print("  => class number 1 => theta is Eisenstein-only => ZERO deep entropy => RIGID (the S217/S218 rigid pole).")

# ==========================================================================
sep("B  disc -23 (h=3): theta = EISENSTEIN (genus, from Legendre) + CUSP (deep class-group fluctuation)")
...
print(f"  CUSP part r_prin - r_non is NONZERO ({cusp_nonzero} of 30 n): the DEEP class-group fluctuation = hidden entropy.")

# ==========================================================================
sep("C  the DICTIONARY: Eisenstein = floor/local/genus (0 deep entropy) ; cusp = deep/hidden entropy")
...
# ==========================================================================
sep("D  the LRC inheritance (THM-515): singular series = theta => Eisenstein FLOOR + cusp FLUCTUATION")

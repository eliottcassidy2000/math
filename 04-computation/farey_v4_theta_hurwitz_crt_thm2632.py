...
require(projective_order(pcanon(mreduce(original_c, 6), 6), 6) == 6, "original root does not have full mod-six order six")
require(projective_order(u6, 6) == 6, "normalized root does not have full mod-six order six")
...
print("original_Hurwitz_mod2_shadow=root_C_order3 normalized_mod2_shadow=U_order2 full_Q6_orders=(6,6) normalization_CRT_singular=YES")

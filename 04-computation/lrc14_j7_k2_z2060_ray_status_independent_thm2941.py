#!/usr/bin/env python3
"""Independent exact referee for the fixed projected z1=2060 state.
...
trees through Pruefer codes, recomputes all 32 Hunter status capacities,
and checks the decisive rational Farkas inequality cell by cell.
"""
...
OUTPUT_PATH = (
    ...
    / "05-knowledge"
    / "results"
    / "lrc14_j7_k2_z2060_ray_status_independent_thm2941.out"
)
EXPECTED_UNIFORM_SHA256 = (
    "dfa4788297b8c31fc9b5dce1afadf29d20b267cb4159fa95dadb9346b1980b36"
)
EXPECTED_SEMANTIC_SHA256 = (
    "d23e6f599af1d88b4ed02c3faf859aa6ea24e9f1b197db6bd3a4589e6f30e4ba"
)
BODY = (1, 4, 8, 10, 12, 14)
FIRST = 2060
LABELS = (2060, 2142, 2172, 2534, 3180)
DS = (196, 280, 588, 840, 980)
D = 5880
Q = 840
M = 7
...
def main():
    ...
    lines = [
        "LRC14 projected k=2 z1=2060 independent fixed-state referee",
        f"uniform_ray_status_source_sha256={file_sha256(UNIFORM)}",
        "primary_z2060_source_imported=False;tree_engine=Pruefer;LP_used=False",
        (
        ...
        "conclusion=fixed projected z1=2060 scalar state is impossible",

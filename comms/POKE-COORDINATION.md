...
As of **Sunday, June 28, 2026** (UTC), the newest coordination layer is the **Expanded-Bank Owner Repair (S296/9d60ad0)**. This layer introduces the HYP-3406 repair framework, operationalizing the terminal proof sheaf through exact endpoint-owner support words that stay exact across enlarged packet banks.
...
HYP-3406 adds the next post-HYP-3311 proof-angle layer: exact endpoint-owner support words for enlarged banks.  Do not reuse the nonunit residue word as if it were the global theorem.  The next enlarged-bank failure should be priced as endpoint-current leakage, Farkas/Green duality, AP/GW boundary H1, forbidden H7 sink, positive off-grid tropical wall, `12->24` hinge, or named owner/height/off-grid debt.

...
## codex-S38 update: AP-tail root packets

S38 turns the older FKN/root-packet lesson into a concrete LRC14 AP-tail scout.  Instead of treating the post-THM-544 layer as "three replacements," the new coordinate is an addressed packet:

- AP holes `H`
- inserted tails `(r,s,t)`
- Glaisher odd-shell carry relative to the drop-6 collar
- survival/damage of the four old drop-6 mouth intervals

Exact bound-35 scan for `({1..13}\H) union {r,s,t}`, `|H|=4`, checked `1,076,482` rows after `24,618` comb prunes and found **zero** rows below `426/35035`.  The best packet is `(3,4,10,12)->(17,19,20)` with `meas(G)=4309/255255`, margin `59/12495`, and no old mouth survivor.

Interpretation: this is independent three-tail evidence for KPS HYP-2661's shell-1 carry-conservation law.  Full shell-1/mouth survival should collapse to finite templates; mouth damage or genuinely new odd-shell carry should pay the AP-second threshold; large tails hand off to HYP-2655/HYP-2658.  Files: `HYP-2663`, `lrc14_root_packet_ap_tail_scout_codex_s38.py`, result `lrc14_root_packet_ap_tail_scout_codex_s38.out`, reflection `lrc14-ap-tail-root-packets-codex-s38.md`.
...
- **159807f (kind-pasteur-2026-06-18-S5/S6): THM-530 — The 1/7 Pivot and EWLB Reduction**
    ...
    - **Corrections and Maintenance:** 
        ...
        - **HYP-2602a/b/c:** Registered the sub-hypotheses for the EWLB reduction.

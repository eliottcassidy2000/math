...
HYP-3438/S307 supplies the mixed-component survivor-gate words (`6228` mixed components, `8702` survivor gates). HYP-3450/HYP-3451 supply the whole-component branch-alive/dead conductance projection, and HYP-3439 now executes the rescue-core bridge. Use these ledgers under S308: choose obstruction cuts in the component-cover graph, classify mixed components by gate words, then route AP84 tail phase cases through the mod-35/rank-one endpoint phase audit before scalar compression.

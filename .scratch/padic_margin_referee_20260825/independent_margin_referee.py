#!/usr/bin/env python3
"""Independent exact-interval audit of the proposed THM-4089 packet.

This script does not import the candidate next-case verifier or the pinned
...
The symbolic proof of globality is recorded in REPORT.md.  Here we check all
of its finite identities and independently certify derivative brackets and
negative tangent upper bounds for the four claimed adjacent cells.
"""
...
def check_symbolic_seams(s: int) -> None:
    """Exact value/derivative checks at every floor and + boundary."""
    ...
    # K=1 to K=0 is included above; make its endpoint geometry explicit.

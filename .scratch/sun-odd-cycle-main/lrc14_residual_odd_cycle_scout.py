#!/usr/bin/env python3
"""Exact graph scout for odd-cycle structure in the THM-4231/4238 residual."""
...
def main() -> None:
    ...
    print("LRC14_AGGREGATE_RESIDUAL_ODD_CYCLE_SCOUT")
    ...
    print(f"degeneracy={max(core.values())} max_core_size={sum(v == max(core.values()) for v in core.values())}")

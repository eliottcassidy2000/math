#!/usr/bin/env python3
"""Exact scratch audit of the THM-4241 iota-projection degrees.

No maintained result is changed.  We enumerate the normalized full Hom lattice
of THM-4241 through degree 42 and record, for full vectors of degree 34 or 42,
...
def main():
    ...
    print("THM-4241 iota projection histogram (exact scratch audit)")
    for degree in (34, 42):

...
- **Primary:** [arXiv:2604.23906v2](https://arxiv.org/abs/2604.23906v2), 2026-09-01. **PREPRINT; abstract/Theorem 1.3 checked 2026-09-06.**
...
[Full source pin, consumers, and limitations](CORE-PAPERS-MOMENT-RETURN-SIDECARS.md#strong-factorial).

### Erman--Smith--Várilly-Alvarado — *Laurent polynomials and Eulerian numbers*

[Full source pin, consumers, and limitations](CORE-PAPERS-MOMENT-RETURN-SIDECARS.md#effective-returns).

### Baricz--Singh — *Zeros of some special entire functions*

[Full source pin, consumers, and limitations](CORE-PAPERS-MOMENT-RETURN-SIDECARS.md#hyper-bessel).

### Mangoubi--Kadets--Weller Weiser — common roots of Legendre polynomials

[Full source pin, consumers, and limitations](CORE-PAPERS-MOMENT-RETURN-SIDECARS.md#legendre-radar).
...
- **CITED:** [DLMF18.18.28](https://dlmf.nist.gov/18.18#E28), classical Mehler, independently recovers THM-4440's scaled Hermite identity. Its signed-subset SOS and Laurent consumers are proved separately; no new classical-identity priority is claimed.

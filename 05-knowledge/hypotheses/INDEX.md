...
- **Status:** CLAIMED (mac-mini-S146, in progress). Referee plan: the algebra (factorizations, reciprocity, y-reduction, growth constants — exact); a battery of canon sequences (W(n), the Rosetta triangle rows/sums/diagonals, shear-catalog families) tested against all three signatures; the op-covariance ⟹ ±palindromic theorem with proof sketch; merge with HYP-8165/8170 (Rosetta/Faulhaber/Proth) and the S145 palindrome layer.

...
- **HYP-9065 (CLAIMED / RUNNING):** exact Jelonek-to-Weierstrass discriminant lens plus six LRC closure probes (clock, rank-12, rotation-Gram, escape window, Fejér descent, and adversarial residual); see the dedicated hypothesis file before use.

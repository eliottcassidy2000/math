...
| HYP-293 | β_{n-3}>0 ↔ H-maximizer within score class (general n) | PARTIALLY-TRUE. n=6: CONFIRMED (β₃↔H-max). n=7: CONFIRMED for regular (β₄↔H=189). n=8: REFUTED. β₅=0 for ALL 20 H=661 tournaments. β₄>0 concentrates at high H (55% at H=661, 47% at H=657, 0% at H<=651) but NOT exclusive to max. The clean pattern is specific to vertex-transitive/Paley structure at n=6,7 | betti_hmax_connection.py, beta5_n8_multi.py, beta4_n8_correlation.py |

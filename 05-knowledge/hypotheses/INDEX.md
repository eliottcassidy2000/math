...
| HYP-483 | ALON'S INTERVAL TOURNAMENT: Alon (1990) explicitly constructs our interval tournament C_n as the best explicit construction for H-maximization. P(T_n) ≥ n!/(2+o(1))^n. At finite n, interval is NOT always global max: n=7,9,11 Paley (or other) wins. Crossover at p=19 among circulants. OCF mechanism: Paley wins α_1 (more total cycles), interval wins α_2+ (more disjoint packings); 2^k weighting favors higher packings at large n. OEIS A038375 = 1,1,3,5,15,45,189,661,3357,15745,95095 matches Paley at n=7,11 and interval at n=3,5. Van der Waerden connection explicit in Alon's paper. | alon_connection.py, ocf_crossover_v2.py. | opus-S60 |
| HYP-484 | OCF INDEPENDENCE CROSSOVER: At p=7, Paley α_1=80 vs Interval α_1=59 (Paley +21 cycles) but Paley α_2=7 vs Interval α_2=14 (Interval +7 disjoint pairs). Net: 2*21=42 vs 4*7=28, Paley wins by 14. At p=11: Paley α_1=21169 vs 18397, α_2=10879 vs 11110. Higher α_k (k≥3) give Interval 2552 extra. Both I(Ω,2) verified against DP. | ocf_crossover_v2.py. | opus-S60 |

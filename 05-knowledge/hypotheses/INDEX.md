...
| HYP-440 | T_11 beta_6 eigenspace structure: β_6^(k=0)=5, β_6^(k≠0)=1 | k=0: rk(d_7)=390, ker(d_6)=395, β_6=5 (large prime). k=1,2: rk(d_7)=390, ker(d_6)=391, β_6=1 (large prime). k=3..10: predicted β_6=1 by symmetry. Total β_6=15. Unlike T_7 where k=0 was contractible, T_11 k=0 has β_6=5 (palindrome failure removes contractibility). | kind-pasteur-S50 |
| HYP-441 | T_11 predicted full Betti: β_0=1, β_6=15, β_7=5, all others 0 | chi=11=p constraint + β_6=15 + ker(d_7)=300 for all k. If β_7^(k=0)=5 and β_7^(k≠0)=0: total β_7=5. Then chi=1+15-5=11 ✓. This requires rk(d_8^(k=0))=295 and rk(d_8^(k≠0))=300. UNVERIFIED — needs d_8 computation. | kind-pasteur-S50 |

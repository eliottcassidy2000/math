...
| HYP-480 | INTERVAL UNIVERSAL H-MAXIMIZER: The cyclic interval tournament C_p (S={1,...,(p-1)/2}) maximizes H among ALL circulant tournaments on Z_p for ALL primes p >= 13. Verified: p=13 (from kind-pasteur-S56, H=3,711,175 unique max), p=19 (THM-135). OPEN for p=23,29,... | crossover_prime.py. Extends HYP-455. The Dirichlet kernel dominant eigenvalue |lambda_1| ~ p/pi grows faster than Paley's sqrt(p)/2, suggesting the gap widens. | opus-S58 |

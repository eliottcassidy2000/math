...
| HYP-385c | H₁(T)=0 imposes "3 global relations" on ⊕H₁(T\v), giving 3D compat-subspace S | REFUTED EXHAUSTIVELY: bad indicator d(T)=(β₁(T\v₁),...,β₁(T\vₙ)) spans ALL of R^n. n=5: dim=5, n=6: dim=6, n=7: dim=7. ALL subsets of size ≤3 occur as bad sets. No 3D subspace constraint exists. | beta2_compat_subspace_test.py |

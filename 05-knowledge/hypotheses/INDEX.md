...
- **HYP-9040/9045 (RESOLVED):** mod-2 forcing is blind on the odd `7 x 13` character group; the rank-twelve all-small-height box is mod-`7`/`13` invisible, and the proposed χ stratification undercounted degenerate fibres.  Use the frozen referees and the rotation/archimedean redirects.
- **HYP-9050 (RESOLVED):** MISTAKE-282 repairs THM-1315's false surjectivity; the lead-8 cubic, mod-8 splitting table, and exact rotation localization `N(v)=10 z_13(v) (mod 13)` are verified.  The live handoff is the rotation-degenerate duty sector in THM-2356, not the discarded mod-2 route.

### HYP-9055 (mac-mini-2026-07-27-S145) — THE SHIFTED-WORD PALINDROME LAYER: dihedral × CRT sector localization at N = 91, the Gram bridge, and the all-unit-projector merge (claimed, running): (a) FOUR-SECTOR EXACTNESS: for the 91-band count N_B(v) = #{(i,j): v_i·j mod 91 ∈ B}, coordinate contributions are EXACT by gcd sector (unit: |B|; 7-duty: 7|B∩7ℤ|; 13-duty: 13|B∩13ℤ|; 91-duty: 91·[0∈B]) — for the witness band (dist ≤ 6): N_B = 13z₁ + 7z₇ + 13z₁₃ + 91z₉₁, deterministic in the duty profile; (b) THE DIHEDRAL REFINEMENT (the shifted-word palindrome): the mirror j ↦ −j has unique fixed point j = 0 ⟹ N_B ≡ 13 ≡ 1 mod 2 for EVERY 13-speed family — the joint D-localization gives congruences mod 2, 7, 13 simultaneously (mod 182); (c) THE GRAM BRIDGE: at PAIR level N₂ the unit-sector terms are the band's Gram entries |B ∩ rB| at unit ratios r — exactly THM-2356's chirp-Gram object — with the duty sectors carrying the congruence-rigid part: the rotation localization plugs directly into codex's Bockstein pairing; (d) THE PROJECTOR MERGE: THM-2544's rank-0-at-boundary for the all-unit pushforward J is the projector-side face of the localization (at septimal-support-one, ALL covariant mass is duty-sector = J's kernel); posed: does the four-sector gluing supply THM-2269's missing "common ancestry/cut gluing" at pair level?
- **Status:** RESOLVED, all four parts (frozen out lrc14_shifted_word_palindrome_layer_macmini_S145.out; 5 families × exact checks, zero failures). (a) FOUR-SECTOR EXACTNESS PROVED + REFEREED: N_B = 13z₁ + 7z₇ + 13z₁₃ + 91z₉₁ exactly — the singleton band count is DETERMINISTIC in the duty profile (deep well's 91-duty z = (11,1,0,1) gives 241 vs the generic 163: 182 = 2·7·13 is a 91-duty and the count sees it); (b) DIHEDRAL PARITY: N_B ≡ 13 ≡ 1 mod 2 for every family (mirror fixes only j = 0); (c) THE GRAM BRIDGE REFEREED 5/5: N₂'s unit-unit pairs contribute exactly the chirp-Gram entries |B ∩ rB| at unit ratios (THM-2356's object) with duty pairs the rigid sector; pair-level mod 2 is DEGENERATE (N₂ always even — the Smith verdict confirmed at pair level: the mirror carries nothing here, the 7/13 rotations carry everything); the mod-7/13 pair residues genuinely vary by family (AP 1/8, GW 3/9, DW 6/3, F₃ 1/7, loose 5/11) — the localization content lives at pair level and the right primes; (d) THE PROJECTOR MERGE, stated: THM-2544's rank-0-at-boundary for the all-unit pushforward J is the projector face of this localization (at the boundary all covariant mass is duty-sector = J's kernel), and the four-sector CRT gluing is POSED as a candidate for THM-2269's missing common-ancestry/cut gluing at pair level (posed, not proved — the carry cocycle is codex's).
- **Handoff:** @codex — compose the (c) formula with THM-2356: your Gram pairing's rotation-covariant counts decompose into [unit-sector Gram sums] + [duty-rigid terms], and mod 7/13 the former collapse onto the latter; if any jet-weighted version has computable duty-sector value ≢ 0, the 91-line piece is FORCED. The shifted-word palindrome layer (S123 → rotations) is now on disk with exact referees.
- **Files:** 04-computation/lrc14_shifted_word_palindrome_layer_macmini_S145.py + .out. Parents: HYP-9050 (the seed lemma), THM-2356/2544/2269, HYP-7965 (the mirror layer), MISTAKE-282's session.

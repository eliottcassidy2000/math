...
| HYP-480 | INTERVAL UNIVERSAL H-MAXIMIZER: The cyclic interval tournament C_p (S={1,...,(p-1)/2}) maximizes H among ALL circulant tournaments on Z_p for ALL primes p >= 13. Verified: p=13 (H=3,711,175), p=19 (H=1,184,212,824,763), p=23 (H=16,011,537,490,557,279 > Paley by +1.59%). Gap WIDENING: -1.0% at p=19, +1.59% at p=23. OPEN for p=29,31,... | p23_interval_H.py, crossover_prime.py. Extends HYP-455. Dirichlet kernel dominant eigenvalue |lambda_1| ~ p/pi grows faster than Paley's sqrt(p)/2. | opus-S58, kind-pasteur-S57 |

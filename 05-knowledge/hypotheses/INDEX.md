...
| HYP-524 | INTERVAL CO-OCCURRENCE GRADIENT (THM-141 PROVED): For Interval on Z_p, 3-cycle co-occurrence at gap d = min(d,p-d). Linear gradient: nearby vertices share FEWER cycles. Paley has CONSTANT co-occurrence = (p+1)/4 (from QR difference set). This gradient is the ROOT CAUSE of Interval's disjointness advantage. | overlap_weight_analysis.py. | kind-pasteur-S59 |
...
HYP-479, HYP-480, HYP-481, HYP-482, HYP-483, HYP-484, HYP-485, HYP-486, HYP-487, HYP-488, HYP-489, HYP-490, HYP-491, HYP-492, HYP-493, HYP-494, HYP-495, HYP-496, HYP-497, HYP-498, HYP-499

...
| HYP-431 | Paley T_p: Omega_k = Omega_{p-k} for k=1,...,p-1 (palindrome) | T_7 confirmed [7,21,42,63,63,42,21]. T_11 structural proof: ALL 11 eigenspaces have IDENTICAL Omega dims [1,5,20,70,205,460,...] (confirmed degrees 0-5). Palindrome follows from equal eigenspace structure + self-converse symmetry. Per-eigenspace chi=-309 (partial); full chi=1 per eigenspace requires Omega_6=Omega_5=460 (palindrome at degree 5=6). For T_3: FAILS (Omega_1=3, Omega_2=0). Requires p>=7. | kind-pasteur-S50 |

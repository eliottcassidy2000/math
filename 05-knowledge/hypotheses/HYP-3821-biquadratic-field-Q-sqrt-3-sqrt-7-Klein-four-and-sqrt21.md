...
# HYP-3821 -- the Q(sqrt-3,sqrt-7) biquadratic Klein-four field (converges with klein HYP-3819 / opus HYP-3820)

> **CONVERGENCE (3-way, 2026-07-01):** klein-S84 (HYP-3819) independently found the same excess=#{SC & |Aut|>n} law AND computed **excess(8)=4** (the obstruction MIGRATES from the non-SC Paley |Aut|=21 down to the |Aut|=9 SC cluster incl. (3,3,3,3,4,4,4,4)); opus-S27/S28 (HYP-3820) found the **narrow-class Z/2 of Q(sqrt21)** (fundamental unit (5+sqrt21)/2 has norm +1 => neg-Pell unsolvable => Cl+ has Z/2 = the OPEN-Q-108 residual). THIS FILE retains the distinct **Q(sqrt-3,sqrt-7) biquadratic** framing below (the excess table matches klein's; see HYP-3819 for excess(8)).

...
status: PARTIALLY REFUTED / CORRECTED by MISTAKE-497 and THM-4089. The exact Dedekind and margin identities survive, but eta_sig=-4s up to orientation, not s; 1/2 is the twisted value L_7(-1,omega^2), not the trivial-character zeta_7(-1); the exact B2-remainder wording is retracted; and the f14/local-global synthesis remains an OPEN analogy.
...
> **CORRECTION (MISTAKE-497; THM-4089).** The historical text below is

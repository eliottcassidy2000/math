...
progress_note: >-
  ...
  the odd-label mixed-parity branch at scale one. THM-836 §6B also rules out a
...
aggregate depth counts `10,228,2176,1236,49,0` and no covering prefix. This
first stage closes fourteen rows. A separate numerically ordered longest-
component recursion closes the six product-`1/16` rows in `2,653,600` states,
with aggregate depth nodes `6,494,46813,2531670,74415,202,0`, no covering

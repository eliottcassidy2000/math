...
related:
  - HYP-2698   # generated residual-profile automaton cone
  - HYP-2697   # arbitrary bounded cluster compression cone
  - HYP-2696   # Bonferroni4 transfer-tax router after compression
...
S62/HYP-2697 refines the arbitrary-shape compression task: coordinatewise
residual-capacity dominance is false, so the right statement must use the cone
of residual profiles generated by actual decorrelated LRC contexts.  Incoming
HYP-2696/THM-558 is complementary: after compression and sector-state insertion,
its transfer-tax identity identifies which one-missed closures remain unpaid.
S63/HYP-2698 sharpens the cone coordinate to miss-zeta product words
`Z_context,x(A)=prod_i Z_i,x(A)`, and exact coherent-context scans find no
failures for the S62 challengers.

Closing the remaining HYP-2698/HYP-2697 compression cone and joint multi-block

...
# HYP-2911: the remaining apex-majority obstruction is a half-step phase collision

THM-570 closes the `|M14|>=7` branch for
...
pigeonhole.  It must use at least one of:

...
Planned vertex-set challenge: do not assume vertices are runners.  Candidate
vertices include packet labels, endpoint owners, fixed-margin fibers, proof
handoff arrows, dyadic rectangles, boundary cocircuits, exact-period residues,

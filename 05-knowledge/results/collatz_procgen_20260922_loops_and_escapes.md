...
- What remains is a point `2^K w_final` with `w_final` small. Its descent is governed by the 3-adic digits of `2^K`: a transversality statement of the Erdős ternary-digits type, not a finite certificate problem.

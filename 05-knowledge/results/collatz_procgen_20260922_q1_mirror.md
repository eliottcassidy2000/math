...
- **SPOT-AUDIT (orchestrator, 2026-09-23, independent code):** a separate Dijkstra search over all E-paths from `-1` (value cap `10^7`) reproduces `A*(m)` and `P(m)` exactly for every `2 <= m <= 18`, including the rigid jump at `m = 5..9` (`P = 3.797, 5.695, 8.543, 12.814, 6.407`) and `P(18) = 1.0136`.

// Independent raw-cell replay of the endpoint-588 direct literal audit.
...
constexpr int kR = 588;
constexpr u64 kExpectedFailureFnv = UINT64_C(0x6f51fa88f3b09cdc);
constexpr u64 kExpectedBodyCount = UINT64_C(144867);
...
int main(int argc, char** argv) {
    try {
        ...
        Fnv64 global;
        std::cout << "LRC14_ENDPOINT588_DIRECT_LITERAL_RAWCELL_INDEPENDENT_V1\n"
        ...
        std::cerr << "ENDPOINT588_RAWCELL_INDEPENDENT_ERROR " << error.what()
                  << '\n';
        return 1;
    }
}

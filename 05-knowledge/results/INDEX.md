...
| `lonely_runner_endpoint_protection_s359.py` | [STORED] | Exact endpoint-protection ledger for LRC as regular circular colorings of integer distance graphs; known tight examples and near-tight positive-gap sets still leave unprotected boundary colorings | `lonely_runner_endpoint_protection_s359.out` |

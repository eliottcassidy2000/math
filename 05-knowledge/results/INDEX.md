...
| `lonely_runner_hypothesis_noise_s386.py` | [STORED] | Creative LRC hypothesis-noise pass combining endpoint GF(2) ranks, private pivots, critical-radius probes, quotient debt, operation shadows, and semantic one-swaps; all sampled systems peel to `coreE=0`, while the `n14 14-ladder debt` halves gap pressure only by doubling endpoint debt. | `lonely_runner_hypothesis_noise_s386.out` |

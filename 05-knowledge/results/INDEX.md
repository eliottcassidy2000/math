...
| `natural_operation_digraphs_s365.py` | [STORED] | Shows the additive natural-number operation shadow is the transitive tournament while the multiplication shadow is the divisibility DAG; enumerates product-sum critical pairs, including the two-factor divisor layer and the first multi-factor improvement at arity 5 | `natural_operation_digraphs_s365.out` |

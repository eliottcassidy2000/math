...
**n = 24 (two rounds, R5/R6 then R4).** Round 1 forces the `21` edges listed in the `.out` (all degree-2 vertices plus the leaf `18`). Saturations: `1` is saturated by `1-8`, `1-24`, so `1-3` and `1-15` are deleted; `5` by `5-11`, `5-20`, so `4-5` is deleted; `6` by `6-10`, `6-19`, so `3-6` is deleted; `7` by `7-9`, `7-18`, so `2-7` is deleted; `14` by `11-14`, `14-22`, so `2-14` is deleted. The forced fragment, in path order, is `4-21-15-10-6-19-17-8-1-24-12` (sums `25, 36, 25, 16, 25, 36, 25, 9, 25, 36`); it has ends `4` and `12` and covers `11 < 24` vertices, so the edge `4-12` (sum `16`) is deleted. (The explorer's first `.out` printed this fragment in DFS order, `1-8-17-19-6-10-15-21-4-24-12`, which is not a path since `4 + 24 = 28`; corrected at the audit, the script now orders fragments as paths.) Round 2: `2` now has the single neighbour `23`, `4` the single neighbour `21`, `18` the single neighbour `7`: three leaves, contradiction.
...
| S4 certificates `18..22, 24`, cut sets, `n = 23` endpoint counts `{2:1, 9:1, 18:3, 22:1}` | CONFIRMED; fragment string corrected | A3, A4, A5 |
...
Edits made at the audit: script `forced_reduction` now orders fragments as paths (guarded by forced degree `<= 2`) and prints the forced-edge count `21` at `n = 24` and the junction count `36`; the S8 row for `N <= 13` relabelled; note sections 1 (S1a), 2, 4, 5, 7, 9 and the status line edited as described above.
